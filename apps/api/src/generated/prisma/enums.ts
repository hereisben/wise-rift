...
export const RuneEffectType = {
  ...
  ITEM_ABILITY_HASTE: 'ITEM_ABILITY_HASTE',
...
export const RuneTriggerType = {
  ...
  ON_HIT: 'ON_HIT',
  ON_ATTACK: 'ON_ATTACK',
  ON_EMPOWERED_ATTACK: 'ON_EMPOWERED_ATTACK',
  ON_ABILITY_HIT: 'ON_ABILITY_HIT',
  ON_ACTIVE_ABILITY_HIT: 'ON_ACTIVE_ABILITY_HIT',
  ON_CHAMPION_HIT: 'ON_CHAMPION_HIT',
  ON_CHAMPION_DAMAGE_TAKEN: 'ON_CHAMPION_DAMAGE_TAKEN',
  ON_IMMOBILIZE_APPLIED: 'ON_IMMOBILIZE_APPLIED',
  ON_IMMOBILIZED: 'ON_IMMOBILIZED',
  ON_MOVEMENT_IMPAIRED_TARGET: 'ON_MOVEMENT_IMPAIRED_TARGET',
  ON_TAKEDOWN: 'ON_TAKEDOWN',
  ON_KILL: 'ON_KILL',
  ON_ASSIST: 'ON_ASSIST',
  ON_LOW_HEALTH: 'ON_LOW_HEALTH',
  ON_TARGET_LOW_HEALTH: 'ON_TARGET_LOW_HEALTH',
  ON_TARGET_HIGH_HEALTH: 'ON_TARGET_HIGH_HEALTH',
  ON_HEALTH_THRESHOLD_CROSSED: 'ON_HEALTH_THRESHOLD_CROSSED',
  ON_SHIELD: 'ON_SHIELD',
  ON_HEAL: 'ON_HEAL',
  ON_MOVEMENT: 'ON_MOVEMENT',
  ON_SUMMONER_SPELL_CAST: 'ON_SUMMONER_SPELL_CAST',
  ON_COMBAT_START: 'ON_COMBAT_START',
  WHILE_IN_COMBAT: 'WHILE_IN_COMBAT',
  WHILE_OUT_OF_COMBAT: 'WHILE_OUT_OF_COMBAT',
  ON_NEARBY_UNIT_DEATH: 'ON_NEARBY_UNIT_DEATH',
  ON_PLANT_DESTROYED: 'ON_PLANT_DESTROYED',
  ON_WARD_DESTROYED: 'ON_WARD_DESTROYED',
...
export const SpellEffectType = {
  ...
  SHIELD: 'SHIELD',
  MOVEMENT_SPEED: 'MOVEMENT_SPEED',
  MOVEMENT_SPEED_STEAL: 'MOVEMENT_SPEED_STEAL',
  SLOW: 'SLOW',
  DAMAGE_REDUCTION: 'DAMAGE_REDUCTION',
  CLEANSE: 'CLEANSE',
  CROWD_CONTROL_IMMUNITY: 'CROWD_CONTROL_IMMUNITY',
  ANTI_HEAL: 'ANTI_HEAL',
  TELEPORT: 'TELEPORT',
  ...
  MONSTER_DAMAGE_AMPLIFICATION: 'MONSTER_DAMAGE_AMPLIFICATION',
