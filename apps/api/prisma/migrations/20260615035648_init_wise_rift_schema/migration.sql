...
-- CreateEnum
CREATE TYPE "SkillEffect" AS ENUM ('DAMAGE', 'SLOW', 'ROOT', 'STUN', 'KNOCK_UP', 'KNOCK_BACK', 'PULL', 'CHARM', 'SILENCE', 'FEAR', 'TAUNT', 'DASH', 'BLINK', 'SPEED_UP', 'SHIELD', 'HEAL', 'STEALTH', 'UNTARGETABLE', 'INVULNERABLE', 'EXECUTE', 'EMPOWERED_ATTACK', 'TRUE_DAMAGE', 'VISION', 'ZONE_CONTROL');
