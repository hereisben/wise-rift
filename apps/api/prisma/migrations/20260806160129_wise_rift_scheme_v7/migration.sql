...
-- CreateEnum
CREATE TYPE "GameTagCategory" AS ENUM ('CHAMPION', 'SKILL', 'ITEM', 'RUNE', 'SPELL', 'SCORING', 'PLAYSTYLE', 'TEAM_COMP', 'MATCHUP', 'BUILD', 'COUNTER', 'GENERAL');
...
-- CreateEnum
CREATE TYPE "RuneEffectType" AS ENUM ('DAMAGE', 'DAMAGE_AMPLIFICATION', 'DAMAGE_REDUCTION', 'HEAL', 'SHIELD', 'MOVEMENT_SPEED', 'MOBILITY', 'SLOW_RESISTANCE', 'TENACITY', 'ATTACK_SPEED', 'ATTACK_RANGE', 'ABILITY_HASTE', 'ITEM_ABILITY_HASTE', 'COOLDOWN_REDUCTION', 'ADAPTIVE_FORCE', 'ARMOR', 'MAGIC_RESIST', 'HEALTH', 'MANA', 'PHYSICAL_VAMP', 'MAGIC_VAMP', 'OMNIVAMP', 'GOLD', 'RESOURCE_RESTORE', 'CROWD_CONTROL', 'VISION', 'STACKING', 'SCALING', 'UTILITY');

-- CreateEnum
CREATE TYPE "RuneTriggerType" AS ENUM ('ALWAYS_ACTIVE', 'ON_HIT', 'ON_ATTACK', 'ON_EMPOWERED_ATTACK', 'ON_ABILITY_HIT', 'ON_ACTIVE_ABILITY_HIT', 'ON_CHAMPION_HIT', 'ON_CHAMPION_DAMAGE_TAKEN', 'ON_IMMOBILIZE_APPLIED', 'ON_IMMOBILIZED', 'ON_MOVEMENT_IMPAIRED_TARGET', 'ON_TAKEDOWN', 'ON_KILL', 'ON_ASSIST', 'ON_LOW_HEALTH', 'ON_TARGET_LOW_HEALTH', 'ON_TARGET_HIGH_HEALTH', 'ON_HEALTH_THRESHOLD_CROSSED', 'ON_SHIELD', 'ON_HEAL', 'ON_MOVEMENT', 'ON_SUMMONER_SPELL_CAST', 'ON_COMBAT_START', 'WHILE_IN_COMBAT', 'WHILE_OUT_OF_COMBAT', 'ON_NEARBY_UNIT_DEATH', 'ON_PLANT_DESTROYED', 'ON_WARD_DESTROYED', 'AFTER_TIME', 'PERIODIC', 'STACK_BASED');

-- CreateEnum
CREATE TYPE "RuneStatType" AS ENUM ('ATTACK_DAMAGE', 'ABILITY_POWER', 'ADAPTIVE_FORCE', 'ATTACK_SPEED', 'ATTACK_RANGE', 'ABILITY_HASTE', 'ITEM_ABILITY_HASTE', 'CRITICAL_RATE', 'ARMOR', 'MAGIC_RESIST', 'HEALTH', 'MANA', 'TENACITY', 'SLOW_RESISTANCE', 'OMNIVAMP', 'PHYSICAL_VAMP', 'MAGIC_VAMP', 'MOVEMENT_SPEED', 'GOLD');

-- CreateEnum
CREATE TYPE "SpellEffectType" AS ENUM ('DAMAGE', 'TRUE_DAMAGE', 'HEAL', 'SHIELD', 'MOVEMENT_SPEED', 'MOVEMENT_SPEED_STEAL', 'SLOW', 'DAMAGE_REDUCTION', 'CLEANSE', 'CROWD_CONTROL_IMMUNITY', 'ANTI_HEAL', 'TELEPORT', 'DURATION_EXTENSION', 'EFFECT_REFRESH', 'GOLD_MODIFIER', 'EXPERIENCE_MODIFIER', 'MONSTER_DAMAGE_AMPLIFICATION', 'HEALTH_REGENERATION', 'MANA_REGENERATION', 'CHARGE_SYSTEM', 'UPGRADE', 'UTILITY');
...
-- CreateEnum
CREATE TYPE "DamageType" AS ENUM ('PHYSICAL', 'MAGIC', 'MIXED', 'TRUE_DAMAGE', 'UTILITY', 'NONE', 'UNKNOWN');

-- CreateEnum
CREATE TYPE "TargetType" AS ENUM ('SELF', 'ALLY', 'ALLIES', 'ENEMY', 'ENEMIES', 'CHAMPION', 'CHAMPIONS', 'MINION', 'MONSTER', 'EPIC_MONSTER', 'TURRET', 'STRUCTURE', 'WARD', 'PLANT', 'AREA', 'LOCATION', 'LINE');

-- CreateEnum
CREATE TYPE "SkillEffect" AS ENUM ('DAMAGE', 'SLOW', 'ROOT', 'STUN', 'KNOCK_UP', 'KNOCK_BACK', 'KNOCK_DOWN', 'PULL', 'CHARM', 'SILENCE', 'FEAR', 'TAUNT', 'DASH', 'BLINK', 'SPEED_UP', 'SHIELD', 'HEAL', 'STEALTH', 'UNTARGETABLE', 'INVULNERABLE', 'EXECUTE', 'EMPOWERED_ATTACK', 'TRUE_DAMAGE', 'VISION', 'ZONE_CONTROL', 'STASIS', 'BUFF', 'DAMAGE_REDUCTION', 'ARMOR_REDUCTION', 'REVEAL');
...
-- CreateEnum
CREATE TYPE "ItemCategory" AS ENUM ('LOW_TIER', 'MIDDLE_TIER', 'HIGH_TIER', 'COMPONENT', 'PHYSICAL', 'MAGIC', 'DEFENSIVE', 'BOOTS', 'ENCHANT', 'ACTIVE', 'TRANSFORMED', 'SUPPORT', 'JUNGLE', 'UTILITY', 'HYBRID', 'ON_HIT', 'UNKNOWN');
...
CREATE TABLE "ChampionPatchStat" (
    ...
    "resourceGrowth" DOUBLE PRECISION,
...
CREATE TABLE "ItemPatchStat" (
    ...
    "attackSpeed" DOUBLE PRECISION,
    "flatArmorPenetration" DOUBLE PRECISION,
    "percentArmorPenetration" DOUBLE PRECISION,
    "flatMagicPenetration" DOUBLE PRECISION,
    "percentMagicPenetration" DOUBLE PRECISION,
    "physicalVamp" DOUBLE PRECISION,
    "magicVamp" DOUBLE PRECISION,
    "omniVamp" DOUBLE PRECISION,
    "healthRegen" DOUBLE PRECISION,
    "manaRegen" DOUBLE PRECISION,
    "healShieldPower" DOUBLE PRECISION,
    "tenacity" DOUBLE PRECISION,
    "slowResistance" DOUBLE PRECISION,
    "flatMovementSpeed" DOUBLE PRECISION,
    "percentMovementSpeed" DOUBLE PRECISION,
...
CREATE TABLE "SpellPatchStat" (
    ...
    "chargeRechargeSeconds" DOUBLE PRECISION,
    "maxCharges" INTEGER,
...
CREATE TABLE "GameTag" (
    ...
    "description" TEXT NOT NULL,
    "descriptionVi" TEXT NOT NULL,
    "category" "GameTagCategory" NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "deletedAt" TIMESTAMP(3),
...
-- CreateIndex
CREATE UNIQUE INDEX "GameTag_key_key" ON "GameTag"("key");

-- CreateIndex
CREATE INDEX "GameTag_category_idx" ON "GameTag"("category");
