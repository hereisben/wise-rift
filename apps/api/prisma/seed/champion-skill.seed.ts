...
Chỉ áp dụng tối đa 3 Dấu Ấn Sấm Sét lên một mục tiêu.`,
  ...
  // ORNN - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Living Forge`,
    nameVi: `Lò Rèn Di Động`,
    description: `Ornn can spend gold to forge items anywhere on the map. Ornn also gains additional defensive stats as he levels.`,
    descriptionVi: `Ornn có thể dùng vàng để rèn trang bị ở bất kỳ đâu trên bản đồ. Ornn cũng nhận thêm chỉ số phòng thủ theo cấp độ.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      bonusDefensiveStatPercentByLevel: [7, 12, 17, 22],
    },
    effects: [SkillEffect.BUFF],
    tags: [
      `BONUS_RESISTANCES`,
  ...
  // ORNN - Q
  {
    ...
    nameVi: `Núi Lửa Phun Trào`,
    description: `Ornn slams the ground, creating a fissure that deals physical damage and slows enemies hit. A rock pillar forms at the fissure's end for a short duration. The fissure stops shortly after hitting an enemy champion.`,
    descriptionVi: `Ornn đập xuống đất, tạo ra một khe nứt gây sát thương vật lý và làm chậm kẻ địch trúng chiêu. Một cột đá hình thành ở cuối khe nứt trong thời gian ngắn. Khe nứt dừng lại không lâu sau khi trúng tướng địch.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [9, 9, 8, 8], unit: `seconds` },
    cost: { values: [45, 45, 45, 45], resource: `MANA` },
    range: null,
    scaling: {
  ...
  // ORNN - W
  {
    ...
    name: `Bellows Breath`,
    nameVi: `Thổi Bễ`,
    description: `Ornn stomps forward unstoppably while breathing fire, dealing max Health magic damage over a short duration. Enemies hit by the final bout of flame become Brittle. Immobilizing effects on Brittle targets last longer and deal additional max Health magic damage. Ornn's attacks against Brittle targets knock them back and deal additional damage.`,
    descriptionVi: `Ornn tiến về phía trước trong trạng thái không thể bị cản khi phun lửa, gây sát thương phép theo máu tối đa trong thời gian ngắn. Kẻ địch trúng luồng lửa cuối sẽ bị Giòn. Hiệu ứng khống chế bất động lên mục tiêu Giòn kéo dài lâu hơn và gây thêm sát thương phép theo máu tối đa. Đòn đánh của Ornn lên mục tiêu Giòn sẽ đẩy lùi và gây thêm sát thương.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: { values: [12, 11, 11, 10], unit: `seconds` },
    cost: { values: [45, 45, 45, 45], resource: `MANA` },
    range: null,
    scaling: {
      maxHealthDamagePercent: [10, 11, 12, 13],
      breathDurationSeconds: 0.75,
      brittleDurationSeconds: 3,
      immobilizeDurationAmpPercent: 30,
      brittleMaxHealthDamagePercent: 8,
      brittleLevelScalingPercentRange: [7, 22],
      minionMinimumDamage: [90, 140, 190, 240],
      monsterMaximumDamage: [155, 190, 225, 260],
      immobilizeMonsterDamageCap: 250,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.BUFF, SkillEffect.KNOCK_BACK],
    tags: [
      `MAX_HEALTH_DAMAGE`,
      `DAMAGE_OVER_TIME`,
      `UNSTOPPABLE`,
  ...
  // ORNN - E
  {
    ...
    slot: SkillSlot.E,
    name: `Searing Charge`,
    nameVi: `Xung Kích Bỏng Cháy`,
    description: `Ornn charges forward, dealing physical damage. If he collides with terrain, he creates a shockwave that knocks up enemies and deals the same damage in the area. The charge destroys magma pillars and terrain created by enemies, then reduces this skill's cooldown.`,
    descriptionVi: `Ornn lao tới, gây sát thương vật lý. Nếu va vào địa hình, hắn tạo ra một chấn động hất tung kẻ địch và gây cùng lượng sát thương trong vùng ảnh hưởng. Cú lao phá hủy cột dung nham và địa hình do kẻ địch tạo ra, sau đó giảm hồi chiêu kỹ năng này.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [13, 12, 11, 10], unit: `seconds` },
    cost: { values: [35, 35, 35, 35], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [80, 140, 200, 260],
      bonusArmorRatio: 0.4,
      bonusMagicResistRatio: 0.4,
      knockUpDurationSeconds: 1.25,
      cooldownReductionPercentOnTerrainDestroy: 25,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.DASH, SkillEffect.KNOCK_UP],
    tags: [
      `COLLISION_DASH`,
  ...
  // ORNN - R
  {
    ...
    nameVi: `Hỏa Dương Hiệu Triệu`,
    description: `Ornn summons a massive lava elemental that stampedes toward him, dealing magic damage, applying Brittle, and slowing enemies based on Ornn's level. Ornn can recast to dash with a headbutt. If he hits the elemental, he redirects and empowers it, causing it to knock up champions hit. The elemental deals magic damage again and reapplies Brittle.`,
    descriptionVi: `Ornn triệu hồi một linh thú dung nham khổng lồ lao về phía hắn, gây sát thương phép, áp dụng Giòn và làm chậm kẻ địch dựa theo cấp của Ornn. Ornn có thể tái kích hoạt để lao tới húc đầu. Nếu va vào linh thú, hắn đổi hướng và cường hóa nó, khiến nó hất tung tướng trúng phải. Linh thú gây sát thương phép lần nữa và tái áp dụng Giòn.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: { values: [90, 80, 70], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    range: null,
    scaling: {
      firstHitBaseDamage: [125, 175, 225],
      secondHitBaseDamage: [125, 175, 225],
      abilityPowerRatio: 0.2,
      brittleDurationSeconds: 3,
      slowPercentByLevelMax: 40,
      slowDurationSeconds: 2,
      firstChampionKnockUpDurationSeconds: 1,
      subsequentChampionKnockUpDurationSeconds: 0.5,
    },
    effects: [
      SkillEffect.DAMAGE,
      SkillEffect.SLOW,
  ...
  // PANTHEON - PASSIVE
  {
    ...
    name: `Mortal Will`,
    nameVi: `Chiến Ý`,
    description: `After 5 attacks or ability casts, Pantheon's next basic ability is enhanced.`,
    descriptionVi: `Sau 5 đòn đánh hoặc lần dùng kỹ năng, kỹ năng cơ bản kế tiếp của Pantheon được cường hóa.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    ...
    effects: [SkillEffect.BUFF],
    tags: [`STACKING_PASSIVE`, `EMPOWERED_ABILITY`, `EMPOWER`, `SPELL_WEAVING`],
  },
  ...
  // PANTHEON - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Comet Spear`,
    nameVi: `Ngọn Giáo Sao Băng`,
    description: `Tap cast stabs forward, dealing physical damage and refunding part of this skill's cooldown. Charge cast hurls the spear, dealing the same damage to the first enemy hit and reduced damage to subsequent targets. Low-health enemies are critically hit for higher physical damage. Mortal Will adds bonus physical damage. Damage to minions is reduced, while damage to monsters is increased.`,
    descriptionVi: `Nhấn nhanh để đâm tới trước, gây sát thương vật lý và hoàn lại một phần hồi chiêu của kỹ năng này. Giữ để ném giáo, gây cùng lượng sát thương lên kẻ địch đầu tiên trúng phải và giảm sát thương lên các mục tiêu sau. Kẻ địch thấp máu bị chí mạng với sát thương vật lý cao hơn. Chiến Ý cộng thêm sát thương vật lý. Sát thương lên lính bị giảm, còn sát thương lên quái được tăng.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [9, 8, 8, 7], unit: `seconds` },
    cost: { values: [40, 40, 40, 40], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [80, 120, 160, 200],
      attackDamageRatio: 1.2,
      cooldownRefundPercentOnTapCast: 60,
      subsequentTargetDamageReductionPercent: 50,
      executeThresholdHealthPercent: 35,
      lowHealthCriticalDamage: [120, 210, 300, 390],
      lowHealthCriticalAttackDamageRatio: 1.8,
      mortalWillBonusDamage: 30,
      mortalWillAttackDamageRatio: 1.2,
      minionDamageReductionPercent: 20,
      monsterDamagePercent: 110,
    },
    effects: [SkillEffect.DAMAGE],
    tags: [
  ...
  // PANTHEON - W
  {
    ...
    slot: SkillSlot.W,
    name: `Shield Vault`,
    nameVi: `Khiên Trời Giáng`,
    description: `Pantheon dashes to an enemy, stunning them and dealing physical damage. Mortal Will follows up with an empowered attack that strikes 3 times for bonus physical damage.`,
    descriptionVi: `Pantheon lao tới một kẻ địch, làm choáng và gây sát thương vật lý. Chiến Ý tung thêm một đòn đánh cường hóa đánh 3 lần, gây thêm sát thương vật lý.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.ENEMY,
    cooldown: { values: [12, 11, 10, 9], unit: `seconds` },
    cost: { values: [55, 55, 55, 55], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [70, 120, 170, 220],
      abilityPowerRatio: 1,
      stunDurationSeconds: 1,
      mortalWillEmpoweredAttackDamage: 87,
      mortalWillEmpoweredAttackDamageAttackDamageRatio: 1.35,
      mortalWillHitCount: 3,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.DASH, SkillEffect.STUN],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // PANTHEON - E
  {
    ...
    slot: SkillSlot.E,
    name: `Aegis Assault`,
    nameVi: `Tiến Công Vũ Bão`,
    description: `Pantheon blocks all non-tower damage from one direction for a short duration while dealing physical damage to nearby enemies. At the end, he slams forward to deal physical damage. Mortal Will grants Move Speed after the shield slam. Pantheon is slowed when moving away from the blocking direction. Recast to end early. Damage to minions is reduced.`,
    descriptionVi: `Pantheon chặn toàn bộ sát thương không đến từ trụ theo một hướng trong thời gian ngắn đồng thời gây sát thương vật lý lên kẻ địch gần đó. Khi kết thúc, hắn đập khiên về phía trước để gây sát thương vật lý. Chiến Ý cho Pantheon Tốc Độ Di Chuyển sau cú đập khiên. Pantheon bị làm chậm khi di chuyển ngược hướng chặn. Có thể tái kích hoạt để kết thúc sớm. Sát thương lên lính bị giảm.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: { values: [15, 14, 13, 12], unit: `seconds` },
    cost: { values: [80, 80, 80, 80], resource: `MANA` },
    range: null,
    scaling: {
      blockDurationSeconds: 1.5,
      nearbyDamage: 64,
      nearbyDamageAttackDamageRatio: 1,
      slamBaseDamage: [60, 120, 180, 240],
      slamAttackDamageRatio: 1.5,
      mortalWillMoveSpeedPercent: 60,
      mortalWillMoveSpeedDurationSeconds: 2.5,
      selfSlowPercentWhenMovingAway: 50,
      minionDamageReductionPercent: 50,
    },
    effects: [
      SkillEffect.DAMAGE,
      SkillEffect.DAMAGE_REDUCTION,
  ...
  // PANTHEON - R
  {
    ...
    name: `Grand Starfall`,
    nameVi: `Trời Sập`,
    description: `Passive: Pantheon gains Armor Penetration. Active: Pantheon leaps into the air and throws a spear that deals physical damage and slows enemies, then crashes down to deal magic damage in the landing area. Grand Starfall instantly readies Mortal Will. Damage is reduced near the edges of the landing area.`,
    descriptionVi: `Nội tại: Pantheon nhận Xuyên Giáp. Kích hoạt: Pantheon nhảy lên không trung và ném một ngọn giáo gây sát thương vật lý, làm chậm kẻ địch, sau đó lao xuống gây sát thương phép trong vùng đáp. Trời Sập lập tức chuẩn bị Chiến Ý. Sát thương giảm ở rìa vùng đáp.`,
    damageType: DamageType.MIXED,
    targetType: TargetType.AREA,
    cooldown: { values: [90, 80, 70], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    range: null,
    scaling: {
      armorPenetrationPercent: [10, 20, 30],
      spearDamage: 30,
      spearDamageSource: `Comet Spear damage`,
      slowPercent: 50,
      slowDurationSeconds: 2,
      landingBaseDamage: [300, 500, 700],
      landingAbilityPowerRatio: 1,
      edgeDamageReductionPercent: 50,
      mortalWillReadyOnCast: true,
    },
    effects: [
      SkillEffect.DAMAGE,
      SkillEffect.SLOW,
  ...
  // POPPY - PASSIVE
  {
    ...
    nameVi: `Sứ Giả Thép`,
    description: `Every 12 seconds, Poppy's next attack throws her buckler, gaining bonus Attack Range and dealing bonus magic damage. The buckler ricochets off the target and lands nearby for a short duration. Poppy can pick it up to gain a shield based on max Health. If the buckler kills the target or the target dies before being hit, it automatically returns to Poppy.`,
    descriptionVi: `Mỗi 12 giây, đòn đánh kế tiếp của Poppy ném khiên, nhận thêm tầm đánh và gây thêm sát thương phép. Chiếc khiên bật khỏi mục tiêu và rơi gần đó trong thời gian ngắn. Poppy có thể nhặt lại để nhận lá chắn dựa trên máu tối đa. Nếu khiên kết liễu mục tiêu hoặc mục tiêu chết trước khi bị trúng, khiên tự động quay về với Poppy.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.ENEMY,
    cooldown: { values: [12], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      bonusAttackRange: 350,
      bonusMagicDamage: 20,
      bucklerGroundDurationSeconds: 4,
      shieldValue: 86,
      shieldMaxHealthRatio: 0.13,
      shieldDurationSeconds: 3,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SHIELD],
    tags: [
  ...
  // POPPY - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Hammer Shock`,
    nameVi: `Búa Chấn Động`,
    description: `Poppy smashes the ground, dealing physical damage plus max Health physical damage and making the ground unstable. The unstable area slows enemies and monsters, then erupts after a short delay to deal the same physical damage again. Percent Health damage is capped against monsters.`,
    descriptionVi: `Poppy đập búa xuống đất, gây sát thương vật lý cộng thêm sát thương vật lý theo máu tối đa và khiến mặt đất bất ổn. Vùng bất ổn làm chậm kẻ địch và quái, sau đó nổ sau một khoảng trễ ngắn để gây lại cùng lượng sát thương vật lý. Sát thương theo máu bị giới hạn lên quái.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: { values: [7, 6, 5, 4], unit: `seconds` },
    cost: { values: [30, 30, 30, 30], resource: `MANA` },
    range: null,
    scaling: {
      baseDamagePerHit: [50, 70, 90, 110],
      bonusAttackDamageRatioPerHit: 0.9,
      maxHealthDamagePercentPerHit: 9,
      slowPercent: [25, 30, 35, 40],
      eruptionDelaySeconds: 1,
      monsterPercentHealthDamageCapPerHit: [40, 100, 160, 220],
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // POPPY - W
  {
    ...
    nameVi: `Không Thể Lay Chuyển`,
    description: `Passive: Poppy gains bonus Armor and Magic Resist, doubled when she is low Health. Active: Poppy gains Move Speed and projects a field around herself that stops enemy dashes. Enemies stopped by the field take magic damage, become grounded, and are slowed.`,
    descriptionVi: `Nội tại: Poppy nhận thêm Giáp và Kháng Phép, tăng gấp đôi khi cô thấp máu. Kích hoạt: Poppy nhận Tốc Độ Di Chuyển và tạo một vùng quanh bản thân ngăn kẻ địch lướt. Kẻ địch bị chặn bởi vùng này nhận sát thương phép, bị sa lầy và bị làm chậm.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: { values: [19, 16, 14, 11], unit: `seconds` },
    cost: { values: [40, 40, 40, 40], resource: `MANA` },
    range: null,
    scaling: {
      bonusArmorPercent: 12,
      bonusMagicResistPercent: 12,
      doubledBonusHealthThresholdPercent: 40,
      activeMoveSpeedPercent: 40,
      fieldDurationSeconds: 2,
      dashStopDamage: [95, 140, 185, 230],
      abilityPowerRatio: 0.7,
      groundedDurationSeconds: 2,
      slowPercent: 25,
      slowDurationSeconds: 2,
    },
    effects: [
  ...
  // POPPY - E
  {
    ...
    slot: SkillSlot.E,
    name: `Heroic Charge`,
    nameVi: `Xung Phong Anh Dũng`,
    description: `Poppy tackles an enemy, dealing physical damage and carrying them forward. If the target collides with terrain, they are stunned and take additional physical damage.`,
    descriptionVi: `Poppy lao vào một kẻ địch, gây sát thương vật lý và đẩy chúng về phía trước. Nếu mục tiêu va vào địa hình, chúng bị làm choáng và nhận thêm sát thương vật lý.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.ENEMY,
    cooldown: { values: [13, 12, 11, 10], unit: `seconds` },
    cost: { values: [60, 60, 60, 60], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [75, 100, 125, 150],
      bonusAttackDamageRatio: 0.5,
      terrainCollisionStunDurationSeconds: [1.7, 1.8, 1.9, 2],
      terrainCollisionBonusDamage: [75, 100, 125, 150],
      terrainCollisionBonusAttackDamageRatio: 0.5,
    },
    effects: [
      SkillEffect.DAMAGE,
      SkillEffect.DASH,
  ...
  // POPPY - R
  {
    ...
    nameVi: `Sứ Giả Phán Quyết`,
    description: `Hold: Poppy charges her hammer for up to several seconds, slowing herself. Release: Poppy smashes the ground, creating a shockwave that deals physical damage to the first enemy champion hit and nearby enemies, knocks them back toward their Nexus, and makes them untargetable while they fly. Range and knockback distance increase with charge duration. An uncharged smash deals reduced physical damage and knocks enemies airborne.`,
    descriptionVi: `Giữ: Poppy tụ lực chiếc búa trong vài giây, tự làm chậm bản thân. Thả: Poppy đập xuống đất, tạo sóng chấn động gây sát thương vật lý lên tướng địch đầu tiên trúng phải và kẻ địch gần đó, đẩy lùi chúng về phía Nhà Chính và khiến chúng không thể bị chọn làm mục tiêu khi đang bay. Tầm và khoảng cách đẩy lùi tăng theo thời gian tụ lực. Cú đập không tụ lực gây sát thương vật lý thấp hơn và hất tung kẻ địch.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [90, 80, 70], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    range: null,
    scaling: {
      maxChargeDurationSeconds: 4,
      selfSlowPercentWhileCharging: 15,
      chargedDamage: [200, 300, 400],
      chargedBonusAttackDamageRatio: 0.9,
      unchargedDamage: [100, 150, 200],
      unchargedBonusAttackDamageRatio: 0.45,
      unchargedKnockUpDurationSeconds: 1,
      rangeScalesWithChargeDuration: true,
      knockBackDistanceScalesWithChargeDuration: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.KNOCK_BACK, SkillEffect.KNOCK_UP],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // PYKE - PASSIVE
  {
    ...
    nameVi: `Quà Của Kẻ Chết Đuối`,
    description: `Pyke stores a portion of damage taken from enemy champions, increased when multiple visible enemy champions are nearby. When Pyke is not visible to enemies, he heals for the amount of stored damage. Pyke cannot increase his max Health and converts bonus Health into Attack Damage.`,
    descriptionVi: `Pyke tích trữ một phần sát thương nhận từ tướng địch, tăng lên khi có nhiều tướng địch nhìn thấy ở gần. Khi Pyke không bị kẻ địch nhìn thấy, hắn hồi lại lượng sát thương đã tích trữ. Pyke không thể tăng máu tối đa và chuyển hóa máu cộng thêm thành Sức Mạnh Công Kích.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      storedDamagePercent: 10,
      storedDamageLethalityRatio: 0.35,
      nearbyEnemyStoredDamagePercent: 50,
      nearbyEnemyStoredDamageLethalityRatio: 0.65,
      nearbyEnemyThreshold: 2,
      storedDamageFlatCap: 160,
      storedDamageHealthCapPercent: 65,
      storedDamageBonusAttackDamageCapBase: 160,
      storedDamageBonusAttackDamageCapRatio: 8,
      bonusHealthToAttackDamageRatio: {
        bonusHealth: 14,
        attackDamage: 1,
      },
    },
  ...
  // PYKE - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Bone Skewer`,
    nameVi: `Đâm Thấu Xương`,
    description: `Pyke charges his spear, slowing himself while increasing cast range, then releases to hurl the spear and deal physical damage, heavily slow the target, and pull them in. Releasing immediately causes Pyke to thrust instead, dealing the same damage. Bone Skewer deals reduced damage to minions and monsters. If overcharged, it refunds part of its cooldown and mana cost.`,
    descriptionVi: `Pyke tụ lực ngọn giáo, tự làm chậm bản thân đồng thời tăng tầm dùng chiêu, rồi thả ra để phóng giáo gây sát thương vật lý, làm chậm mạnh mục tiêu và kéo chúng lại. Thả ngay lập tức khiến Pyke đâm giáo thay vì ném, gây cùng lượng sát thương. Đâm Thấu Xương gây giảm sát thương lên lính và quái. Nếu tụ quá mức, kỹ năng hoàn lại một phần hồi chiêu và năng lượng tiêu hao.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [10, 9, 8, 7], unit: `seconds` },
    cost: { values: [35, 40, 45, 50], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [130, 195, 260, 325],
      attackDamageRatio: 0.6,
      selfSlowPercentWhileCharging: 15,
      maxChargeDurationSeconds: 3,
      rangeIncreaseDurationSeconds: 0.8,
      slowPercent: 90,
      slowDurationSeconds: 1,
      minionAndMonsterDamagePercent: 50,
      overchargeManaRefundPercent: 50,
    },
  ...
  // PYKE - W
  {
    ...
    nameVi: `Lặn Mất Tăm`,
    description: `Pyke becomes camouflaged and gains a burst of Movement Speed that decays over the duration.`,
    descriptionVi: `Pyke ngụy trang và nhận một lượng Tốc Độ Di Chuyển giảm dần theo thời gian hiệu lực.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: { values: [11, 10, 10, 9], unit: `seconds` },
    cost: { values: [50, 50, 50, 50], resource: `MANA` },
    range: null,
    scaling: {
      camouflageDurationSeconds: 5,
      moveSpeedPercent: 40,
      moveSpeedLethalityRatio: 2,
      movementSpeedDecaysOverDuration: true,
    },
    effects: [SkillEffect.BUFF, SkillEffect.SPEED_UP],
    tags: [
      `CAMOUFLAGE`,
  ...
  // PYKE - E
  {
    ...
    nameVi: `Dòng Nước Ma Quái`,
    description: `Pyke dashes forward, leaving behind a phantom. After a delay, the phantom returns to Pyke, dealing physical damage and stunning enemies hit. This skill deals reduced damage to minions and monsters.`,
    descriptionVi: `Pyke lướt tới trước, để lại một bóng ma phía sau. Sau một khoảng trễ, bóng ma quay lại chỗ Pyke, gây sát thương vật lý và làm choáng kẻ địch trúng phải. Kỹ năng này gây giảm sát thương lên lính và quái.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [11, 11, 10, 10], unit: `seconds` },
    cost: { values: [40, 40, 40, 40], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [120, 175, 230, 285],
      attackDamageRatio: 1,
      phantomReturnDelaySeconds: 1,
      stunDurationSeconds: 1.5,
      stunDurationLethalityRatio: 0.01,
      minionAndMonsterDamagePercent: 50,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.DASH, SkillEffect.STUN],
    tags: [
  ...
  // PYKE - R
  {
    ...
    nameVi: `Tử Thần Đáy Sâu`,
    description: `Pyke marks an X-shaped area, executing enemy champions below a health threshold. Non-champions and champions above the threshold take reduced physical damage. If an enemy champion is struck, Pyke blinks to the location. If the target is executed, Pyke can recast Death from Below for a limited time. Pyke earns additional gold when he executes an enemy, and assisting teammates can receive additional gold.`,
    descriptionVi: `Pyke đánh dấu một vùng hình chữ X, hành quyết tướng địch dưới ngưỡng máu. Mục tiêu không phải tướng và tướng trên ngưỡng máu nhận sát thương vật lý giảm. Nếu trúng tướng địch, Pyke dịch chuyển chớp nhoáng tới vị trí đó. Nếu mục tiêu bị hành quyết, Pyke có thể tái kích hoạt Tử Thần Đáy Sâu trong thời gian giới hạn. Pyke nhận thêm vàng khi hành quyết kẻ địch, và đồng đội hỗ trợ cũng có thể nhận thêm vàng.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: { values: [80, 70, 60], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    range: null,
    scaling: {
      executeThreshold: [250, 400, 550],
      attackDamageRatio: 0.8,
      lethalityRatio: 2.5,
      nonExecuteDamagePercent: 50,
      recastWindowSeconds: 15,
      pykeExecuteAdditionalGoldPercent: 100,
      teammateAssistAdditionalGoldPercent: 120,
      pykeAssistAdditionalGoldPercent: 160,
      pykeAssistAdditionalGoldCap: 600,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.DASH],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // RAKAN - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Fey Feathers`,
    nameVi: `Bộ Cánh Ma Thuật`,
    description: `Rakan periodically gains a health shield. Attacks and abilities on enemy champions reduce this cooldown. Lover's Leap allows Xayah and Rakan to join each other's recall, returning to the Summoning Platform when the initiator's recall ends.`,
    descriptionVi: `Rakan định kỳ nhận một lá chắn máu. Đòn đánh và kỹ năng trúng tướng địch giảm hồi chiêu này. Vũ Điệu Tình Nhân cho phép Xayah và Rakan tham gia biến về cùng nhau, cả hai trở về Bệ Đá Cổ khi thời gian biến về của người khởi xướng kết thúc.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: { values: [35, 14], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      shieldValue: 31,
      abilityPowerRatio: 0.8,
      cooldownReductionOnChampionHitSeconds: 1,
      loverRecallSynergy: true,
    },
    effects: [SkillEffect.SHIELD, SkillEffect.BUFF],
    tags: [
      `SELF_SHIELD`,
  ...
  // RAKAN - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Gleaming Quill`,
    nameVi: `Phi Tiêu Lấp Lánh`,
    description: `Rakan flings a magical feather that deals magic damage to the first enemy hit. If the feather hits a champion or epic monster, Rakan restores health to himself and nearby allies after a delay or when he touches an ally.`,
    descriptionVi: `Rakan phóng một chiếc lông vũ ma thuật gây sát thương phép lên kẻ địch đầu tiên trúng phải. Nếu lông vũ trúng tướng hoặc quái khủng, Rakan hồi máu cho bản thân và đồng minh gần đó sau một khoảng trễ hoặc khi chạm vào đồng minh.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: { values: [10, 9, 8, 7], unit: `seconds` },
    cost: { values: [60, 60, 60, 60], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [90, 150, 210, 270],
      abilityPowerRatio: 0.6,
      healValueByLevelRange: [56, 140],
      healAbilityPowerRatio: 0.7,
      delayedHealSeconds: 3,
      earlyHealOnAllyTouch: true,
      healTriggerTargets: [`CHAMPION`, `EPIC_MONSTER`],
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.HEAL],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // RAKAN - W
  {
    ...
    slot: SkillSlot.W,
    name: `Grand Entrance`,
    nameVi: `Xuất Hiện Hoành Tráng`,
    description: `Rakan dashes to a target location. Upon arrival, he leaps into the air, dealing magic damage and knocking up enemies.`,
    descriptionVi: `Rakan lướt tới vị trí chỉ định. Khi đến nơi, hắn nhảy lên không trung, gây sát thương phép và hất tung kẻ địch.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LOCATION,
    cooldown: { values: [16, 14, 12, 10], unit: `seconds` },
    cost: { values: [50, 60, 70, 80], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [70, 135, 200, 265],
      abilityPowerRatio: 0.45,
      knockUpDurationSeconds: 1,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.DASH, SkillEffect.KNOCK_UP],
  ...
  // RAKAN - E
  {
    ...
    slot: SkillSlot.E,
    name: `Battle Dance`,
    nameVi: `Điệu Nhảy Tiếp Viện`,
    description: `Rakan flies to an allied champion, granting them a shield. Battle Dance can be recast for free within a short window. When cast on Xayah, the shield amount is increased and the cooldown is reduced.`,
    descriptionVi: `Rakan bay tới một tướng đồng minh, trao cho họ một lá chắn. Điệu Nhảy Tiếp Viện có thể tái kích hoạt miễn phí trong thời gian ngắn. Khi dùng lên Xayah, lượng lá chắn tăng và hồi chiêu được giảm.`,
    damageType: DamageType.NONE,
    targetType: TargetType.ALLY,
    cooldown: { values: [18, 16, 14, 12], unit: `seconds` },
    cost: { values: [60, 70, 80, 90], resource: `MANA` },
    range: null,
    scaling: {
      shieldValue: [50, 80, 110, 140],
      abilityPowerRatio: 0.65,
      shieldDurationSeconds: 3,
      recastWindowSeconds: 5,
      recastCostFree: true,
      xayahShieldIncreasePercent: 25,
      xayahCooldownReduced: true,
    },
    effects: [SkillEffect.DASH, SkillEffect.SHIELD],
    tags: [
      `ALLY_DASH`,
  ...
  // RAKAN - R
  {
    ...
    slot: SkillSlot.R,
    name: `The Quickness`,
    nameVi: `Bộ Pháp Thần Tốc`,
    description: `Rakan gains Movement Speed for a short duration. Touching enemies deals magic damage and charms them once per unit. The first champion charmed grants Rakan additional decaying Movement Speed.`,
    descriptionVi: `Rakan nhận Tốc Độ Di Chuyển trong thời gian ngắn. Chạm vào kẻ địch gây sát thương phép và mê hoặc chúng một lần trên mỗi đơn vị. Tướng đầu tiên bị mê hoặc cho Rakan thêm Tốc Độ Di Chuyển giảm dần.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: { values: [80, 70, 60], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    ...
    scaling: {
      ...
      abilityPowerRatio: 0.5,
      charmDurationSeconds: [1, 1.25, 1.5],
      oncePerUnit: true,
      firstChampionCharmMoveSpeedPercent: 75,
      firstChampionCharmMoveSpeedDecays: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SPEED_UP, SkillEffect.CHARM],
    tags: [
      `MAGIC_DAMAGE`,
      `SPEED_UP`,
      `CHARM`,
  ...
  // RAMMUS - PASSIVE
  {
    ...
    nameVi: `Tê Tê Lăn Bánh`,
    description: `While out of combat, Rammus gains bonus Movement Speed. This bonus is increased during Powerball. Rammus exits combat after not taking damage or using abilities for a short duration.`,
    descriptionVi: `Khi ngoài giao tranh, Rammus nhận thêm Tốc Độ Di Chuyển. Lượng cộng thêm này tăng khi đang dùng Quả Cầu Tốc Độ. Rammus rời giao tranh sau khi không nhận sát thương hoặc dùng kỹ năng trong một khoảng thời gian ngắn.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      outOfCombatMoveSpeed: 32,
      powerballMoveSpeedBase: 60,
      powerballMoveSpeedPerLevel: 1,
      exitCombatDelaySeconds: 5,
    },
    effects: [SkillEffect.BUFF, SkillEffect.SPEED_UP],
    tags: [`SPEED_UP`, `MOVEMENT_SPEED_SCALING`, `OUT_OF_COMBAT_BURST`],
  },
  ...
  // RAMMUS - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Powerball`,
    nameVi: `Quả Cầu Tốc Độ`,
    description: `Rammus accelerates over several seconds, gaining bonus Movement Speed. Colliding with an enemy deals area magic damage, knocks back enemies, and slows them. Activating Powerball cancels Defensive Ball Curl and puts it on cooldown.`,
    descriptionVi: `Rammus tăng tốc trong vài giây, nhận thêm Tốc Độ Di Chuyển. Va vào kẻ địch gây sát thương phép diện rộng, đẩy lùi và làm chậm chúng. Kích hoạt Quả Cầu Tốc Độ sẽ hủy Thế Thủ và đưa kỹ năng đó vào hồi chiêu.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: { values: [12, 10, 8, 6], unit: `seconds` },
    cost: { values: [65, 65, 65, 65], resource: `MANA` },
    range: null,
    scaling: {
      maxMoveSpeedPercentBase: 115,
      maxMoveSpeedPercentPerLevel: 5,
      accelerationDurationSeconds: 6,
      baseDamage: [80, 110, 140, 170],
      abilityPowerRatio: 1,
      slowPercent: [40, 50, 60, 70],
      slowDurationSeconds: 1,
      cancelsDefensiveBallCurl: true,
    },
    effects: [
      SkillEffect.DAMAGE,
      SkillEffect.SPEED_UP,
  ...
  // RAMMUS - W
  {
    ...
    nameVi: `Thế Thủ`,
    description: `Passive: Rammus's attacks deal bonus magic damage based on Armor. Active: Rammus braces for several seconds, gaining Armor and Magic Resist. While curled, Spiked Shell deals increased damage and also applies to enemies that attack Rammus. This skill deals increased damage to monsters. Activating Defensive Ball Curl cancels Powerball and puts it on cooldown.`,
    descriptionVi: `Nội tại: Đòn đánh của Rammus gây thêm sát thương phép dựa trên Giáp. Kích hoạt: Rammus co mình phòng thủ trong vài giây, nhận thêm Giáp và Kháng Phép. Khi đang co mình, Mai Gai gây thêm sát thương và cũng áp dụng lên kẻ địch tấn công Rammus. Kỹ năng này gây thêm sát thương lên quái. Kích hoạt Thế Thủ sẽ hủy Quả Cầu Tốc Độ và đưa kỹ năng đó vào hồi chiêu.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: { values: [7, 7, 7, 7], unit: `seconds` },
    cost: { values: [40, 40, 40, 40], resource: `MANA` },
    range: null,
    scaling: {
      spikedShellBonusDamage: [12, 14, 16, 18],
      spikedShellArmorRatio: 0.1,
      activeDurationSeconds: 6,
      bonusArmorFlat: 30,
      bonusArmorRatio: [0.45, 0.5, 0.55, 0.6],
      bonusMagicResistFlat: 10,
      bonusMagicResistRatio: [0.35, 0.4, 0.45, 0.5],
      curledSpikedShellDamageIncreasePercent: 40,
      monsterDamagePercent: 175,
      cancelsPowerball: true,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // RAMMUS - E
  {
    ...
    nameVi: `Khiêu Khích Điên Cuồng`,
    description: `Rammus taunts an enemy champion or monster and gains decaying Attack Speed for several seconds.`,
    descriptionVi: `Rammus khiêu khích một tướng địch hoặc quái và nhận Tốc Độ Đánh giảm dần trong vài giây.`,
    damageType: DamageType.NONE,
    targetType: TargetType.ENEMY,
    cooldown: { values: [14, 13, 13, 12], unit: `seconds` },
    cost: { values: [50, 50, 50, 50], resource: `MANA` },
    range: null,
    scaling: {
      tauntDurationSeconds: [1.25, 1.5, 1.75, 2],
      attackSpeedPercent: [35, 45, 55, 65],
      attackSpeedDurationSeconds: 5,
      attackSpeedDecaysOverDuration: true,
      validTargets: [`CHAMPION`, `MONSTER`],
    },
    effects: [SkillEffect.TAUNT, SkillEffect.BUFF],
    tags: [
      `TAUNT`,
      `LOCK_ON`,
      `ATTACK_SPEED_STEROID`,
  ...
  // RAMMUS - R
  {
    ...
    slot: SkillSlot.R,
    name: `Soaring Slam`,
    nameVi: `Cú Nhảy Chấn Động`,
    description: `Rammus hops into the air and slams down, dealing magic damage and creating aftershocks for several seconds. Aftershocks deal magic damage every second and incrementally slow enemies, stacking up to a cap. If used during Powerball, Powerball's effects are applied at the center of the landing zone. Soaring Slam's range increases with Movement Speed and it can damage structures.`,
    descriptionVi: `Rammus nhảy lên không trung rồi đập xuống, gây sát thương phép và tạo dư chấn trong vài giây. Dư chấn gây sát thương phép mỗi giây và làm chậm kẻ địch tăng dần, cộng dồn đến giới hạn. Nếu dùng khi đang trong Quả Cầu Tốc Độ, hiệu ứng của Quả Cầu Tốc Độ được áp dụng tại tâm vùng đáp. Tầm dùng Cú Nhảy Chấn Động tăng theo Tốc Độ Di Chuyển và có thể gây sát thương lên công trình.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: { values: [70, 60, 50], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    range: null,
    scaling: {
      impactDamage: [75, 150, 225],
      abilityPowerRatio: [0.5, 0.6, 0.7],
      aftershockDurationSeconds: 4,
      aftershockDamagePerSecond: 30,
      aftershockAbilityPowerRatio: 0.2,
      slowStackPercent: 10,
      maxSlowPercent: 50,
      powerballEffectAppliedIfUsedDuringPowerball: true,
      rangeScalesWithMovementSpeed: true,
  ...
  // RELL - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Break the Mold`,
    nameVi: `Phá Vỡ Khuôn Mẫu`,
    description: `Rell's attacks and abilities steal Armor and Magic Resist from enemies hit for a short duration, stacking per target. Her attacks also deal bonus magic damage on hit based on her Armor and Magic Resist. Rell steals a minimum amount of Armor and Magic Resist and does not steal from minions or epic monsters.`,
    descriptionVi: `Đòn đánh và kỹ năng của Rell đánh cắp Giáp và Kháng Phép từ kẻ địch trúng phải trong thời gian ngắn, cộng dồn trên từng mục tiêu. Đòn đánh của cô cũng gây thêm sát thương phép trên đòn đánh dựa trên Giáp và Kháng Phép. Rell đánh cắp tối thiểu một lượng Giáp và Kháng Phép, nhưng không đánh cắp từ lính hoặc quái khủng.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.ENEMY,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      armorStealPercentPerStack: 2.5,
      magicResistStealPercentPerStack: 2.5,
      durationSeconds: 5,
      maxTotalStealPercent: 12.5,
      maxStacksPerTarget: 5,
      onHitBonusMagicDamage: 4,
      onHitArmorRatio: 0.05,
      onHitMagicResistRatio: 0.05,
      minimumArmorAndMagicResistStealByLevelRange: [1.5, 3],
      doesNotStealFrom: [`MINION`, `EPIC_MONSTER`],
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.BUFF],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // RELL - Q
  {
    ...
    nameVi: `Tấn Công Phá Vỡ`,
    description: `Rell thrusts her lance, dealing magic damage, stunning enemies hit, and destroying all shields. This skill does not break shields on monsters.`,
    descriptionVi: `Rell đâm thương tới trước, gây sát thương phép, làm choáng kẻ địch trúng phải và phá hủy toàn bộ lá chắn. Kỹ năng này không phá lá chắn trên quái.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: { values: [11, 10, 9, 8], unit: `seconds` },
    cost: { values: [50, 50, 50, 50], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [70, 130, 190, 250],
      abilityPowerRatio: 0.5,
      stunDurationSeconds: 0.65,
      destroysShields: true,
      doesNotBreakMonsterShields: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.STUN],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // RELL - W
  {
    ...
    nameVi: `Thiết Kỵ - Rơi Xuống / Lên Ngựa`,
    description: `Mounted Alacrity: Rell gains bonus Movement Speed while mounted. Crash Down: Rell leaps off her mount, dealing magic damage, knocking up enemies, and gaining a max Health shield that lasts until she remounts. Rell then enters Armored Form. While dismounted, she gains Armor, Magic Resist, Attack Speed, and Attack Range. Mount Up: Rell mounts up, gains decaying Movement Speed, and empowers her next attack to knock up enemies, throw them behind her, and deal bonus magic damage. Rell then returns to Mounted Form.`,
    descriptionVi: `Nhanh Nhẹn Khi Cưỡi: Rell nhận thêm Tốc Độ Di Chuyển khi đang cưỡi. Rơi Xuống: Rell nhảy khỏi thú cưỡi, gây sát thương phép, hất tung kẻ địch và nhận lá chắn theo máu tối đa tồn tại đến khi cô lên ngựa lại. Rell sau đó vào Dạng Giáp. Khi xuống ngựa, cô nhận thêm Giáp, Kháng Phép, Tốc Độ Đánh và Tầm Đánh. Lên Ngựa: Rell cưỡi lên lại, nhận Tốc Độ Di Chuyển giảm dần, và cường hóa đòn đánh kế tiếp để hất tung kẻ địch, ném chúng ra sau cô và gây thêm sát thương phép. Rell sau đó trở lại Dạng Cưỡi.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: { values: [9, 9, 9, 9], unit: `seconds` },
    cost: { values: [40, 40, 40, 40], resource: `MANA` },
    range: null,
    scaling: {
      mountedMoveSpeed: 15,
      crashDownDamage: [70, 100, 130, 160],
      crashDownAbilityPowerRatio: 0.5,
      crashDownShield: [30, 60, 90, 120],
      crashDownShieldMaxHealthRatio: 0.13,
      shieldLastsUntilRemount: true,
      armoredFormBonusArmorPercent: 12,
      armoredFormBonusMagicResistPercent: 12,
      armoredFormAttackSpeedPercent: 20,
      armoredFormAttackRange: 75,
      mountUpMoveSpeedPercent: 30,
      mountUpMoveSpeedDurationSeconds: 2,
      mountUpEmpoweredAttackWindowSeconds: 3.5,
      mountUpBonusDamage: [15, 30, 45, 60],
      mountUpAbilityPowerRatio: 0.35,
    },
    effects: [
      SkillEffect.DAMAGE,
      SkillEffect.KNOCK_UP,
  ...
  // RELL - E
  {
    ...
    slot: SkillSlot.E,
    name: `Full Tilt`,
    nameVi: `Tốc Lực Toàn Phần`,
    description: `Rell charges, granting herself and a nearby allied champion Movement Speed. If no target is selected, the nearest allied champion receives the bonus. This bonus increases when facing enemy champions or each other. Rell's next attack or Shattering Strike explodes in an area, dealing max Health magic damage. Damage is capped against monsters and structures.`,
    descriptionVi: `Rell lao tới, cho bản thân và một tướng đồng minh gần đó Tốc Độ Di Chuyển. Nếu không chọn mục tiêu, tướng đồng minh gần nhất sẽ nhận hiệu ứng. Lượng tăng này mạnh hơn khi hướng về tướng địch hoặc hướng về nhau. Đòn đánh kế tiếp hoặc Tấn Công Phá Vỡ của Rell phát nổ trong vùng ảnh hưởng, gây sát thương phép theo máu tối đa. Sát thương bị giới hạn lên quái và công trình.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.ALLY,
    cooldown: { values: [13, 13, 13, 13], unit: `seconds` },
    cost: { values: [40, 40, 40, 40], resource: `MANA` },
    range: null,
    scaling: {
      baseMoveSpeedPercent: 10,
      empoweredMoveSpeedPercent: 25,
      empoweredMoveSpeedDurationSeconds: 3,
      maxHealthDamagePercent: [5.5, 6, 6.5, 7],
      abilityPowerRatio: 0.03,
      monsterAndStructureDamageCap: 150,
      canTriggerWith: [`BASIC_ATTACK`, `SHATTERING_STRIKE`],
    },
    effects: [SkillEffect.SPEED_UP, SkillEffect.DAMAGE, SkillEffect.BUFF],
    tags: [
      `MAGIC_DAMAGE`,
      `SPEED_UP`,
      `ALLY_BUFF`,
  ...
  // RELL - R
  {
    ...
    name: `Magnet Storm`,
    nameVi: `Bão Nam Châm`,
    description: `Rell explodes in fury, pulling nearby enemy champions toward herself. While Magnet Storm is active, it constantly pulls nearby enemies toward Rell and deals magic damage over a short duration.`,
    descriptionVi: `Rell bùng nổ thịnh nộ, kéo các tướng địch gần đó về phía bản thân. Khi Bão Nam Châm đang hoạt động, nó liên tục kéo kẻ địch gần đó về phía Rell và gây sát thương phép trong thời gian ngắn.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: { values: [75, 70, 65], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    range: null,
    scaling: {
      totalDamage: [120, 200, 280],
      abilityPowerRatio: 1,
      durationSeconds: 2,
      continuousPull: true,
    },
  ...
  // RENEKTON - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Reign of Anger`,
    nameVi: `Đế Chế Cuồng Nộ`,
    description: `Casting abilities with enough Fury consumes that Fury for enhanced effects. Enhanced abilities do not generate Fury. Renekton's attacks generate Fury, and Fury gains are increased when he is low Health. Out of combat, Fury dissipates every second.`,
    descriptionVi: `Dùng kỹ năng khi có đủ Nộ sẽ tiêu hao Nộ để cường hóa hiệu ứng. Kỹ năng đã cường hóa không tạo thêm Nộ. Đòn đánh của Renekton tạo Nộ, và lượng Nộ nhận được tăng khi hắn thấp máu. Khi ngoài giao tranh, Nộ giảm dần mỗi giây.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      empoweredFuryThreshold: 50,
      furyPerAttack: 5,
      lowHealthFuryGainIncreasePercent: 50,
      lowHealthThresholdPercent: 50,
      outOfCombatFuryDecayPerSecond: 4,
    },
    effects: [SkillEffect.BUFF],
    tags: [
      `RAGE`,
  ...
  // RENEKTON - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Cull the Meek`,
    nameVi: `Vũ Điệu Cá Sấu`,
    description: `Renekton deals physical damage to nearby enemies, generates Fury for each enemy hit, and heals based on enemies hit, with stronger healing against enemy champions. Reign of Anger increases the damage and greatly increases the healing.`,
    descriptionVi: `Renekton gây sát thương vật lý lên kẻ địch xung quanh, tạo Nộ với mỗi kẻ địch trúng chiêu và hồi máu dựa trên số mục tiêu trúng phải, hồi nhiều hơn khi trúng tướng địch. Đế Chế Cuồng Nộ tăng sát thương và tăng mạnh lượng hồi máu.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: { values: [7, 7, 7, 7], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      baseDamage: [80, 130, 180, 230],
      attackDamageRatio: 0.9,
      furyGeneratedPerEnemyHit: 5,
      furyGeneratedPerChampionHit: 10,
      healPerEnemyHit: [4, 6, 8, 10],
      healBonusAttackDamageRatioPerEnemyHit: 0.05,
      healPerChampionHit: [16, 24, 32, 40],
      healBonusAttackDamageRatioPerChampionHit: 0.2,
      empoweredDamage: [120, 195, 270, 345],
      empoweredAttackDamageRatio: 1.35,
      empoweredHealingIncreasePercent: 200,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.HEAL],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // RENEKTON - W
  {
    ...
    nameVi: `Kẻ Săn Mồi Tàn Nhẫn`,
    description: `Renekton empowers his next attack to strike twice, stunning the target and dealing physical damage. Reign of Anger makes the attack strike three times, increases the stun duration, and increases the damage. Under Red Fury, this skill clears all shields on the target. Hitting an enemy champion grants additional Fury.`,
    descriptionVi: `Renekton cường hóa đòn đánh kế tiếp để đánh hai lần, làm choáng mục tiêu và gây sát thương vật lý. Đế Chế Cuồng Nộ khiến đòn đánh đánh ba lần, tăng thời gian làm choáng và tăng sát thương. Khi ở trạng thái Nộ Đỏ, kỹ năng này xóa toàn bộ lá chắn trên mục tiêu. Trúng tướng địch sẽ nhận thêm Nộ.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.ENEMY,
    cooldown: { values: [14, 12, 10, 8], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      hitCount: 2,
      stunDurationSeconds: 0.75,
      baseDamage: [24, 48, 72, 96],
      attackDamageRatio: 1.5,
      empoweredHitCount: 3,
      empoweredStunDurationSeconds: 1.5,
      empoweredDamage: [36, 72, 108, 144],
      empoweredAttackDamageRatio: 2.25,
      redFuryClearsTargetShields: true,
      furyGeneratedOnChampionHit: 10,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.STUN],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // RENEKTON - E
  {
    ...
    name: `Slice and Dice`,
    nameVi: `Cắt Và Xắt`,
    description: `Renekton dashes in a direction, dealing physical damage and generating Fury for each enemy passed through, with more Fury against enemy champions. Hitting an enemy grants a second dash for a short window. Reign of Anger empowers the second dash to deal higher physical damage, shred Armor, and restore Fury over time when an enemy champion is hit.`,
    descriptionVi: `Renekton lướt theo hướng chỉ định, gây sát thương vật lý và tạo Nộ với mỗi kẻ địch đi xuyên qua, tạo nhiều Nộ hơn khi trúng tướng địch. Trúng kẻ địch cho phép dùng cú lướt thứ hai trong thời gian ngắn. Đế Chế Cuồng Nộ cường hóa cú lướt thứ hai để gây sát thương vật lý cao hơn, giảm Giáp và hồi Nộ theo thời gian khi trúng tướng địch.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [14, 13, 11, 10], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      baseDamage: [40, 80, 120, 160],
      attackDamageRatio: 0.9,
      furyGeneratedPerEnemyHit: 5,
      furyGeneratedPerChampionHit: 10,
      secondDashWindowSeconds: 4,
      empoweredSecondDashDamage: [70, 130, 190, 250],
      empoweredSecondDashAttackDamageRatio: 1.35,
      armorShredPercent: [25, 30, 35, 40],
      armorShredDurationSeconds: 4,
      championHitFuryRestore: 20,
      championHitFuryRestoreDurationSeconds: 2,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.DASH],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // RENEKTON - R
  {
    ...
    name: `Dominus`,
    nameVi: `Thần Cá Sấu`,
    description: `Renekton gains Fury and bonus Health for a duration. Every second after casting, he gains Fury and deals magic damage to nearby enemies.`,
    descriptionVi: `Renekton nhận Nộ và máu cộng thêm trong một khoảng thời gian. Mỗi giây sau khi dùng chiêu, hắn nhận thêm Nộ và gây sát thương phép lên kẻ địch xung quanh.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: { values: [75, 70, 65], unit: `seconds` },
    cost: null,
    ...
    scaling: {
      initialFuryGain: 20,
      bonusHealth: [300, 575, 750],
      durationSeconds: 12,
      furyGainPerSecond: 5,
      damagePerSecond: [70, 120, 170],
      abilityPowerRatioPerSecond: 0.2,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // RENGAR - PASSIVE
  {
    ...
    nameVi: `Thú Săn Mồi Lẩn Khuất`,
    description: `If Rengar is in brush or camouflaged, his next attack leaps to the target. Rengar gains Ferocity from basic abilities and can empower his next basic ability at full Ferocity. Empowered abilities grant Movement Speed and do not refresh the basic ability's cooldown. Bonetooth Necklace grants Attack Damage for each unique champion takedown. Ferocity is lost after leaving combat for a duration.`,
    descriptionVi: `Nếu Rengar ở trong bụi hoặc đang ngụy trang, đòn đánh kế tiếp của hắn sẽ nhảy tới mục tiêu. Rengar nhận Hung Tợn từ kỹ năng cơ bản và có thể cường hóa kỹ năng cơ bản kế tiếp khi đủ Hung Tợn. Kỹ năng cường hóa cho Tốc Độ Di Chuyển và không làm mới hồi chiêu kỹ năng cơ bản. Dây Chuyền Răng Nanh cho Sức Mạnh Công Kích với mỗi tướng địch riêng biệt bị hạ gục. Hung Tợn mất đi sau khi rời giao tranh một khoảng thời gian.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    ...
    scaling: {
      ferocityMaxStacks: 4,
      ferocityGainOnBasicAbilityCast: 1,
      empoweredMoveSpeedPercentByLevelBreakpoint: [30, 40, 50],
      empoweredMoveSpeedDurationSeconds: 1.5,
      ferocityDecayAfterLeavingCombatSeconds: 8,
      bonetoothAttackDamagePercentPerUniqueTakedownRange: [4, 20],
      uniqueChampionTakedownRequired: true,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DASH, SkillEffect.SPEED_UP],
    tags: [
      `LEAP`,
      `CAMOUFLAGE`,
      `RAGE`,
  ...
  // RENGAR - Q
  {
    ...
    name: `Savagery`,
    nameVi: `Tàn Ác`,
    description: `Rengar's next attacks within a short duration gain Attack Speed. The first attack is empowered to deal bonus physical damage and critically strike. Critical Rate further increases the first attack's damage. Ferocity grants a stronger Attack Speed steroid and changes the bonus damage scaling. This skill deals reduced damage to turrets.`,
    descriptionVi: `Các đòn đánh kế tiếp của Rengar trong thời gian ngắn nhận Tốc Độ Đánh. Đòn đầu tiên được cường hóa để gây thêm sát thương vật lý và chí mạng. Tỉ Lệ Chí Mạng tiếp tục tăng sát thương của đòn đầu tiên. Hung Tợn cho hiệu ứng tăng Tốc Độ Đánh mạnh hơn và thay đổi tỉ lệ sát thương cộng thêm. Kỹ năng này gây giảm sát thương lên trụ.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.SELF,
    cooldown: { values: [6, 5, 4, 4], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      empoweredAttackWindowSeconds: 3,
      attackCount: 2,
      attackSpeedPercent: 40,
      firstAttackBonusDamage: [40, 80, 120, 160],
      firstAttackAttackDamageRatio: [0.05, 0.1, 0.15, 0.2],
      firstAttackCriticallyStrikes: true,
      criticalRateBonusDamageRangePercent: [0, 55],
      criticalRateForMaxBonusDamagePercent: 100,
      ferocityAttackSpeedPercent: 45,
      ferocityAttackSpeedDurationSeconds: 3,
      ferocityFirstAttackBonusDamage: [40, 80, 120, 160],
      ferocityFirstAttackAttackDamageRatio: 0.4,
      turretDamagePercent: 60,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // RENGAR - W
  {
    ...
    slot: SkillSlot.W,
    name: `Battle Roar`,
    nameVi: `Tiếng Gầm Chiến Trận`,
    description: `Rengar roars, dealing magic damage and healing for a portion of damage taken recently. Ferocity increases the magic damage, restores Health based on recent damage taken, and removes all crowd control effects from Rengar. Damage from monsters restores Health based on the full damage taken instead.`,
    descriptionVi: `Rengar gầm lên, gây sát thương phép và hồi máu theo một phần sát thương đã nhận gần đây. Hung Tợn tăng sát thương phép, hồi máu dựa trên sát thương đã nhận gần đây và xóa toàn bộ hiệu ứng khống chế khỏi Rengar. Sát thương từ quái hồi máu theo toàn bộ sát thương đã nhận.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: { values: [16, 14, 12, 10], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      baseDamage: [60, 100, 140, 180],
      abilityPowerRatio: 0.8,
      recentDamageWindowSeconds: 2,
      recentDamageHealingPercent: 60,
      ferocityDamage: [80, 120, 160, 200],
      ferocityAbilityPowerRatio: 0.8,
      ferocityRecentDamageHealingPercent: 60,
      monsterDamageHealingPercent: 100,
      removesCrowdControl: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.HEAL, SkillEffect.BUFF],
    tags: [
  ...
  // RENGAR - E
  {
    ...
    name: `Bola Strike`,
    nameVi: `Cú Ném Bola`,
    description: `Rengar throws a bola, dealing physical damage, slowing the target, and revealing the surrounding area. Ferocity changes the effect to root the target and reveal the target and surrounding area. Bola Strike can be cast while Rengar is leaping.`,
    descriptionVi: `Rengar ném bola, gây sát thương vật lý, làm chậm mục tiêu và làm lộ khu vực xung quanh. Hung Tợn đổi hiệu ứng thành trói chân mục tiêu và làm lộ mục tiêu cùng khu vực xung quanh. Cú Ném Bola có thể dùng khi Rengar đang nhảy.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [10, 10, 10, 10], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      baseDamage: [70, 130, 190, 250],
      bonusAttackDamageRatio: 0.7,
      slowPercent: [30, 50, 70, 90],
      slowDurationSeconds: 1.75,
      revealDurationSeconds: 2,
      ferocityDamage: 75,
      ferocityBonusAttackDamageRatio: 0.7,
      ferocityRootDurationSeconds: 1.75,
      canCastWhileLeaping: true,
    },
    effects: [
      SkillEffect.DAMAGE,
      SkillEffect.SLOW,
  ...
  // RENGAR - R
  {
    ...
    nameVi: `Khao Khát Săn Mồi`,
    description: `Rengar gains Movement Speed and reveals the nearest enemy champion for a duration. After a short delay, Rengar becomes camouflaged and can leap without being in brush. Leaping to an enemy champion shreds the target's Armor for a short duration.`,
    descriptionVi: `Rengar nhận Tốc Độ Di Chuyển và làm lộ tướng địch gần nhất trong một khoảng thời gian. Sau một khoảng trễ ngắn, Rengar ngụy trang và có thể nhảy mà không cần ở trong bụi. Nhảy vào tướng địch sẽ giảm Giáp của mục tiêu trong thời gian ngắn.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: { values: [85, 75, 65], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      moveSpeedPercent: [40, 50, 60],
      revealDurationSeconds: [12, 14, 16],
      camouflageDelaySeconds: 1,
      armorShred: [16, 24, 32],
      armorShredDurationSeconds: 4,
      canLeapWithoutBrush: true,
    },
    effects: [SkillEffect.BUFF, SkillEffect.SPEED_UP, SkillEffect.REVEAL],
    tags: [
      `SPEED_UP`,
      `REVEAL`,
      `CAMOUFLAGE`,
  ...
  // RIVEN - PASSIVE
  {
    ...
    name: `Runic Blade`,
    nameVi: `Kiếm Cổ Ngữ`,
    description: `Riven's abilities charge her blade up to 3 times. Her attacks expend charges to deal bonus physical damage. Bonus damage to monsters and structures is reduced.`,
    descriptionVi: `Kỹ năng của Riven tích năng lượng cho thanh kiếm tối đa 3 lần. Đòn đánh của cô tiêu hao cộng dồn để gây thêm sát thương vật lý. Sát thương cộng thêm lên quái và công trình bị giảm.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    ...
    scaling: {
      maxCharges: 3,
      bonusPhysicalDamage: 21,
      attackDamageRatioByLevelRange: [0.22, 0.5],
      monsterAndStructureDamagePercent: 65,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // RIVEN - Q
  {
    ...
    name: `Broken Wings`,
    nameVi: `Tam Bộ Kiếm`,
    description: `Riven slashes in a direction up to 3 times, dealing physical damage to nearby enemies with each slash. The third slash can cross terrain and knocks up nearby enemies. Tap-casting prioritizes champions and large monsters within slash range. This skill deals reduced damage to monsters.`,
    descriptionVi: `Riven chém theo một hướng tối đa 3 lần, gây sát thương vật lý lên kẻ địch gần đó với mỗi nhát chém. Nhát chém thứ ba có thể vượt địa hình và hất tung kẻ địch gần đó. Nhấn nhanh sẽ ưu tiên tướng và quái lớn trong tầm chém. Kỹ năng này gây giảm sát thương lên quái.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: { values: [12, 12, 12, 12], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      castCount: 3,
      baseDamagePerSlash: [30, 55, 80, 105],
      attackDamageRatioPerSlash: [0.55, 0.6, 0.65, 0.7],
      thirdSlashKnockUpDurationSeconds: 0.5,
      thirdSlashCrossesTerrain: true,
      monsterDamagePercent: 70,
      tapCastPriorityTargets: [`CHAMPION`, `LARGE_MONSTER`],
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.DASH, SkillEffect.KNOCK_UP],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // RIVEN - W
  {
    ...
    name: `Ki Burst`,
    nameVi: `Kình Lực`,
    description: `Riven stuns nearby enemies and deals physical damage.`,
    descriptionVi: `Riven làm choáng kẻ địch xung quanh và gây sát thương vật lý.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: { values: [9, 8, 8, 7], unit: `seconds` },
    cost: null,
  ...
  // RIVEN - E
  {
    ...
    name: `Valor`,
    nameVi: `Anh Dũng`,
    description: `Riven dashes in a direction and gains a shield for a short duration. Valor cannot cross terrain.`,
    descriptionVi: `Riven lướt theo một hướng và nhận lá chắn trong thời gian ngắn. Anh Dũng không thể vượt địa hình.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: { values: [9, 8, 7, 6], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      shieldValue: [85, 120, 155, 190],
      attackDamageRatio: 0.9,
      shieldDurationSeconds: 2,
      cannotCrossTerrain: true,
    },
    effects: [SkillEffect.DASH, SkillEffect.SHIELD],
    tags: [
      `DASH`,
  ...
  // RIVEN - R
  {
    ...
    nameVi: `Lưỡi Kiếm Lưu Đày`,
    description: `Riven expands her blade for a duration, gaining bonus Attack Damage, increasing the range of her attacks and damaging abilities, and gaining a single cast of Wind Slash. Wind Slash launches a shockwave that deals physical damage increased by the target's missing Health. During Blade of the Exile, takedowns reset Wind Slash casts and extend this ability's duration, up to a cap.`,
    descriptionVi: `Riven mở rộng thanh kiếm trong một khoảng thời gian, nhận thêm Sức Mạnh Công Kích, tăng tầm đánh và tầm kỹ năng gây sát thương, đồng thời nhận một lần dùng Chém Gió. Chém Gió phóng ra sóng kiếm gây sát thương vật lý tăng theo máu đã mất của mục tiêu. Trong thời gian Lưỡi Kiếm Lưu Đày, hạ gục sẽ đặt lại số lần dùng Chém Gió và kéo dài thời gian hiệu lực, tối đa đến giới hạn.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.SELF,
    cooldown: { values: [75, 60, 45], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      durationSeconds: 12,
      bonusAttackDamagePercent: 25,
      attackAndAbilityRangeIncreased: true,
      windSlashInitialCasts: 1,
      windSlashMinDamage: [100, 150, 200],
      windSlashMinAttackDamageRatio: 0.6,
      windSlashMaxDamage: [300, 450, 600],
      windSlashMaxAttackDamageRatio: 1.8,
      windSlashScalesWithMissingHealth: true,
      takedownResetsWindSlashCasts: true,
      takedownDurationExtensionSeconds: 3,
      maxExtendedDurationSeconds: 12,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // RUMBLE - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Junkyard Titan`,
    nameVi: `Khổng Lồ Bãi Rác`,
    description: `Rumble's abilities generate Heat. Above a Heat threshold, he enters the Danger Zone, causing his basic abilities to gain bonus effects. At maximum Heat, Rumble becomes Overheated, silencing himself but gaining bonus Attack Speed and empowering his attacks to deal bonus magic damage plus max Health magic damage. Percent damage is capped against monsters.`,
    descriptionVi: `Kỹ năng của Rumble tạo Nhiệt. Khi vượt ngưỡng Nhiệt, hắn vào Vùng Nguy Hiểm, khiến kỹ năng cơ bản nhận hiệu ứng cường hóa. Khi đạt Nhiệt tối đa, Rumble Quá Nhiệt, tự câm lặng bản thân nhưng nhận thêm Tốc Độ Đánh và cường hóa đòn đánh để gây thêm sát thương phép cộng sát thương phép theo máu tối đa. Sát thương theo phần trăm bị giới hạn lên quái.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      dangerZoneHeatThreshold: 50,
      overheatThreshold: 150,
      overheatDurationSeconds: 4,
      overheatAttackSpeedPercent: 55,
      overheatBonusMagicDamage: 5,
      overheatAbilityPowerRatio: 0.2,
      overheatMaxHealthDamagePercent: 5,
      monsterPercentDamageCapByLevelRange: [65, 150],
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE, SkillEffect.SILENCE],
    tags: [
      `MAGIC_DAMAGE`,
      `SILENCE`,
      `ATTACK_SPEED_STEROID`,
  ...
  // RUMBLE - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Flamespitter`,
    nameVi: `Súng Phun Lửa`,
    description: `Rumble ignites his flamethrower, dealing magic damage plus max Health magic damage over several seconds. The flamethrower deals increased damage against minions. Danger Zone increases the damage and max Health damage. Percent damage is capped against monsters.`,
    descriptionVi: `Rumble khởi động súng phun lửa, gây sát thương phép cộng sát thương phép theo máu tối đa trong vài giây. Súng phun lửa gây thêm sát thương lên lính. Vùng Nguy Hiểm tăng sát thương và sát thương theo máu tối đa. Sát thương theo phần trăm bị giới hạn lên quái.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.ENEMIES,
    cooldown: { values: [8, 7, 6, 5], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      baseDamage: [120, 160, 200, 240],
      abilityPowerRatio: 1.1,
      maxHealthDamagePercent: [6, 8, 10, 12],
      durationSeconds: 3,
      minionDamagePercent: 105,
      dangerZoneDamage: [180, 240, 300, 360],
      dangerZoneAbilityPowerRatio: 1.65,
      dangerZoneMaxHealthDamagePercent: 9,
      monsterPercentDamageCapByLevelRange: [65, 150],
    },
    effects: [SkillEffect.DAMAGE],
    tags: [
  ...
  // RUMBLE - W
  {
    ...
    slot: SkillSlot.W,
    name: `Scrap Shield`,
    nameVi: `Khiên Phế Liệu`,
    description: `Rumble gains a shield and Movement Speed for a short duration. Danger Zone increases both the Movement Speed and shield value.`,
    descriptionVi: `Rumble nhận một lá chắn và Tốc Độ Di Chuyển trong thời gian ngắn. Vùng Nguy Hiểm tăng cả Tốc Độ Di Chuyển và lượng lá chắn.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: { values: [5, 5, 5, 5], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      shieldValue: [40, 70, 100, 130],
      shieldMaxHealthRatio: 0.06,
      shieldAbilityPowerRatio: 0.35,
      shieldDurationSeconds: 1.5,
      moveSpeedPercent: [20, 25, 30, 35],
      moveSpeedDurationSeconds: 1,
      dangerZoneMoveSpeedPercent: [30, 35, 40, 45],
      dangerZoneShieldValue: [60, 105, 150, 195],
      dangerZoneShieldMaxHealthRatio: 0.09,
      dangerZoneShieldAbilityPowerRatio: 0.45,
    },
    effects: [SkillEffect.SHIELD, SkillEffect.SPEED_UP],
    tags: [
      `SELF_SHIELD`,
  ...
  // RUMBLE - E
  {
    ...
    nameVi: `Lao Điện`,
    description: `Rumble launches an electrified harpoon, dealing magic damage, slowing the target, and reducing their Magic Resist. Hitting an enemy already slowed by Electro-Harpoon increases the slow and Magic Resist reduction. Danger Zone increases the damage, slow, and Magic Resist reduction. This skill stores up to 2 charges.`,
    descriptionVi: `Rumble phóng một lao điện, gây sát thương phép, làm chậm mục tiêu và giảm Kháng Phép của chúng. Trúng kẻ địch đã bị Lao Điện làm chậm sẽ tăng hiệu ứng làm chậm và giảm Kháng Phép. Vùng Nguy Hiểm tăng sát thương, làm chậm và giảm Kháng Phép. Kỹ năng này tích trữ tối đa 2 cộng dồn.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: { values: [1, 1, 1, 1], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      baseDamage: [60, 90, 120, 150],
      abilityPowerRatio: 0.4,
      slowPercent: [30, 35, 40, 45],
      slowDurationSeconds: 1.5,
      magicResistReductionPercent: [8, 12, 16, 20],
      magicResistReductionDurationSeconds: 4,
      repeatHitSlowPercent: [45, 52.5, 60, 67.5],
      repeatHitMagicResistReductionPercent: [12, 18, 24, 30],
      dangerZoneDamage: [90, 135, 180, 225],
      dangerZoneAbilityPowerRatio: 0.6,
      dangerZoneSlowAndMagicResistReductionIncreasePercent: 50,
      chargeRechargeSeconds: 6,
      maxCharges: 2,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW],
    tags: [
  ...
  // RUMBLE - R
  {
    ...
    name: `The Equalizer`,
    nameVi: `Mưa Tên Lửa`,
    description: `Rumble launches a line of rockets that creates a burning trail on impact, dealing magic damage and slowing enemies in the trail over several seconds.`,
    descriptionVi: `Rumble phóng một hàng tên lửa tạo vệt cháy trên mặt đất khi va chạm, gây sát thương phép và làm chậm kẻ địch trong vệt cháy trong vài giây.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: { values: [80, 70, 60], unit: `seconds` },
    cost: null,
  ...
  // RYZE - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Arcane Mastery`,
    nameVi: `Bậc Thầy Cổ Thuật`,
    description: `Ryze gains max Mana based on Ability Power. His abilities deal additional damage based on his bonus Mana.`,
    descriptionVi: `Ryze nhận thêm năng lượng tối đa dựa trên Sức Mạnh Phép Thuật. Kỹ năng của hắn gây thêm sát thương dựa trên năng lượng cộng thêm.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      maxManaAbilityPowerRatio: 0.1,
      abilitiesScaleWithBonusMana: true,
    },
    effects: [SkillEffect.BUFF],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // RYZE - Q
  {
    ...
    name: `Overload`,
    nameVi: `Quá Tải`,
    description: `Passive: Rune Prison and Spell Flux refresh Overload's cooldown and charge a rune for a short duration, up to 2 runes. Active: Ryze unleashes a magic blast that deals magic damage to the first enemy hit. If the target has Flux, Overload consumes Flux, deals increased damage, and bounces to nearby enemies with Flux. When two runes are charged, Ryze discharges them to gain Movement Speed. This skill deals reduced damage to monsters.`,
    descriptionVi: `Nội tại: Ngục Cổ Ngữ và Dòng Chảy Ma Pháp làm mới hồi chiêu Quá Tải và tích một cổ ngữ trong thời gian ngắn, tối đa 2 cổ ngữ. Kích hoạt: Ryze phóng ra luồng ma pháp gây sát thương phép lên kẻ địch đầu tiên trúng phải. Nếu mục tiêu có Dòng Chảy, Quá Tải tiêu hao Dòng Chảy, gây thêm sát thương và nảy sang kẻ địch gần đó đang có Dòng Chảy. Khi có đủ 2 cổ ngữ, Ryze giải phóng chúng để nhận Tốc Độ Di Chuyển. Kỹ năng này gây giảm sát thương lên quái.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: { values: [5, 5, 5, 5], unit: `seconds` },
    cost: { values: [35, 33, 31, 29], resource: `MANA` },
    range: null,
    scaling: {
      maxRuneCharges: 2,
      runeChargeDurationSeconds: 4,
      baseDamage: [70, 95, 120, 145],
      abilityPowerRatio: 0.45,
      bonusManaRatio: 0.02,
      fluxDamageIncreasePercent: 25,
      runeMoveSpeedPercent: [20, 27.5, 35, 42.5],
      runeMoveSpeedDurationSeconds: 2,
      monsterDamagePercent: 40,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SPEED_UP],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // RYZE - W
  {
    ...
    name: `Rune Prison`,
    nameVi: `Ngục Cổ Ngữ`,
    description: `Ryze deals magic damage and slows the target. If the target has Flux, Rune Prison consumes Flux and roots instead of slowing.`,
    descriptionVi: `Ryze gây sát thương phép và làm chậm mục tiêu. Nếu mục tiêu có Dòng Chảy, Ngục Cổ Ngữ tiêu hao Dòng Chảy và trói chân thay vì làm chậm.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.ENEMY,
    cooldown: { values: [10, 9, 8, 7], unit: `seconds` },
    cost: { values: [35, 50, 65, 80], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [70, 110, 150, 190],
      abilityPowerRatio: 0.65,
      bonusManaRatio: 0.04,
      slowPercent: 50,
      slowDurationSeconds: 1.5,
      fluxTurnsSlowIntoRoot: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW, SkillEffect.ROOT],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // RYZE - E
  {
    ...
    slot: SkillSlot.E,
    name: `Spell Flux`,
    nameVi: `Dòng Chảy Ma Pháp`,
    description: `Ryze fires an orb, dealing magic damage and applying Flux to the target and nearby enemies. If the enemy is already afflicted with Flux, the duration is refreshed and Flux spreads further to nearby enemies.`,
    descriptionVi: `Ryze bắn một quả cầu, gây sát thương phép và áp dụng Dòng Chảy lên mục tiêu cùng kẻ địch gần đó. Nếu kẻ địch đã chịu Dòng Chảy, thời gian hiệu lực được làm mới và Dòng Chảy lan xa hơn sang kẻ địch gần đó.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.ENEMY,
    cooldown: { values: [3, 3, 3, 2], unit: `seconds` },
    cost: { values: [30, 40, 50, 60], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [80, 110, 140, 170],
      abilityPowerRatio: 0.4,
      bonusManaRatio: 0.02,
      fluxDurationSeconds: 4,
      refreshesFluxDuration: true,
      spreadsFurtherIfTargetAlreadyHasFlux: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.BUFF],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // RYZE - R
  {
    ...
    slot: SkillSlot.R,
    name: `Realm Warp`,
    nameVi: `Vòng Xoáy Không Gian`,
    description: `Passive: Realm Warp increases Overload's damage bonus against targets with Flux. Active: Ryze opens a portal to a target location. After a delay, allied champions and minions near the portal are teleported to the location and gain Movement Speed. Ryze's basic ability cooldowns are reset after the teleport. If Ryze becomes immobilized or crowd controlled by disables such as knock up, knock back, or stun, the portal is canceled.`,
    descriptionVi: `Nội tại: Vòng Xoáy Không Gian tăng sát thương cộng thêm của Quá Tải lên mục tiêu có Dòng Chảy. Kích hoạt: Ryze mở cổng dịch chuyển tới vị trí chỉ định. Sau một khoảng trễ, tướng đồng minh và lính gần cổng được dịch chuyển tới vị trí đó và nhận Tốc Độ Di Chuyển. Hồi chiêu kỹ năng cơ bản của Ryze được đặt lại sau khi dịch chuyển. Nếu Ryze bị bất động hoặc chịu khống chế như hất tung, đẩy lùi hoặc làm choáng, cổng sẽ bị hủy.`,
    damageType: DamageType.NONE,
    targetType: TargetType.LOCATION,
    cooldown: { values: [110, 95, 80], unit: `seconds` },
    cost: { values: [90, 90, 90], resource: `MANA` },
    range: null,
    scaling: {
      overloadFluxDamageBonusPercent: [50, 75, 100],
      portalDelaySeconds: 2,
      allyMoveSpeedPercentAfterTeleport: 35,
      allyMoveSpeedDurationSeconds: 2,
      resetsBasicAbilityCooldownsAfterTeleport: true,
      canceledByImmobilizeOrHardCc: true,
      cancelingCcExamples: [`KNOCK_UP`, `KNOCK_BACK`, `STUN`],
    },
    effects: [SkillEffect.BUFF, SkillEffect.SPEED_UP],
    tags: [
      `TELEPORT`,
  ...
  // SAMIRA - PASSIVE
  {
    ...
    nameVi: `Thích Thể Hiện`,
    description: `Samira builds a combo by damaging enemy champions with attacks or abilities that are unique from the previous hit. Each unique hit increases her Style rating from E to S.`,
    descriptionVi: `Samira tạo chuỗi combo bằng cách gây sát thương lên tướng địch bằng đòn đánh hoặc kỹ năng khác với lần đánh trước đó. Mỗi lần trúng độc nhất tăng hạng Phong Cách của cô từ E lên S.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      styleRanks: [`E`, `D`, `C`, `B`, `A`, `S`],
      requiresUniqueDamageSourceFromPreviousHit: true,
      validTargets: [`ENEMY_CHAMPION`],
    },
    effects: [SkillEffect.BUFF],
    tags: [
      `STACKING_PASSIVE`,
  ...
  // SAMIRA - Q
  {
    ...
    name: `Flair`,
    nameVi: `Ứng Biến`,
    description: `Samira fires a shot, dealing physical damage to the first enemy hit. If cast toward an enemy in melee range, Samira slashes in a cone instead, dealing the same damage to all enemies within. Either hit can critically strike for bonus damage. If cast during Wild Rush, Samira strikes all enemies in her path upon completion.`,
    descriptionVi: `Samira bắn một phát, gây sát thương vật lý lên kẻ địch đầu tiên trúng phải. Nếu dùng về phía kẻ địch trong tầm cận chiến, Samira chém theo hình nón, gây cùng lượng sát thương lên tất cả kẻ địch trong vùng. Cả hai dạng đều có thể chí mạng để gây thêm sát thương. Nếu dùng trong lúc Hoang Dại, Samira tấn công tất cả kẻ địch trên đường lướt khi hoàn tất.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [7, 5, 4, 2], unit: `seconds` },
    cost: { values: [30, 30, 30, 30], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [15, 20, 25, 30],
      attackDamageRatio: [1, 1.15, 1.3, 1.45],
      meleeRangeCastsAsCone: true,
      criticalStrikeBonusDamagePercent: 25,
      wildRushPathStrikeOnCompletion: true,
    },
    effects: [SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SAMIRA - W
  {
    ...
    name: `Blade Whirl`,
    nameVi: `Lốc Kiếm`,
    description: `Samira slashes around herself for a short duration, damaging enemies twice and destroying enemy missiles that enter the area.`,
    descriptionVi: `Samira vung kiếm quanh bản thân trong thời gian ngắn, gây sát thương hai lần lên kẻ địch và phá hủy đạn đạo của kẻ địch đi vào vùng ảnh hưởng.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: { values: [22, 20, 18, 16], unit: `seconds` },
    cost: { values: [60, 60, 60, 60], resource: `MANA` },
    range: null,
    scaling: {
      durationSeconds: 0.75,
      hitCount: 2,
      damagePerHit: [20, 40, 60, 80],
      attackDamageRatioPerHit: 0.8,
      destroysEnemyMissiles: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.BUFF],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SAMIRA - E
  {
    ...
    name: `Wild Rush`,
    nameVi: `Hoang Dại`,
    description: `Samira dashes through an enemy, including structures, slashing enemies she passes through, dealing magic damage and gaining Attack Speed. If Samira scores a takedown, Wild Rush's cooldown is reset. Tapping Flair mid-dash casts Flair.`,
    descriptionVi: `Samira lướt xuyên qua một kẻ địch, bao gồm cả công trình, chém kẻ địch cô đi xuyên qua, gây sát thương phép và nhận Tốc Độ Đánh. Nếu Samira tham gia hạ gục, hồi chiêu Hoang Dại được đặt lại. Nhấn Ứng Biến trong lúc lướt sẽ dùng Ứng Biến.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.ENEMY,
    cooldown: { values: [20, 17, 14, 11], unit: `seconds` },
    cost: { values: [40, 40, 40, 40], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [45, 60, 75, 90],
      attackDamageRatio: 0.2,
      attackSpeedPercent: [35, 40, 45, 50],
      attackSpeedDurationSeconds: 3,
      resetsCooldownOnTakedown: true,
      canCastFlairMidDash: true,
      validDashTargetsIncludeStructures: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.DASH, SkillEffect.BUFF],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // SAMIRA - R
  {
    ...
    nameVi: `Hỏa Ngục Liên Xạ`,
    description: `Samira can only cast Inferno Trigger at S Style rating. She unleashes a torrent of shots, slowing herself while firing repeatedly at up to several nearby enemies. Each shot deals physical damage and can critically strike. This skill deals reduced damage to minions.`,
    descriptionVi: `Samira chỉ có thể dùng Hỏa Ngục Liên Xạ khi đạt hạng Phong Cách S. Cô xả một cơn mưa đạn, tự làm chậm bản thân trong lúc bắn liên tục vào tối đa nhiều kẻ địch gần đó. Mỗi phát bắn gây sát thương vật lý và có thể chí mạng. Kỹ năng này gây giảm sát thương lên lính.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: { values: [8, 8, 8], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      requiredStyleRank: `S`,
      selfMoveSpeedReductionPercent: 30,
      maxTargets: 5,
      shotCount: 10,
      durationSeconds: 2.23,
      damagePerShot: [5, 20, 35],
      attackDamageRatioPerShot: 0.6,
      eachShotCanCriticallyStrike: true,
      minionDamagePercent: 25,
    },
    effects: [SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SENNA - PASSIVE
  {
    ...
    name: `Absolution`,
    nameVi: `Giải Thoát`,
    description: `Senna can absorb Mist by attacking souls that spawn from dead enemies. She can also siphon Mist from enemy champions she hits twice within a short duration, dealing current Health bonus physical damage. If nearby souls are not attacked, Senna absorbs them automatically when they disappear. Each Mist stack grants Attack Damage, and every 20 stacks grant Attack Range and Critical Chance.`,
    descriptionVi: `Senna có thể hấp thụ Màn Sương bằng cách tấn công linh hồn xuất hiện từ kẻ địch đã chết. Cô cũng có thể hút Màn Sương từ tướng địch bị cô đánh trúng hai lần trong thời gian ngắn, gây thêm sát thương vật lý theo máu hiện tại. Nếu không bị tấn công, linh hồn gần Senna sẽ tự động được hấp thụ khi biến mất. Mỗi cộng dồn Màn Sương cho Sức Mạnh Công Kích, và mỗi 20 cộng dồn cho Tầm Đánh cùng Tỉ Lệ Chí Mạng.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      championSiphonHitCount: 2,
      championSiphonWindowSeconds: 4,
      currentHealthBonusDamagePercent: 1.2,
      championSiphonCooldownPerTargetSeconds: 6,
      attackDamagePerMistStack: 1.25,
      mistStacksPerRangeAndCritBonus: 20,
      attackRangePerThreshold: 15,
      criticalChancePercentPerThreshold: 15,
      nearbySoulsAutoAbsorbOnDisappearance: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.BUFF],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SENNA - Q
  {
    ...
    nameVi: `Bóng Tối Xuyên Thấu`,
    description: `Senna shoots a bolt of piercing shadow through any object, dealing physical damage to enemies, slowing enemies, and restoring Health to allied champions. Attacks reduce Piercing Darkness's cooldown. This ability's cast range matches Senna's attack range, its cast time improves with Attack Speed, and it applies on-hit effects to enemy champions.`,
    descriptionVi: `Senna bắn một tia bóng tối xuyên qua mọi vật thể, gây sát thương vật lý lên kẻ địch, làm chậm kẻ địch và hồi máu cho tướng đồng minh. Đòn đánh giảm hồi chiêu Bóng Tối Xuyên Thấu. Tầm dùng kỹ năng này khớp với tầm đánh của Senna, thời gian thi triển được cải thiện theo Tốc Độ Đánh, và kỹ năng áp dụng hiệu ứng đòn đánh lên tướng địch.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [15, 15, 15, 15], unit: `seconds` },
    cost: { values: [70, 80, 90, 100], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [50, 90, 130, 170],
      attackDamageRatio: 0.6,
      slowBasePercent: 15,
      slowAttackDamageRatio: 0.1,
      slowAbilityPowerRatio: 0.06,
      slowDurationSeconds: [0.75, 1, 1.25, 1.5],
      healValue: [40, 70, 100, 130],
      healAttackDamageRatio: 0.4,
      healAbilityPowerRatio: 0.25,
      attackCooldownReductionSeconds: 1,
      castRangeMatchesAttackRange: true,
      castTimeImprovesWithAttackSpeed: true,
      appliesOnHitEffectsToEnemyChampions: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW, SkillEffect.HEAL],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SENNA - W
  {
    ...
    name: `Last Embrace`,
    nameVi: `Ràng Buộc`,
    description: `Senna sends forth a wave of Black Mist, dealing physical damage to the first enemy hit. After a short delay, the target and nearby enemies are rooted.`,
    descriptionVi: `Senna phóng ra một làn Sóng Sương Đen, gây sát thương vật lý lên kẻ địch đầu tiên trúng phải. Sau một khoảng trễ ngắn, mục tiêu và kẻ địch gần đó bị trói chân.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [11, 11, 11, 11], unit: `seconds` },
    cost: { values: [55, 60, 65, 70], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [90, 155, 220, 285],
      attackDamageRatio: 0.7,
      rootDelaySeconds: 1,
      rootDurationSeconds: [1.3, 1.6, 1.9, 2.2],
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.ROOT],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SENNA - E
  {
    ...
    nameVi: `Lời Nguyền Sương Đen`,
    description: `Senna dissolves into a cloud of mist, becoming a Wraith. Allied champions who enter the mist are camouflaged and become Wraiths when they leave. Wraiths gain Movement Speed, are unselectable, and hide their identities as long as no enemy champions are nearby. Camouflaged units are hidden from view but can be revealed by nearby enemy champions, turrets, and True Sight.`,
    descriptionVi: `Senna tan vào một đám mây sương, trở thành Bóng Ma. Tướng đồng minh đi vào màn sương được ngụy trang và trở thành Bóng Ma khi rời khỏi vùng sương. Bóng Ma nhận Tốc Độ Di Chuyển, không thể bị chọn làm mục tiêu và che giấu danh tính miễn là không có tướng địch ở gần. Đơn vị ngụy trang bị ẩn khỏi tầm nhìn nhưng có thể bị phát hiện bởi tướng địch ở gần, trụ và Tầm Nhìn Chuẩn.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: { values: [22, 20, 18, 16], unit: `seconds` },
    cost: { values: [70, 70, 70, 70], resource: `MANA` },
    range: null,
    scaling: {
      allyCamouflage: true,
      wraithMoveSpeedPercent: 20,
      wraithsUnselectable: true,
      wraithsHideIdentitiesUnlessEnemyChampionNearby: true,
      revealedBy: [`NEARBY_ENEMY_CHAMPION`, `TURRET`, `TRUE_SIGHT`],
    },
    effects: [SkillEffect.BUFF, SkillEffect.SPEED_UP],
    tags: [
      `CAMOUFLAGE`,
  ...
  // SENNA - R
  {
    ...
    slot: SkillSlot.R,
    name: `Dawning Shadow`,
    nameVi: `Hắc Ám Soi Rọi`,
    description: `Senna fires a global wave that shields allied champions for a short duration while dealing physical damage to enemies. Enemy champions caught in the center are also applied with Mist.`,
    descriptionVi: `Senna bắn ra một làn sóng toàn bản đồ, tạo lá chắn cho tướng đồng minh trong thời gian ngắn đồng thời gây sát thương vật lý lên kẻ địch. Tướng địch trúng vùng trung tâm cũng bị áp dụng Màn Sương.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [85, 80, 75], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    range: null,
    scaling: {
      shieldValue: [120, 160, 200],
      shieldAbilityPowerRatio: 0.4,
      shieldValuePerMist: 4,
      shieldDurationSeconds: 3,
      baseDamage: [250, 375, 500],
      attackDamageRatio: 1.2,
      abilityPowerRatio: 0.5,
      appliesMistToEnemyChampionsInCenter: true,
    },
    effects: [SkillEffect.SHIELD, SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
      `GLOBAL_RANGE`,
      `LINE_DAMAGE`,
  ...
  // SERAPHINE - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Stage Presence`,
    nameVi: `Nữ Hoàng Sân Khấu`,
    description: `Echo: Every third basic ability cast echoes, casting it again. Harmony: Casting an ability grants a Note to nearby allies for a short duration. For each Note, Seraphine's next attack gains Attack Range and deals bonus magic damage.`,
    descriptionVi: `Vang Vọng: Mỗi kỹ năng cơ bản thứ ba sẽ vang vọng, thi triển lại một lần nữa. Hòa Âm: Dùng kỹ năng trao một Nốt Nhạc cho đồng minh gần đó trong thời gian ngắn. Với mỗi Nốt Nhạc, đòn đánh kế tiếp của Seraphine nhận thêm tầm đánh và gây thêm sát thương phép.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      echoEveryNthBasicAbility: 3,
      noteDurationSeconds: 5,
      attackRangePerNote: 30,
      bonusMagicDamagePerNote: 4,
      abilityPowerRatioPerNote: 0.4,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // SERAPHINE - Q
  {
    ...
    name: `High Note`,
    nameVi: `Nốt Cao`,
    description: `Seraphine deals magic damage in a target area, increased based on enemies' missing Health. The damage reaches its maximum against low Health targets.`,
    descriptionVi: `Seraphine gây sát thương phép trong vùng chỉ định, tăng theo máu đã mất của kẻ địch. Sát thương đạt tối đa lên mục tiêu thấp máu.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: { values: [11, 9, 7, 5], unit: `seconds` },
    cost: { values: [60, 65, 70, 75], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [60, 75, 90, 105],
      abilityPowerRatio: 0.45,
      missingHealthDamageIncreaseRangePercent: [0, 50],
      maxDamageHealthThresholdPercent: 25,
    },
    effects: [SkillEffect.DAMAGE],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // SERAPHINE - W
  {
    ...
    slot: SkillSlot.W,
    name: `Surround Sound`,
    nameVi: `Thanh Âm Bao Phủ`,
    description: `Seraphine shields all nearby allied champions and grants them Movement Speed. If Seraphine is already shielded, nearby allies are healed based on missing Health, increased for each ally.`,
    descriptionVi: `Seraphine tạo lá chắn cho tất cả tướng đồng minh gần đó và cho họ Tốc Độ Di Chuyển. Nếu Seraphine đã có lá chắn, đồng minh gần đó được hồi máu dựa trên máu đã mất, tăng theo mỗi đồng minh.`,
    damageType: DamageType.NONE,
    targetType: TargetType.AREA,
    cooldown: { values: [23, 22, 21, 20], unit: `seconds` },
    cost: { values: [40, 60, 80, 100], resource: `MANA` },
    range: null,
    scaling: {
      shieldValue: [50, 75, 100, 125],
      shieldAbilityPowerRatio: 0.3,
      shieldDurationSeconds: 2.5,
      moveSpeedPercent: [20, 22.5, 25, 27.5],
      moveSpeedDurationSeconds: 2.5,
      allyMissingHealthHealPercent: 5,
      healAbilityPowerRatioPercent: 0.01,
      healIncreasePercentPerAlly: 50,
      requiresSeraphineAlreadyShieldedForHeal: true,
    },
    effects: [SkillEffect.SHIELD, SkillEffect.SPEED_UP, SkillEffect.HEAL],
    tags: [
      `ALLY_SHIELD`,
      `ALLY_HEAL`,
      `SPEED_UP`,
  ...
  // SERAPHINE - E
  {
    ...
    name: `Beat Drop`,
    nameVi: `Đổi Nhịp`,
    description: `Seraphine deals magic damage to enemies and heavily slows them. If the enemy is already slowed, they are rooted instead. If they are already rooted, they are stunned.`,
    descriptionVi: `Seraphine gây sát thương phép lên kẻ địch và làm chậm mạnh chúng. Nếu kẻ địch đã bị làm chậm, chúng bị trói chân thay vào đó. Nếu chúng đã bị trói chân, chúng bị làm choáng.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: { values: [12, 11, 10, 9], unit: `seconds` },
    cost: { values: [60, 70, 80, 90], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [60, 95, 130, 165],
      abilityPowerRatio: 0.4,
      slowPercent: 99,
      slowDurationSeconds: 1,
      slowedTargetBecomesRooted: true,
      rootedTargetBecomesStunned: true,
    },
    effects: [
      SkillEffect.DAMAGE,
      SkillEffect.SLOW,
  ...
  // SERAPHINE - R
  {
    ...
    slot: SkillSlot.R,
    name: `Encore`,
    nameVi: `Khúc Ca Lan Tỏa`,
    description: `Seraphine deals magic damage to enemies and charms and slows them. Encore extends when it touches an allied or enemy champion.`,
    descriptionVi: `Seraphine gây sát thương phép lên kẻ địch, mê hoặc và làm chậm chúng. Khúc Ca Lan Tỏa kéo dài tầm khi chạm vào tướng đồng minh hoặc tướng địch.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: { values: [105, 90, 75], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    range: null,
    scaling: {
      ...
      charmDurationSeconds: [1, 1.25, 1.5],
      slowPercent: 40,
      slowDurationSeconds: [1, 1.25, 1.5],
      extendsOnChampionHit: true,
      validExtensionTargets: [`ALLY_CHAMPION`, `ENEMY_CHAMPION`],
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.CHARM, SkillEffect.SLOW],
    tags: [
      `MAGIC_DAMAGE`,
      `LINE_SKILLSHOT`,
      `LINE_DAMAGE`,
  ...
  // SETT - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Pit Grit`,
    nameVi: `Vua Đấu Trường`,
    description: `Sett's attacks alternate between left and right punches. Right punches follow the left quickly and deal bonus physical damage. Sett gains bonus Health Regeneration based on missing Health. Sett resets back to a left punch if he does not use a right punch shortly after a left punch.`,
    descriptionVi: `Đòn đánh của Sett luân phiên giữa đấm trái và đấm phải. Đấm phải nối sau đấm trái rất nhanh và gây thêm sát thương vật lý. Sett nhận thêm hồi máu dựa trên máu đã mất. Sett quay lại đấm trái nếu không tung đấm phải trong thời gian ngắn sau đấm trái.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      rightPunchBonusDamage: 9,
      rightPunchDamagePerChampionLevel: true,
      rightPunchAttackDamageRatio: 0.5,
      bonusHealthRegenPer5PercentMissingHealth: 0.25,
      rightPunchWindowSeconds: 2,
      rightPunchAttackSpeedMultiplier: 8,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SETT - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Knuckle Down`,
    nameVi: `Không Trượt Phát Nào`,
    description: `Sett gains Movement Speed toward enemy champions for a short duration. His next two attacks are empowered to deal bonus physical damage plus max Health physical damage. The additional damage is capped against monsters.`,
    descriptionVi: `Sett nhận Tốc Độ Di Chuyển khi hướng về tướng địch trong thời gian ngắn. Hai đòn đánh kế tiếp được cường hóa để gây thêm sát thương vật lý cộng sát thương vật lý theo máu tối đa. Sát thương cộng thêm bị giới hạn lên quái.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.SELF,
    cooldown: { values: [10, 8, 7, 5], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      moveSpeedTowardEnemyChampionsPercent: 35,
      moveSpeedDurationSeconds: 1.5,
      empoweredAttackCount: 2,
      bonusDamage: [5, 20, 35, 50],
      maxHealthDamagePercentBase: 1,
      maxHealthDamageAttackDamageRatio: [0.0001, 0.00015, 0.0002, 0.00025],
      monsterDamageCap: 100,
    },
    effects: [SkillEffect.BUFF, SkillEffect.SPEED_UP, SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
      `SPEED_UP`,
      `EMPOWERED_ATTACK`,
  ...
  // SETT - W
  {
    ...
    slot: SkillSlot.W,
    name: `Haymaker`,
    nameVi: `Cuồng Thú Quyền`,
    description: `Passive: Sett stores damage taken as Grit up to a maximum based on his max Health. Grit decays after a delay. Active: Sett consumes all Grit to gain a decaying shield based on Grit consumed, then punches forward. Enemies in the center take true damage based on Grit consumed, while enemies outside the center take physical damage.`,
    descriptionVi: `Nội tại: Sett tích trữ sát thương nhận vào thành Điểm Gan Góc, tối đa dựa trên máu tối đa. Điểm Gan Góc giảm dần sau một khoảng trễ. Kích hoạt: Sett tiêu hao toàn bộ Điểm Gan Góc để nhận lá chắn giảm dần dựa trên lượng đã tiêu hao, rồi tung một cú đấm về phía trước. Kẻ địch ở trung tâm nhận sát thương chuẩn dựa trên Điểm Gan Góc đã tiêu hao, còn kẻ địch ngoài trung tâm nhận sát thương vật lý.`,
    damageType: DamageType.TRUE_DAMAGE,
    targetType: TargetType.AREA,
    cooldown: { values: [16, 15, 13, 12], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      damageTakenStoredAsGritPercent: 100,
      gritCapValue: 305,
      gritCapMaxHealthPercent: 50,
      gritDecayDelaySeconds: 4,
      shieldGritConsumedRatio: 1,
      shieldDecayDurationSeconds: 3,
      baseCenterDamage: [80, 105, 130, 155],
      gritConsumedDamagePercent: 25,
      gritConsumedAttackDamageRatio: 0.00275,
      nonCenterDamageType: `PHYSICAL`,
    },
    effects: [SkillEffect.SHIELD, SkillEffect.DAMAGE],
    tags: [
      `TRUE_DAMAGE`,
  ...
  // SETT - E
  {
    ...
    slot: SkillSlot.E,
    name: `Facebreaker`,
    nameVi: `Song Thú Chưởng`,
    description: `Sett smashes enemies on either side into each other, dealing physical damage and slowing them. If Sett grabs at least one enemy on each side, all enemies hit are stunned.`,
    descriptionVi: `Sett kéo kẻ địch ở hai bên đập vào nhau, gây sát thương vật lý và làm chậm chúng. Nếu Sett kéo được ít nhất một kẻ địch ở mỗi bên, tất cả kẻ địch trúng chiêu sẽ bị làm choáng.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: { values: [13, 12, 10, 9], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      baseDamage: [50, 75, 100, 125],
      attackDamageRatio: 0.6,
      slowPercent: 50,
      slowDurationSeconds: 0.5,
      stunDurationSeconds: 1,
      requiresEnemyOnEachSideToStun: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW, SkillEffect.STUN],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SETT - R
  {
    ...
    nameVi: `Hủy Diệt Đấu Trường`,
    description: `Sett grabs an enemy champion and suppresses them as he carries them forward, then slams them into the ground. The slam deals physical damage plus bonus Health scaling damage to surrounding enemies and heavily slows them. Enemies take less damage the farther they are from Sett's landing point.`,
    descriptionVi: `Sett túm một tướng địch và áp chế chúng khi lao về phía trước, rồi đập chúng xuống đất. Cú va chạm gây sát thương vật lý cộng sát thương theo máu cộng thêm lên kẻ địch xung quanh và làm chậm mạnh chúng. Kẻ địch càng xa điểm đáp của Sett càng nhận ít sát thương hơn.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.ENEMY,
    cooldown: { values: [70, 65, 60], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      baseDamage: [200, 300, 400],
      attackDamageRatio: 1,
      bonusHealthDamagePercent: [35, 45, 55],
      slowPercent: 99,
      slowDurationSeconds: 1,
      damageFalloffByDistanceFromLandingPoint: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.DASH, SkillEffect.SLOW],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SHEN - PASSIVE
  {
    ...
    name: `Ki Barrier`,
    nameVi: `Lá Chắn Ki`,
    description: `Shen gains a shield after completing an ability. If the ability affects at least one champion, Ki Barrier's cooldown is reduced. Shen gains Energy when his abilities damage an enemy.`,
    descriptionVi: `Shen nhận một lá chắn sau khi hoàn tất một kỹ năng. Nếu kỹ năng ảnh hưởng ít nhất một tướng, hồi chiêu Lá Chắn Ki được giảm. Shen nhận Nội Năng khi kỹ năng của hắn gây sát thương lên kẻ địch.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    ...
    scaling: {
      shieldValue: 51,
      shieldHealthRatio: 0.14,
      shieldDurationSeconds: 2.5,
      cooldownReductionOnChampionAffectedSeconds: 4,
      energyGainOnAbilityDamage: 10,
    },
    effects: [SkillEffect.SHIELD, SkillEffect.BUFF],
    tags: [
      `SELF_SHIELD`,
  ...
  // SHEN - Q
  {
    ...
    nameVi: `Công Kích Hoàng Hôn`,
    description: `Shen recalls his Spirit Blade, enhancing his next attacks to deal bonus max Health magic damage. If the Spirit Blade passes through an enemy champion, the damage bonus is increased and Shen gains Attack Speed. Enemy champions the Spirit Blade passes through are slowed while moving away from Shen. This skill deals increased damage to minions.`,
    descriptionVi: `Shen gọi Kiếm Hồn về, cường hóa các đòn đánh kế tiếp để gây thêm sát thương phép theo máu tối đa. Nếu Kiếm Hồn đi xuyên qua tướng địch, sát thương cộng thêm tăng và Shen nhận Tốc Độ Đánh. Tướng địch bị Kiếm Hồn đi xuyên qua sẽ bị làm chậm khi di chuyển ra xa Shen. Kỹ năng này gây thêm sát thương lên lính.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: { values: [8, 7, 6, 5], unit: `seconds` },
    cost: { values: [75, 70, 65, 60], resource: `ENERGY` },
    range: null,
    scaling: {
      empoweredAttackCount: 3,
      baseBonusDamage: 12,
      maxHealthDamagePercent: [3, 3.5, 4, 4.5],
      abilityPowerMaxHealthDamageRatio: 0.015,
      empoweredMaxHealthDamagePercent: [5.5, 6, 6.5, 7],
      empoweredAbilityPowerMaxHealthDamageRatio: 0.02,
      attackSpeedPercentIfBladePassesThroughChampion: 50,
      bladePassThroughSlowPercent: [15, 20, 25, 30],
      bladePassThroughSlowDurationSeconds: 2,
      minionDamagePercent: 150,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE, SkillEffect.SLOW],
    tags: [
      `MAGIC_DAMAGE`,
      `ENERGY_COST`,
      `EMPOWERED_ATTACK`,
  ...
  // SHEN - W
  {
    ...
    nameVi: `Bảo Hộ Linh Hồn`,
    description: `Shen sends his Spirit Blade to an allied champion, creating a zone that blocks enemy attacks for a short duration.`,
    descriptionVi: `Shen đưa Kiếm Hồn tới một tướng đồng minh, tạo ra một vùng chặn đòn đánh của kẻ địch trong thời gian ngắn.`,
    damageType: DamageType.NONE,
    targetType: TargetType.ALLY,
    cooldown: { values: [18, 16, 14, 12], unit: `seconds` },
    cost: { values: [20, 20, 20, 20], resource: `ENERGY` },
    range: null,
    scaling: {
      zoneDurationSeconds: 1.75,
      blocksEnemyAttacks: true,
    },
    effects: [SkillEffect.BUFF],
    tags: [
      `ENERGY_COST`,
  ...
  // SHEN - E
  {
    ...
    name: `Shadow Dash`,
    nameVi: `Vô Ảnh Bộ`,
    description: `Shen dashes forward, dealing physical damage to enemy champions and monsters and taunting them.`,
    descriptionVi: `Shen lướt tới trước, gây sát thương vật lý lên tướng địch và quái, đồng thời khiêu khích chúng.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [16, 14, 12, 10], unit: `seconds` },
    cost: { values: [75, 75, 75, 75], resource: `ENERGY` },
    range: null,
    scaling: {
      baseDamage: [60, 90, 120, 150],
      healthRatio: 0.15,
      tauntDurationSeconds: 1.5,
      validDamageTargets: [`ENEMY_CHAMPION`, `MONSTER`],
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.DASH, SkillEffect.TAUNT],
    tags: [
      `PHYSICAL_DAMAGE`,
      `ENERGY_COST`,
      `DASH`,
  ...
  // SHEN - R
  {
    ...
    name: `Stand United`,
    nameVi: `Nhất Thống`,
    description: `Shen channels, shielding an allied champion for a duration. The shield is increased based on the target's missing Health. Upon completing the channel, Shen teleports to the target ally.`,
    descriptionVi: `Shen vận sức, tạo lá chắn cho một tướng đồng minh trong thời gian ngắn. Lá chắn tăng dựa trên máu đã mất của mục tiêu. Khi hoàn tất vận sức, Shen dịch chuyển tới đồng minh mục tiêu.`,
    damageType: DamageType.NONE,
    targetType: TargetType.ALLY,
    cooldown: { values: [110, 100, 90], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      channelDurationSeconds: 3,
      shieldValue: [170, 340, 510],
      abilityPowerRatio: 1.35,
      healthRatio: 0.15,
      shieldDurationSeconds: 5,
      missingHealthShieldIncreaseRangePercent: [0, 60],
      teleportsToTargetOnChannelComplete: true,
    },
    effects: [SkillEffect.SHIELD, SkillEffect.BUFF],
    tags: [
      `ALLY_SHIELD`,
  ...
  // SHYVANA - PASSIVE
  {
    ...
    nameVi: `Huyết Mạch Rồng`,
    description: `Shyvana gains Draconic Bloodline stacks from slaying large monsters, champion takedowns, Rift Herald, Baron Nashor, and Dragons. Every 100 stacks enhances one of Shyvana's abilities.`,
    descriptionVi: `Shyvana nhận cộng dồn Huyết Mạch Rồng khi hạ quái lớn, tham gia hạ gục tướng, hạ Sứ Giả Khe Nứt, Baron Nashor và Rồng. Mỗi 100 cộng dồn sẽ cường hóa một kỹ năng của Shyvana.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      largeMonsterStacks: 8,
      championTakedownStacks: 15,
      riftHeraldOrBaronStacks: 15,
      dragonStacks: 35,
      stacksPerAbilityEnhancement: 100,
      upgradeThresholds: {
        twinBite: 100,
        burnout: 200,
        flameBreath: 300,
  ...
  // SHYVANA - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Twin Bite`,
    nameVi: `Song Long Thủ`,
    description: `Shyvana empowers her next attack to strike twice, dealing physical damage with both hits. Attacks reduce Twin Bite's cooldown. In Dragon Form, Twin Bite strikes in a larger area and applies on-hit effects to all enemies. At 100 Draconic Bloodline stacks, Twin Bite slows enemies hit while in Dragon Form.`,
    descriptionVi: `Shyvana cường hóa đòn đánh kế tiếp để đánh hai lần, gây sát thương vật lý ở cả hai đòn. Đòn đánh giảm hồi chiêu Song Long Thủ. Trong Dạng Rồng, Song Long Thủ đánh trong vùng lớn hơn và áp dụng hiệu ứng đòn đánh lên tất cả kẻ địch. Khi đạt 100 cộng dồn Huyết Mạch Rồng, Song Long Thủ làm chậm kẻ địch trúng chiêu khi ở Dạng Rồng.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.SELF,
    cooldown: { values: [8, 7, 6, 5], unit: `seconds` },
    cost: null,
    ...
    scaling: {
      firstHitDamage: 58,
      firstHitAttackDamageRatio: 1,
      secondHitDamage: 12,
      secondHitAttackDamageRatio: [0.2, 0.4, 0.6, 0.8],
      attackCooldownReductionSeconds: 0.5,
      dragonFormLargerArea: true,
      dragonFormAppliesOnHitsToAllEnemies: true,
      draconicUpgradeStacksRequired: 100,
      dragonFormSlowPercent: 30,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE, SkillEffect.SLOW],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SHYVANA - W
  {
    ...
    name: `Burnout`,
    nameVi: `Rực Cháy`,
    description: `Shyvana deals magic damage per second to nearby enemies and gains decaying Movement Speed. Attacking extends Burnout's duration up to a cap. In Dragon Form, the flames expand to a larger area. At 200 Draconic Bloodline stacks, Burnout grants additional Movement Speed while in Dragon Form.`,
    descriptionVi: `Shyvana gây sát thương phép mỗi giây lên kẻ địch gần đó và nhận Tốc Độ Di Chuyển giảm dần. Đòn đánh kéo dài thời gian Rực Cháy đến giới hạn. Trong Dạng Rồng, ngọn lửa mở rộng ra vùng lớn hơn. Khi đạt 200 cộng dồn Huyết Mạch Rồng, Rực Cháy cho thêm Tốc Độ Di Chuyển khi ở Dạng Rồng.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: { values: [13, 12, 11, 10], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      damagePerSecond: [35, 50, 65, 80],
      bonusAttackDamageRatioPerSecond: 0.3,
      moveSpeedPercent: [30, 35, 40, 45],
      moveSpeedDecaysOverDuration: true,
      baseDurationSeconds: 3,
      maxExtendedDurationSeconds: 4,
      attacksExtendDuration: true,
      dragonFormLargerArea: true,
      draconicUpgradeStacksRequired: 200,
      dragonFormAdditionalMoveSpeedPercent: 25,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SPEED_UP],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // SHYVANA - E
  {
    ...
    slot: SkillSlot.E,
    name: `Flame Breath`,
    nameVi: `Hơi Thở Của Rồng`,
    description: `Shyvana launches a fireball that deals magic damage and Scorches enemies. Shyvana's attacks on Scorched enemies deal bonus max Health magic damage. In Dragon Form, the fireball explodes on impact, dealing area magic damage and leaving fire that deals magic damage and Scorches enemies inside it. At 300 Draconic Bloodline stacks, attacks against Scorched enemies deal true damage while in Dragon Form.`,
    descriptionVi: `Shyvana phóng một quả cầu lửa gây sát thương phép và Thiêu Cháy kẻ địch. Đòn đánh của Shyvana lên kẻ địch bị Thiêu Cháy gây thêm sát thương phép theo máu tối đa. Trong Dạng Rồng, quả cầu lửa nổ khi va chạm, gây sát thương phép diện rộng và để lại vùng lửa gây sát thương phép đồng thời Thiêu Cháy kẻ địch bên trong. Khi đạt 300 cộng dồn Huyết Mạch Rồng, đòn đánh lên kẻ địch bị Thiêu Cháy gây sát thương chuẩn khi ở Dạng Rồng.`,
    damageType: DamageType.MIXED,
    targetType: TargetType.LINE,
    cooldown: { values: [11, 10, 9, 8], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      baseDamage: [60, 110, 160, 210],
      attackDamageRatio: 0.3,
      abilityPowerRatio: 0.4,
      scorchDurationSeconds: 5,
      attackOnScorchedMaxHealthDamagePercent: 3,
      dragonFormExplosionDamage: 110,
      dragonFormExplosionAttackDamageRatio: 0.5,
      dragonFormExplosionAbilityPowerRatio: 0.7,
      dragonFormFireDurationSeconds: 4,
      dragonFormFireDamage: 28,
      dragonFormFireAttackDamageRatio: 0.1,
      dragonFormFireAbilityPowerRatio: 0.2,
      draconicUpgradeStacksRequired: 300,
      dragonFormScorchedAttackDamageConvertedToTrueDamage: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.BUFF],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // SHYVANA - R
  {
    ...
    nameVi: `Hóa Rồng`,
    description: `Passive: Shyvana generates Fury per second and per attack. At full Fury, she can transform into a dragon and remains in Dragon Form until all Fury is consumed. Active: Shyvana transforms into a dragon, gains Health, and flies to a target location. Enemies along her path take magic damage and are knocked toward her landing point. At 400 Draconic Bloodline stacks, Shyvana gains Omnivamp in Dragon Form.`,
    descriptionVi: `Nội tại: Shyvana tạo Nộ mỗi giây và mỗi đòn đánh. Khi đủ Nộ, cô có thể hóa thành rồng và duy trì Dạng Rồng đến khi tiêu hao hết Nộ. Kích hoạt: Shyvana hóa rồng, nhận thêm Máu và bay tới vị trí chỉ định. Kẻ địch trên đường bay nhận sát thương phép và bị hất về điểm đáp của cô. Khi đạt 400 cộng dồn Huyết Mạch Rồng, Shyvana nhận Hút Máu Toàn Phần trong Dạng Rồng.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LOCATION,
    cooldown: { values: [1, 1, 1], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `FURY` },
    range: null,
    scaling: {
      furyPerSecond: [1, 1.5, 2],
      furyPerAttack: 2,
      requiredFuryToCast: 100,
      dragonFormLastsUntilFuryConsumed: true,
      bonusHealth: [350, 475, 600],
      baseDamage: [150, 250, 350],
      abilityPowerRatio: 0.8,
      draconicUpgradeStacksRequired: 400,
      dragonFormOmnivampPercent: 20,
    },
    effects: [
      SkillEffect.BUFF,
      SkillEffect.DASH,
  ...
  // SINGED - PASSIVE
  {
    ...
    nameVi: `Xé Gió Độc Hại`,
    description: `Singed drafts off nearby champions, gaining bonus Movement Speed for a short duration. Each champion has an individual cooldown.`,
    descriptionVi: `Singed lợi dụng luồng khí từ tướng gần đó, nhận thêm Tốc Độ Di Chuyển trong thời gian ngắn. Mỗi tướng có hồi chiêu riêng.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    ...
    scaling: {
      moveSpeedPercent: 20,
      moveSpeedDurationSeconds: 2,
      cooldownPerChampionSeconds: 10,
    },
    effects: [SkillEffect.SPEED_UP],
    tags: [
      `SPEED_UP`,
  ...
  // SINGED - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Poison Trail`,
    nameVi: `Phun Khói Độc`,
    description: `Toggle: Singed leaves a poisonous trail behind him, dealing magic damage per second to enemies in the trail.`,
    descriptionVi: `Bật/tắt: Singed để lại một vệt khói độc phía sau, gây sát thương phép mỗi giây lên kẻ địch trong vùng độc.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: { values: [1, 1, 1, 1], unit: `seconds` },
    cost: { values: [12, 12, 12, 12], resource: `MANA` },
    range: null,
    scaling: {
      damagePerSecond: [20, 28, 36, 44],
      abilityPowerRatioPerSecond: 0.3,
      toggle: true,
    },
    effects: [SkillEffect.DAMAGE],
    tags: [
  ...
  // SINGED - W
  {
    ...
    slot: SkillSlot.W,
    name: `Mega Adhesive`,
    nameVi: `Keo Siêu Dính`,
    description: `Singed tosses adhesive that sticks to the ground at a target area. The adhesive explodes on landing, dealing magic damage and slowing enemies. Enemies in the area are grounded and cannot use movement abilities. If a target is flung into the adhesive, they are rooted.`,
    descriptionVi: `Singed ném keo dính xuống vùng chỉ định. Keo phát nổ khi chạm đất, gây sát thương phép và làm chậm kẻ địch. Kẻ địch trong vùng bị khóa khả năng di chuyển và không thể dùng kỹ năng cơ động. Nếu mục tiêu bị hất vào vùng keo, chúng bị trói chân.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: { values: [11, 11, 11, 11], unit: `seconds` },
    cost: { values: [60, 70, 80, 90], resource: `MANA` },
    ...
    scaling: {
      zoneDurationSeconds: 3,
      baseDamage: [50, 70, 90, 100],
      abilityPowerRatio: 0.25,
      slowPercent: [35, 40, 45, 50],
      preventsMovementAbilities: true,
      rootsTargetsFlungIntoZone: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW, SkillEffect.ROOT],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // SINGED - E
  {
    ...
    name: `Fling`,
    nameVi: `Hất`,
    description: `Singed raises his shield and dashes toward the target, knocking aside enemies in his way. If he hits the target, he flings them behind him, dealing magic damage plus max Health magic damage. If the target is flung into Mega Adhesive, they are rooted. This skill has a maximum damage cap against non-champions.`,
    descriptionVi: `Singed giơ khiên và lao tới mục tiêu, hất văng kẻ địch trên đường. Nếu chạm mục tiêu, hắn hất chúng ra sau lưng, gây sát thương phép cộng sát thương phép theo máu tối đa. Nếu mục tiêu bị hất vào Keo Siêu Dính, chúng bị trói chân. Kỹ năng này có giới hạn sát thương tối đa lên mục tiêu không phải tướng.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.ENEMY,
    cooldown: { values: [12, 12, 12, 12], unit: `seconds` },
    cost: { values: [80, 95, 110, 125], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [40, 60, 80, 100],
      abilityPowerRatio: 0.5,
      maxHealthDamagePercent: [5, 6, 7, 8],
      adhesiveRootDurationSeconds: [1.25, 1.5, 1.75, 2],
      nonChampionDamageCap: 500,
      knocksAsideEnemiesInPath: true,
      flingsTargetBehindSinged: true,
    },
    effects: [
      SkillEffect.DAMAGE,
      SkillEffect.DASH,
  ...
  // SINGED - R
  {
    ...
    nameVi: `Thuốc Hóa Điên`,
    description: `Singed drinks a potent brew, gaining Ability Power, Magic Resist, Armor, Movement Speed, Health Regeneration, and Mana Regeneration. The nearest allied champion receives a portion of these buffs. While the potion is active, Singed's magic damage applies Grievous Wounds.`,
    descriptionVi: `Singed uống một hỗn hợp hóa chất cực mạnh, nhận Sức Mạnh Phép Thuật, Kháng Phép, Giáp, Tốc Độ Di Chuyển, Hồi Máu và Hồi Năng Lượng. Tướng đồng minh gần nhất nhận một phần các chỉ số này. Khi thuốc còn hiệu lực, sát thương phép của Singed áp dụng Vết Thương Sâu.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: { values: [70, 65, 60], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    ...
    scaling: {
      durationSeconds: 20,
      allyBuffSharePercent: 30,
      abilityPowerMagicResistArmorMoveSpeedBonus: [30, 55, 80],
      healthRegenAndManaRegenBonus: [15, 20, 25],
      grievousWoundsPercent: 40,
      grievousWoundsDurationSeconds: 1,
      grievousWoundsAppliedByMagicDamage: true,
    },
    effects: [SkillEffect.BUFF, SkillEffect.SPEED_UP],
    tags: [
      `ULTIMATE_EMPOWER`,
  ...
  // SION - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Glory in Death`,
    nameVi: `Vinh Quang Tử Sĩ`,
    description: `Sion permanently gains bonus Health whenever he kills a unit, with increased bonus Health against large units and champion takedowns. Upon taking fatal damage, Sion reanimates, fearing and heavily slowing nearby enemies. While reanimated, his Health rapidly decays, his attacks are faster, gain Physical Vamp, and deal bonus max Health magic damage. All abilities are replaced with Death Surge, granting decaying Movement Speed.`,
    descriptionVi: `Sion vĩnh viễn nhận thêm Máu khi tiêu diệt đơn vị, tăng mạnh hơn khi hạ đơn vị lớn hoặc tham gia hạ gục tướng. Khi nhận sát thương chí tử, Sion hồi sinh tạm thời, gây hoảng sợ và làm chậm mạnh kẻ địch xung quanh. Khi hồi sinh, Máu của hắn giảm nhanh, đòn đánh nhanh hơn, nhận Hút Máu Vật Lý và gây thêm sát thương phép theo máu tối đa. Tất cả kỹ năng được thay bằng Tử Thần Xung Kích, cho Tốc Độ Di Chuyển giảm dần.`,
    damageType: DamageType.MIXED,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      bonusHealthPerUnitKill: 5,
      bonusHealthLargeUnitOrChampionTakedown: 20,
      reanimationFearDurationSeconds: 1,
      reanimationSlowPercent: 90,
      reanimationHealthPercent: 100,
      reanimationAttackSpeed: 1.75,
      physicalVampPercent: 100,
      reanimatedAttackMaxHealthMagicDamagePercent: 10,
      monsterBonusDamageCap: 75,
      structureDamagePercent: 50,
      deathSurgeMoveSpeedPercent: 67,
      deathSurgeMoveSpeedDecayDurationSeconds: 2.38,
    },
    effects: [
      SkillEffect.BUFF,
      SkillEffect.DAMAGE,
  ...
  // SION - Q
  {
    ...
    nameVi: `Cú Nện Tàn Khốc`,
    description: `Sion charges a heavy blow, then recasts to slam his axe down, briefly slowing enemies and dealing physical damage based on charge time. If charged long enough, enemies are knocked up and stunned for a duration based on charge time. Minions and monsters take modified damage.`,
    descriptionVi: `Sion tụ lực một cú đánh mạnh, sau đó tái kích hoạt để nện rìu xuống, làm chậm ngắn kẻ địch và gây sát thương vật lý dựa trên thời gian tụ lực. Nếu tụ lực đủ lâu, kẻ địch bị hất tung và làm choáng trong thời gian dựa trên thời gian tụ lực. Lính và quái nhận sát thương được điều chỉnh.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: { values: [9, 8, 7, 6], unit: `seconds` },
    cost: { values: [45, 45, 45, 45], resource: `MANA` },
    range: null,
    scaling: {
      maxChargeDurationSeconds: 1.75,
      slowPercent: 50,
      slowDurationSeconds: 0.25,
      minDamage: [50, 75, 100, 125],
      minAttackDamageRatio: [0.45, 0.55, 0.65, 0.75],
      maxDamage: [100, 185, 270, 355],
      maxAttackDamageRatio: [1.35, 1.65, 1.95, 2.25],
      knockUpAndStunChargeThresholdSeconds: 0.75,
      crowdControlDurationByChargeSeconds: [1, 2],
      minionDamagePercent: 60,
      monsterDamagePercent: 120,
    },
    effects: [
      SkillEffect.DAMAGE,
      SkillEffect.SLOW,
  ...
  // SION - W
  {
    ...
    slot: SkillSlot.W,
    name: `Soul Furnace`,
    nameVi: `Lò Luyện Linh Hồn`,
    description: `Sion gains a shield for a duration. After a short delay, if the shield still holds, Sion can recast to detonate it, dealing magic damage plus max Health damage to nearby enemies. The shield automatically detonates at the end of its duration. Bonus damage is capped against monsters.`,
    descriptionVi: `Sion nhận một lá chắn trong thời gian ngắn. Sau một khoảng trễ, nếu lá chắn còn tồn tại, Sion có thể tái kích hoạt để phát nổ, gây sát thương phép cộng sát thương theo máu tối đa lên kẻ địch gần đó. Lá chắn tự động phát nổ khi hết thời gian. Sát thương cộng thêm bị giới hạn lên quái.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: { values: [14, 13, 12, 11], unit: `seconds` },
    cost: { values: [65, 65, 65, 65], resource: `MANA` },
    range: null,
    scaling: {
      shieldValue: [75, 100, 125, 150],
      shieldAbilityPowerRatio: 0.4,
      shieldHealthRatio: [0.1, 0.12, 0.14, 0.16],
      shieldDurationSeconds: 6,
      recastDelaySeconds: 2,
      detonationDamage: [60, 90, 120, 150],
      detonationAbilityPowerRatio: 0.4,
      detonationMaxHealthDamagePercent: [10, 11, 12, 13],
      monsterBonusDamageCap: 400,
      autoDetonatesAtEndOfDuration: true,
    },
    effects: [SkillEffect.SHIELD, SkillEffect.DAMAGE],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // SION - E
  {
    ...
    nameVi: `Sát Nhân Hống`,
    description: `Sion fires a shockwave, dealing magic damage, slowing enemies, and reducing their Armor. Non-champions hit are knocked back. Enemies hit by a knocked back unit take the same damage and effects.`,
    descriptionVi: `Sion bắn ra một sóng xung kích, gây sát thương phép, làm chậm kẻ địch và giảm Giáp của chúng. Mục tiêu không phải tướng bị đẩy lùi. Kẻ địch bị đơn vị bị đẩy lùi va vào sẽ nhận cùng sát thương và hiệu ứng.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: { values: [11, 10, 9, 8], unit: `seconds` },
    cost: { values: [35, 40, 45, 50], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [75, 120, 165, 210],
      abilityPowerRatio: 0.55,
      slowPercent: [50, 55, 60, 65],
      slowDurationSeconds: 2.5,
      armorReductionPercent: 20,
      armorReductionDurationSeconds: 4,
      knocksBackNonChampions: true,
      knockedBackUnitTransfersDamageAndEffects: true,
    },
    effects: [
      SkillEffect.DAMAGE,
      SkillEffect.SLOW,
  ...
  // SION - R
  {
    ...
    nameVi: `Bất Khả Kháng Cự`,
    description: `Sion charges unstoppably in a direction and can turn with player input. He stops when colliding with an enemy champion, structure, terrain, or when recasting. On stopping, Sion slams the ground, dealing physical damage based on charge time while stunning and knocking up enemies. This skill deals reduced damage to structures.`,
    descriptionVi: `Sion lao không thể cản phá theo một hướng và có thể chuyển hướng theo điều khiển. Hắn dừng lại khi va chạm với tướng địch, công trình, địa hình hoặc khi tái kích hoạt. Khi dừng lại, Sion nện xuống mặt đất, gây sát thương vật lý dựa trên thời gian lao, đồng thời làm choáng và hất tung kẻ địch. Kỹ năng này gây giảm sát thương lên công trình.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [90, 70, 50], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    range: null,
    scaling: {
      minDamage: [150, 300, 450],
      maxDamage: [400, 800, 1200],
      bonusAttackDamageRatio: 0.8,
      crowdControlDurationByChargeSeconds: [0.5, 1.5],
      stopsOnCollisionWith: [`ENEMY_CHAMPION`, `STRUCTURE`, `TERRAIN`],
      canRecastToStop: true,
      structureDamagePercent: 50,
    },
    effects: [
      SkillEffect.DAMAGE,
  ...
  // SIVIR - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Fleet of Foot`,
    nameVi: `Bước Chân Nhanh Nhẹn`,
    description: `Sivir gains Movement Speed for a short duration after damaging an enemy champion with an attack or ability.`,
    descriptionVi: `Sivir nhận Tốc Độ Di Chuyển trong thời gian ngắn sau khi gây sát thương lên tướng địch bằng đòn đánh hoặc kỹ năng.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    ...
    scaling: {
      ...
      moveSpeedDurationSeconds: 1.5,
      trigger: [
        `ATTACK_DAMAGE_TO_ENEMY_CHAMPION`,
        `ABILITY_DAMAGE_TO_ENEMY_CHAMPION`,
      ],
    },
    effects: [SkillEffect.SPEED_UP],
    tags: [
  ...
  // SIVIR - Q
  {
    ...
    nameVi: `Gươm Boomerang`,
    description: `Sivir hurls her crossblade, dealing physical damage to enemies it cuts through. Critical Rate increases the damage, and higher Attack Speed shortens the cast time. This skill deals reduced damage to non-champion enemies.`,
    descriptionVi: `Sivir ném vũ khí vòng, gây sát thương vật lý lên kẻ địch nó cắt qua. Tỉ Lệ Chí Mạng tăng sát thương, và Tốc Độ Đánh cao hơn sẽ rút ngắn thời gian thi triển. Kỹ năng này gây giảm sát thương lên mục tiêu không phải tướng.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [10, 9, 9, 8], unit: `seconds` },
    cost: { values: [55, 55, 55, 55], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [10, 30, 50, 70],
      attackDamageRatio: [0.75, 0.8, 0.85, 0.9],
      abilityPowerRatio: 0.6,
      damageIncreasePercentPerCriticalRatePercent: 0.5,
      castTimeImprovesWithAttackSpeed: true,
      nonChampionDamagePercent: 80,
    },
    effects: [SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SIVIR - W
  {
    ...
    name: `Ricochet`,
    nameVi: `Nảy Bật`,
    description: `Sivir gains Attack Speed for a duration. Her attacks bounce to nearby enemies, dealing physical damage. If the first attack critically strikes, the bounces also critically strike. This skill deals reduced damage to minions, and each enemy can be hit by a limited number of bounces.`,
    descriptionVi: `Sivir nhận Tốc Độ Đánh trong một khoảng thời gian. Đòn đánh của cô nảy sang kẻ địch gần đó, gây sát thương vật lý. Nếu đòn đánh đầu chí mạng, các lần nảy cũng chí mạng. Kỹ năng này gây giảm sát thương lên lính, và mỗi kẻ địch chỉ có thể bị trúng số lần nảy giới hạn.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.SELF,
    cooldown: { values: [12, 12, 12, 12], unit: `seconds` },
    cost: { values: [60, 60, 60, 60], resource: `MANA` },
    range: null,
    scaling: {
      attackSpeedPercent: [25, 30, 35, 40],
      attackSpeedDurationSeconds: 4,
      bounceDamage: [4, 6, 8, 10],
      attackDamageRatio: [0.15, 0.18, 0.21, 0.24],
      bounceCritsIfFirstAttackCrits: true,
      minionDamagePercent: 75,
      maxBouncesPerEnemy: 2,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SIVIR - E
  {
    ...
    slot: SkillSlot.E,
    name: `Spell Shield`,
    nameVi: `Khiên Chống Phép`,
    description: `Sivir gains a spell shield for a short duration. If she blocks an ability, she heals herself and gains Fleet of Foot. If the block fails, part of Spell Shield's cooldown is refunded.`,
    descriptionVi: `Sivir nhận một khiên chống phép trong thời gian ngắn. Nếu chặn được kỹ năng, cô hồi máu cho bản thân và nhận Bước Chân Nhanh Nhẹn. Nếu không chặn được, một phần hồi chiêu của Khiên Chống Phép được hoàn trả.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: { values: [22, 20, 18, 16], unit: `seconds` },
    cost: null,
    range: null,
    scaling: {
      spellShieldDurationSeconds: 2,
      healValue: 38,
      healAttackDamageRatio: [0.65, 0.7, 0.75, 0.8],
      healAbilityPowerRatio: 0.5,
      grantsFleetOfFootOnBlock: true,
      cooldownRefundPercentOnFailedBlock: 50,
    },
    effects: [SkillEffect.SHIELD, SkillEffect.HEAL, SkillEffect.BUFF],
    tags: [
      `SPELL_SHIELD`,
      `SELF_HEAL`,
      `SPEED_UP`,
  ...
  // SIVIR - R
  {
    ...
    name: `On The Hunt`,
    nameVi: `Săn Đuổi`,
    description: `Sivir grants bonus Movement Speed to nearby allied champions. During this period, her basic ability cooldowns are reduced. While On The Hunt is active, Sivir gains Morale stacks whenever an attack or ability damages an enemy champion, and additional Morale stacks after champion takedowns. Each Morale stack grants Attack Damage. At enough stacks, Sivir grants additional Movement Speed to nearby allies and refreshes On The Hunt's duration.`,
    descriptionVi: `Sivir cho tướng đồng minh gần đó thêm Tốc Độ Di Chuyển. Trong thời gian này, hồi chiêu kỹ năng cơ bản của cô được giảm. Khi Săn Đuổi còn hiệu lực, Sivir nhận cộng dồn Nhuệ Khí mỗi khi đòn đánh hoặc kỹ năng gây sát thương lên tướng địch, và nhận thêm cộng dồn sau khi tham gia hạ gục tướng. Mỗi cộng dồn Nhuệ Khí cho Sức Mạnh Công Kích. Khi đủ cộng dồn, Sivir cho đồng minh gần đó thêm Tốc Độ Di Chuyển và làm mới thời gian Săn Đuổi.`,
    damageType: DamageType.NONE,
    targetType: TargetType.AREA,
    cooldown: { values: [80, 70, 60], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    range: null,
    scaling: {
      allyMoveSpeedPercent: 15,
      durationSeconds: [10, 11, 12],
      basicAbilityCooldownReductionPercent: [20, 25, 30],
      moraleStacksPerChampionDamage: 1,
      moraleStacksPerChampionTakedown: 2,
      attackDamagePerMoraleStack: [2, 3, 4],
      moraleStacksForBonusEffect: 8,
      bonusAllyMoveSpeedPercentAtMaxMorale: 25,
      refreshesDurationAtMaxMorale: true,
    },
    effects: [SkillEffect.BUFF, SkillEffect.SPEED_UP],
    tags: [
      `ALLY_BUFF`,
  ...
  // SKARNER - PASSIVE
  {
    ...
    nameVi: `Dòng Chấn Động`,
    description: `Skarner's attacks, Shattered Earth, Upheaval, and Impale apply Quaking to targets for a short duration, stacking up to 3 times. At 3 stacks, enemies take max Health magic damage over the duration. This damage is capped against monsters.`,
    descriptionVi: `Đòn đánh của Skarner, Địa Chấn, Chấn Động và Giam Cầm áp dụng Chấn Động lên mục tiêu trong thời gian ngắn, cộng dồn tối đa 3 lần. Khi đạt 3 cộng dồn, kẻ địch nhận sát thương phép theo máu tối đa trong thời gian hiệu lực. Sát thương này bị giới hạn lên quái.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.ENEMY,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      quakingDurationSeconds: 4,
      maxQuakingStacks: 3,
      maxHealthMagicDamagePercentByLevelRange: [5, 10],
      monsterDamageCapByLevelRange: [100, 450],
      appliedBy: [`ATTACK`, `SHATTERED_EARTH`, `UPHEAVAL`, `IMPALE`],
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.BUFF],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // SKARNER - Q
  {
    ...
    nameVi: `Địa Chấn`,
    description: `First Cast: Skarner grabs a boulder, empowering his next 3 attacks to gain Attack Speed and deal physical damage to nearby enemies. The third attack deals additional max Health physical damage and slows enemies. Recast - Upheaval: Skarner throws the boulder in a target direction, ending the ability. The boulder explodes on the first enemy hit, dealing physical damage plus max Health physical damage to the target and nearby enemies and slowing them. Percent Health damage is capped against monsters. The empowered attacks and Upheaval deal modified damage to structures.`,
    descriptionVi: `Lần dùng đầu: Skarner nhặt một tảng đá, cường hóa 3 đòn đánh kế tiếp để nhận Tốc Độ Đánh và gây sát thương vật lý lên kẻ địch gần đó. Đòn thứ ba gây thêm sát thương vật lý theo máu tối đa và làm chậm kẻ địch. Tái kích hoạt - Chấn Động: Skarner ném tảng đá theo hướng chỉ định, kết thúc kỹ năng. Tảng đá phát nổ khi trúng kẻ địch đầu tiên, gây sát thương vật lý cộng sát thương vật lý theo máu tối đa lên mục tiêu và kẻ địch gần đó, đồng thời làm chậm chúng. Sát thương theo phần trăm máu bị giới hạn lên quái. Đòn đánh cường hóa và Chấn Động gây sát thương điều chỉnh lên công trình.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.SELF,
    cooldown: { values: [7, 5, 4, 3], unit: `seconds` },
    cost: { values: [45, 45, 45, 45], resource: `MANA` },
    range: null,
    scaling: {
      empoweredAttackCount: 3,
      attackSpeedPercent: [25, 30, 35, 40],
      baseDamage: [15, 30, 45, 60],
      bonusAttackDamageRatio: 1,
      bonusHealthRatio: 0.04,
      thirdAttackMaxHealthDamagePercent: 9,
      slowPercent: 40,
      slowDurationSeconds: 1,
      upheavalMaxHealthDamagePercent: 9,
      monsterPercentHealthDamageCap: [200, 250, 300, 350],
      monsterPercentHealthDamageCapBonusAttackDamageRatio: 1,
      monsterPercentHealthDamageCapBonusHealthRatio: 0.04,
      firstTwoAttacksStructureDamagePercent: 100,
      thirdAttackAndUpheavalStructureDamagePercent: 200,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE, SkillEffect.SLOW],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SKARNER - W
  {
    ...
    nameVi: `Pháo Đài Địa Chấn`,
    description: `Skarner immediately gains a shield based on max Health and triggers an earthquake that deals magic damage and slows nearby enemies.`,
    descriptionVi: `Skarner lập tức nhận một lá chắn dựa trên máu tối đa và tạo động đất gây sát thương phép, đồng thời làm chậm kẻ địch gần đó.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: { values: [9, 8, 7, 6], unit: `seconds` },
    cost: { values: [60, 65, 70, 75], resource: `MANA` },
    range: null,
    scaling: {
      shieldMaxHealthPercent: 8,
      shieldDurationSeconds: 2.5,
      baseDamage: [50, 70, 90, 110],
      abilityPowerRatio: 0.8,
      slowPercent: 20,
      slowDurationSeconds: 1,
    },
    effects: [SkillEffect.SHIELD, SkillEffect.DAMAGE, SkillEffect.SLOW],
    tags: [
      `MAGIC_DAMAGE`,
      `SELF_SHIELD`,
      `MAX_HEALTH_SCALING`,
  ...
  // SKARNER - E
  {
    ...
    name: `Ixtal's Impact`,
    nameVi: `Cú Húc Ixtal`,
    description: `First Cast: Skarner charges in a target direction, ignoring terrain. If he runs into an enemy champion or large monster, he drags them along for the rest of the charge. Colliding into a wall with an enemy in tow deals physical damage and stuns the enemy. Recast: Skarner ends his charge early. Colliding into a wall with an enemy in tow reduces Ixtal's Impact's cooldown.`,
    descriptionVi: `Lần dùng đầu: Skarner lao theo hướng chỉ định, bỏ qua địa hình. Nếu đâm vào tướng địch hoặc quái lớn, hắn kéo mục tiêu theo trong phần còn lại của cú lao. Va vào tường khi đang kéo mục tiêu sẽ gây sát thương vật lý và làm choáng mục tiêu. Tái kích hoạt: Skarner kết thúc cú lao sớm. Va vào tường khi đang kéo mục tiêu sẽ giảm hồi chiêu Cú Húc Ixtal.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: { values: [20, 18, 16, 14], unit: `seconds` },
    cost: { values: [50, 55, 60, 65], resource: `MANA` },
    range: null,
    scaling: {
      ignoresTerrain: true,
      validGrabTargets: [`ENEMY_CHAMPION`, `LARGE_MONSTER`],
      wallCollisionDamage: [60, 90, 120, 150],
      bonusAttackDamageRatio: 1.2,
      maxHealthRatio: 0.06,
      wallCollisionStunDurationSeconds: 1.5,
      cooldownReductionPercentOnWallCollisionWithEnemy: 35,
      canRecastToEndEarly: true,
    },
    effects: [
      SkillEffect.DAMAGE,
  ...
  // SKARNER - R
  {
    ...
    name: `Impale`,
    nameVi: `Giam Cầm`,
    description: `Skarner lashes his tails forward, dealing magic damage and suppressing the first enemy champions hit. Suppressed champions are dragged along by Skarner for the duration. If Skarner hits at least one enemy champion, he gains Movement Speed. If Shattered Earth is active, Skarner casts Upheaval first.`,
    descriptionVi: `Skarner quật đuôi về phía trước, gây sát thương phép và áp chế các tướng địch đầu tiên trúng phải. Tướng bị áp chế bị Skarner kéo theo trong thời gian hiệu lực. Nếu Skarner trúng ít nhất một tướng địch, hắn nhận Tốc Độ Di Chuyển. Nếu Địa Chấn đang kích hoạt, Skarner sẽ dùng Chấn Động trước.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: { values: [80, 70, 60], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    ...
    scaling: {
      baseDamage: [150, 250, 350],
      abilityPowerRatio: 1,
      maxEnemyChampionsHit: 3,
      suppressionDurationSeconds: 1.5,
      moveSpeedPercentOnChampionHit: 40,
      moveSpeedDurationSeconds: 1.5,
      castsUpheavalFirstIfShatteredEarthActive: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SPEED_UP],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // SMOLDER - PASSIVE
  {
    ...
    nameVi: `Luyện Rồng`,
    description: `Smolder gains Dragon Practice stacks by hitting enemy champions with abilities and killing enemies with Super Scorcher Breath. Dragon Practice improves his basic abilities: Super Scorcher Breath gains additional magic damage and new effects at stack thresholds, Achooo! explosions deal additional magic damage, and Flap, Flap, Flap hits deal additional magic damage and gain extra bolts every stack interval.`,
    descriptionVi: `Smolder nhận cộng dồn Luyện Rồng khi dùng kỹ năng đánh trúng tướng địch và khi tiêu diệt kẻ địch bằng Hơi Thở Bỏng Rát. Luyện Rồng cải thiện các kỹ năng cơ bản: Hơi Thở Bỏng Rát gây thêm sát thương phép và nhận hiệu ứng mới ở các mốc cộng dồn, vụ nổ của Hắt Xì! gây thêm sát thương phép, còn mỗi phát bắn của Vỗ Cánh, Vỗ Cánh, Vỗ Cánh gây thêm sát thương phép và nhận thêm tia theo từng mốc cộng dồn.`,
    damageType: DamageType.MIXED,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    ...
    scaling: {
      stackSources: [
        `ABILITY_HIT_ENEMY_CHAMPION`,
        `SUPER_SCORCHER_BREATH_KILL`,
      ],
      superScorcherBreathAdditionalMagicDamagePercent: 30,
      superScorcherBreathUpgradeThresholds: [25, 100, 175],
      achoooExplosionAdditionalMagicDamagePercent: 55,
      flapFlapFlapHitAdditionalMagicDamagePercent: 12,
      flapFlapFlapExtraBoltEveryStacks: 65,
    },
    effects: [SkillEffect.BUFF, SkillEffect.DAMAGE],
    tags: [
      `STACKING_PASSIVE`,
  ...
  // SMOLDER - Q
  {
    ...
    nameVi: `Hơi Thở Bỏng Rát`,
    description: `Smolder belches flame, dealing physical damage and additional magic damage. If the target dies, Mana is refunded once per cast. Dragon Practice upgrades add nearby area damage, explosions beyond the target, and a late true damage burn that executes enemy champions who drop below a Health threshold while burning. This ability's damage scales with Critical Rate.`,
    descriptionVi: `Smolder phun lửa, gây sát thương vật lý và thêm sát thương phép. Nếu mục tiêu bị tiêu diệt, Smolder được hoàn trả Năng Lượng một lần mỗi lần dùng. Nâng cấp Luyện Rồng thêm sát thương diện rộng quanh mục tiêu, các vụ nổ phía sau mục tiêu, và về sau thêm hiệu ứng thiêu đốt sát thương chuẩn có thể kết liễu tướng địch rơi xuống dưới ngưỡng máu khi đang bị đốt. Sát thương kỹ năng này tăng theo Tỉ Lệ Chí Mạng.`,
    damageType: DamageType.MIXED,
    targetType: TargetType.ENEMY,
    cooldown: { values: [5, 5, 4, 4], unit: `seconds` },
    cost: { values: [30, 30, 30, 30], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [45, 80, 115, 150],
      bonusAttackDamageRatio: 1.1,
      additionalMagicDamagePercent: 40,
      manaRefundOnKill: 15,
      manaRefundOncePerCast: true,
      upgrade25StacksAreaDamageNearbyTarget: true,
      upgrade100StacksExplosionCountBeyondTarget: 2,
      upgrade100StacksExplosionDamagePercentOfAbilityDamage: 50,
      upgrade175StacksBurnDurationSeconds: 3,
      upgrade175StacksMaxHealthTrueDamageBonusAttackDamageRatioPercent: 0.025,
      executeEnemyChampionHealthThresholdPercent: 6.5,
      damageIncreasePercentPer10CriticalRatePercent: 7.5,
      maxCriticalRateDamageIncreasePercent: 75,
    },
    effects: [SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SMOLDER - W
  {
    ...
    name: `Achooo!`,
    nameVi: `Hắt Xì!`,
    description: `Smolder lets out a flaming sneeze, dealing physical damage and slowing enemies. Hitting champions causes an explosion that deals physical damage and additional magic damage in an area, with each consecutive explosion dealing reduced damage. Smolder gains Dragon Practice stacks per champion hit. This skill deals increased damage against minions and monsters.`,
    descriptionVi: `Smolder hắt ra ngọn lửa, gây sát thương vật lý và làm chậm kẻ địch. Trúng tướng sẽ gây một vụ nổ gây sát thương vật lý và thêm sát thương phép trong vùng, với mỗi vụ nổ liên tiếp gây giảm sát thương. Smolder nhận cộng dồn Luyện Rồng theo mỗi tướng trúng chiêu. Kỹ năng này gây thêm sát thương lên lính và quái.`,
    damageType: DamageType.MIXED,
    targetType: TargetType.LINE,
    cooldown: { values: [12, 11, 10, 9], unit: `seconds` },
    cost: { values: [50, 55, 60, 65], resource: `MANA` },
    range: null,
    scaling: {
      baseDamage: [65, 85, 105, 125],
      bonusAttackDamageRatio: 0.6,
      slowPercent: 35,
      slowDurationSeconds: 1.5,
      explosionDamage: [10, 35, 60, 85],
      explosionBonusAttackDamageRatio: 0.55,
      explosionAbilityPowerRatio: 0.8,
      explosionAdditionalMagicDamagePercent: 55,
      consecutiveExplosionDamagePercent: 75,
      dragonPracticeStacksPerChampionHit: 1,
      minionAndMonsterDamagePercent: 130,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SMOLDER - E
  {
    ...
    slot: SkillSlot.E,
    name: `Flap, Flap, Flap`,
    nameVi: `Vỗ Cánh, Vỗ Cánh, Vỗ Cánh`,
    description: `Smolder gains Movement Speed and ignores terrain for a short duration. While flying, he automatically locks on to the lowest Health enemy in range and bombards them multiple times. Each hit deals physical damage and additional magic damage. Dragon Vision grants expanded vision while flying and prioritizes champions for bombardment.`,
    descriptionVi: `Smolder nhận Tốc Độ Di Chuyển và bỏ qua địa hình trong thời gian ngắn. Khi đang bay, cậu tự động khóa mục tiêu thấp máu nhất trong tầm và oanh tạc nhiều lần. Mỗi phát gây sát thương vật lý và thêm sát thương phép. Tầm Nhìn Rồng cho tầm nhìn mở rộng khi đang bay và ưu tiên oanh tạc tướng.`,
    damageType: DamageType.MIXED,
    targetType: TargetType.SELF,
    cooldown: { values: [18, 16, 14, 12], unit: `seconds` },
    cost: { values: [65, 65, 65, 65], resource: `MANA` },
    ...
    scaling: {
      ...
      durationSeconds: 1.25,
      ignoresTerrain: true,
      lockOnTargetPriority: `LOWEST_HEALTH_ENEMY_IN_RANGE`,
      hitCount: 5,
      damagePerHit: [15, 20, 25, 30],
      attackDamageRatioPerHit: 0.3,
      additionalMagicDamagePercentPerHit: 12,
      expandedVisionWhileFlying: true,
      prioritizesChampions: true,
    },
    effects: [SkillEffect.BUFF, SkillEffect.SPEED_UP, SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // SMOLDER - R
  {
    ...
    name: `MMOOOMMMM!`,
    nameVi: `MẸ ƠI!`,
    description: `Smolder's mom breathes fire from above, dealing physical damage to enemies in range. Enemies in the center take increased physical damage and are slowed. Smolder heals if he is hit. This skill deals reduced damage against minions and monsters.`,
    descriptionVi: `Mẹ của Smolder phun lửa từ trên cao, gây sát thương vật lý lên kẻ địch trong vùng. Kẻ địch ở trung tâm nhận sát thương vật lý cao hơn và bị làm chậm. Smolder được hồi máu nếu bị ngọn lửa chạm vào. Kỹ năng này gây giảm sát thương lên lính và quái.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: { values: [80, 70, 60], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    ...
    scaling: {
      ...
      bonusAttackDamageRatio: 1.1,
      abilityPowerRatio: 1,
      centerDamage: [300, 450, 600],
      centerBonusAttackDamageRatio: 1.65,
      centerAbilityPowerRatio: 1.5,
      centerSlowPercent: 40,
      centerSlowDurationSeconds: 2,
      selfHealValue: [100, 135, 170],
      selfHealBonusAttackDamageRatio: 0.5,
      selfHealAbilityPowerRatio: 0.75,
      minionAndMonsterDamagePercent: 50,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW, SkillEffect.HEAL],
    tags: [
  ...
  // SONA - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Power Chord`,
    nameVi: `Hợp Âm Sức Mạnh`,
    description: `After casting basic abilities enough times, Sona's next attack is empowered, dealing bonus magic damage and stunning the target. Casting basic abilities creates a non-stacking aura for a short duration. Sona gains full passive stacks at respawn. Power Chord gains a different bonus based on the last basic ability cast: Hymn of Valor increases bonus damage, Aria of Perseverance reduces the target's damage dealt, and Song of Celerity slows the target. Sona's basic ability cooldowns are reduced based on level.`,
    descriptionVi: `Sau khi dùng đủ số kỹ năng cơ bản, đòn đánh kế tiếp của Sona được cường hóa, gây thêm sát thương phép và làm choáng mục tiêu. Dùng kỹ năng cơ bản tạo một hào quang không cộng dồn trong thời gian ngắn. Sona nhận đủ cộng dồn nội tại khi hồi sinh. Hợp Âm Sức Mạnh nhận hiệu ứng khác nhau dựa trên kỹ năng cơ bản được dùng gần nhất: Anh Hùng Ca tăng sát thương cộng thêm, Giai Điệu Khích Lệ giảm sát thương mục tiêu gây ra, và Bản Nhạc Tốc Độ làm chậm mục tiêu. Hồi chiêu kỹ năng cơ bản của Sona được giảm theo cấp.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      basicAbilityCastsRequired: 3,
      empoweredAttackBonusDamageByLevelRange: [20, 160],
      abilityPowerRatio: 0.15,
      stunDurationSeconds: 0.5,
      auraDurationSeconds: 3,
      fullPassiveStacksAtRespawn: true,
      staccatoBonusMagicDamage: 8,
      staccatoAbilityPowerRatio: 0.06,
      diminuendoDamageReductionPercent: 25,
      diminuendoAbilityPowerRatioPercent: 4,
      diminuendoDurationSeconds: 3,
      tempoSlowPercent: 40,
      tempoAbilityPowerRatioPercent: 4,
      tempoDurationSeconds: 2,
      basicAbilityCooldownReductionByLevelPercentRange: [2, 20],
    },
    effects: [
      SkillEffect.BUFF,
      SkillEffect.DAMAGE,
  ...
  // SONA - Q
  {
    ...
    name: `Hymn of Valor`,
    nameVi: `Anh Hùng Ca`,
    description: `Sona deals magic damage to the nearest enemies. Aura: Allied champions' next attack is enhanced to deal bonus magic damage.`,
    descriptionVi: `Sona gây sát thương phép lên các kẻ địch gần nhất. Hào quang: Đòn đánh kế tiếp của tướng đồng minh được cường hóa để gây thêm sát thương phép.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: { values: [8, 8, 8, 8], unit: `seconds` },
    cost: { values: [60, 65, 70, 75], resource: `MANA` },
    range: null,
    scaling: {
      targetCount: 2,
      baseDamage: [40, 80, 120, 160],
      abilityPowerRatio: 0.4,
      auraBonusMagicDamage: [8, 13, 18, 23],
      auraBonusMagicDamageAbilityPowerRatio: 0.2,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.BUFF],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // SONA - W
  {
    ...
    nameVi: `Giai Điệu Khích Lệ`,
    description: `Sona heals herself and another allied champion. Aura: Allied champions gain a shield for a short duration.`,
    descriptionVi: `Sona hồi máu cho bản thân và một tướng đồng minh khác. Hào quang: Tướng đồng minh nhận lá chắn trong thời gian ngắn.`,
    damageType: DamageType.NONE,
    targetType: TargetType.ALLY,
    cooldown: { values: [10, 10, 10, 10], unit: `seconds` },
    cost: { values: [85, 90, 95, 100], resource: `MANA` },
    range: null,
    scaling: {
      healValue: [25, 40, 55, 70],
      healAbilityPowerRatio: 0.2,
      allyHealTargetCount: 1,
      shieldValue: [25, 50, 75, 100],
      shieldAbilityPowerRatio: 0.18,
      shieldDurationSeconds: 3,
    },
    effects: [SkillEffect.HEAL, SkillEffect.SHIELD],
    tags: [
  ...
  // SONA - E
  {
    ...
    nameVi: `Bản Nhạc Tốc Độ`,
    description: `Sona gains Movement Speed for a duration. Aura: Allied champions within the aura gain Movement Speed. The empowered aura grants increased Movement Speed compared to the normal aura.`,
    descriptionVi: `Sona nhận Tốc Độ Di Chuyển trong một khoảng thời gian. Hào quang: Tướng đồng minh trong vùng hào quang nhận Tốc Độ Di Chuyển. Hào quang cường hóa cho nhiều Tốc Độ Di Chuyển hơn hào quang thường.`,
    damageType: DamageType.NONE,
    targetType: TargetType.AREA,
    cooldown: { values: [14, 14, 14, 14], unit: `seconds` },
    cost: { values: [80, 80, 80, 80], resource: `MANA` },
    range: null,
    scaling: {
      moveSpeedPercent: [10, 11, 12, 13],
      moveSpeedAbilityPowerRatioPercent: 3,
      moveSpeedDurationSeconds: 5,
      auraDurationSeconds: 5,
      allyMoveSpeedPercent: [10, 11, 12, 13],
      allyMoveSpeedAbilityPowerRatioPercent: 3,
      empoweredAuraMoveSpeedMultiplier: 1.2,
    },
    effects: [SkillEffect.SPEED_UP, SkillEffect.BUFF],
    tags: [
      `SPEED_UP`,
  ...
  // SONA - R
  {
    ...
    slot: SkillSlot.R,
    name: `Crescendo`,
    nameVi: `Khúc Cao Trào`,
    description: `Passive: Sona's aura is reinforced for a long duration after casting this ability, providing a stronger buff than usual. Active: Sona plays a chord that emits repeated soundwaves as it travels to the target location. Each soundwave deals magic damage and stuns enemies. Enemies inside the chord are also slowed.`,
    descriptionVi: `Nội tại: Hào quang của Sona được cường hóa trong thời gian dài sau khi dùng kỹ năng này, cung cấp hiệu ứng mạnh hơn bình thường. Kích hoạt: Sona chơi một hợp âm phát ra các đợt sóng âm lặp lại khi di chuyển tới vị trí chỉ định. Mỗi đợt sóng âm gây sát thương phép và làm choáng kẻ địch. Kẻ địch bên trong hợp âm cũng bị làm chậm.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: { values: [80, 70, 60], unit: `seconds` },
    cost: { values: [100, 100, 100], resource: `MANA` },
    range: null,
    scaling: {
      reinforcedAuraDurationSeconds: 20,
      soundwaveIntervalSeconds: 0.75,
      damagePerSoundwave: [35, 60, 85],
      abilityPowerRatioPerSoundwave: 0.15,
      stunDurationSeconds: 1,
      slowPercent: [25, 30, 35],
    },
    effects: [
      SkillEffect.DAMAGE,
      SkillEffect.STUN,
  ...
  // SORAKA - PASSIVE
  {
    ...
    name: `Salvation`,
    nameVi: `Cứu Rỗi`,
    description: `Soraka gains 100% Movement Speed when moving toward allied champions below 35% Health.`,
    descriptionVi: `Soraka nhận 100% Tốc Độ Di Chuyển khi di chuyển về phía tướng đồng minh dưới 35% Máu.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
  ...
  // SORAKA - Q
  {
    ...
    name: `Starcall`,
    nameVi: `Vẫn Tinh`,
    description: `Calls a star, dealing magic damage and slowing enemies by 30% for 2 seconds. If an enemy champion is hit, Soraka gains Rejuvenation, healing over 2.5 seconds. After healing allied champions 3 times, Starcall is empowered to deal 140% damage in a larger area. Cooldown is reduced when hitting enemy champions.`,
    descriptionVi: `Gọi một ngôi sao rơi xuống, gây sát thương phép và làm chậm kẻ địch 30% trong 2 giây. Nếu trúng tướng địch, Soraka nhận Hồi Xuân, hồi máu theo thời gian trong 2.5 giây. Sau khi hồi máu tướng đồng minh 3 lần, Vẫn Tinh được cường hóa để gây 140% sát thương trong vùng lớn hơn. Hồi chiêu được giảm khi trúng tướng địch.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: {
      values: [7, 6, 5, 4],
    ...
    scaling: {
      ...
      empoweredAfterAllyHeals: 3,
      empoweredDamagePercent: 140,
      empoweredArea: `larger`,
      championHitCooldownReduction: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW, SkillEffect.HEAL],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // SORAKA - W
  {
    ...
    nameVi: `Tinh Tú Hộ Mệnh`,
    description: `Heals another allied champion. Excess healing is converted into a shield up to a maximum shield value.`,
    descriptionVi: `Hồi máu cho một tướng đồng minh khác. Lượng hồi máu vượt mức được chuyển thành lá chắn tới một giá trị tối đa.`,
    damageType: DamageType.NONE,
    targetType: TargetType.ALLY,
    cooldown: {
      values: [7, 6, 5, 4],
  ...
  // SORAKA - E
  {
    ...
    slot: SkillSlot.E,
    name: `Equinox`,
    nameVi: `Điểm Phân Cực`,
    description: `Creates a zone that deals magic damage and silences enemies. The zone expires after 1.5 seconds, dealing magic damage again and rooting enemies.`,
    descriptionVi: `Tạo một vùng gây sát thương phép và câm lặng kẻ địch. Vùng này kết thúc sau 1.5 giây, gây sát thương phép lần nữa và trói chân kẻ địch.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: {
      values: [20, 18, 16, 14],
  ...
  // SORAKA - R
  {
    ...
    name: `Wish`,
    nameVi: `Nguyện Ước`,
    description: `Heals all allied champions. Healing is increased by 50% if the ally is below 35% Health.`,
    descriptionVi: `Hồi máu cho tất cả tướng đồng minh. Lượng hồi máu tăng 50% nếu đồng minh dưới 35% Máu.`,
    damageType: DamageType.NONE,
    targetType: TargetType.ALLIES,
    cooldown: {
      values: [85, 80, 75],
  ...
  // SWAIN - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Ravenous Flock`,
    nameVi: `Bầy Quạ Tham Lam`,
    description: `Swain collects Soul Fragments when Vision of Empire and Nevermove hit enemy champions, and when enemy champions die. Soul Fragments heal Swain for a percentage of his Health and permanently grant maximum Health.`,
    descriptionVi: `Swain thu thập Mảnh Hồn khi Tầm Nhìn Bá Chủ và Trói Buộc trúng tướng địch, đồng thời khi tướng địch bị hạ gục. Mảnh Hồn hồi cho Swain một phần trăm Máu và vĩnh viễn tăng Máu tối đa.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      soulFragmentHealPercent: [3, 3.5, 4, 4.5],
      soulFragmentHealAbilityPowerRatioPercent: 0.5,
      maxHealthPerSoulFragment: 16,
    },
    effects: [SkillEffect.HEAL, SkillEffect.BUFF],
    tags: [
      `STACKING_PASSIVE`,
  ...
  // SWAIN - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Death's Hand`,
    nameVi: `Bàn Tay Tử Thần`,
    description: `Swain extends his demonic arm to launch eldritch bolts at enemies, dealing magic damage to enemies within range. Each bolt after the first deals additional magic damage, up to a cap.`,
    descriptionVi: `Swain vươn cánh tay quỷ để phóng các tia năng lượng hắc ám vào kẻ địch, gây sát thương phép lên kẻ địch trong tầm. Mỗi tia sau tia đầu tiên gây thêm sát thương phép, tới một giới hạn tối đa.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: {
      values: [6, 5, 4, 3],
    ...
    scaling: {
      firstBoltDamage: {
        values: [55, 90, 125, 160],
        abilityPowerRatio: 0.32,
        damageType: `MAGIC`,
      },
      additionalBoltDamage: {
        values: [10, 20, 30, 40],
        abilityPowerRatio: 0.12,
        maxDamage: 110,
        damageType: `MAGIC`,
      },
    },
  ...
  // SWAIN - W
  {
    ...
    nameVi: `Tầm Nhìn Bá Chủ`,
    description: `Swain summons a demonic eye that explodes after a short delay, dealing magic damage, slowing enemies, and revealing targets hit. If Vision of Empire damages an immobilized champion, it critically strikes for bonus damage. Champions hit grant 1 Soul Fragment.`,
    descriptionVi: `Swain triệu hồi một con mắt quỷ phát nổ sau một khoảng trễ ngắn, gây sát thương phép, làm chậm kẻ địch và làm lộ diện mục tiêu trúng chiêu. Nếu Tầm Nhìn Bá Chủ gây sát thương lên tướng bị bất động, nó chí mạng gây thêm sát thương. Tướng trúng chiêu cho 1 Mảnh Hồn.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: {
      values: [21, 20, 19, 18],
    ...
    scaling: {
      ...
      slowDurationSeconds: 2.5,
      revealDurationSeconds: 4,
      immobilizedChampionCriticalDamageIncreasePercent: 50,
      soulFragmentsFromChampionHit: 1,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW, SkillEffect.REVEAL],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // SWAIN - E
  {
    ...
    name: `Nevermove`,
    nameVi: `Trói Buộc`,
    description: `Swain launches a demonic wave that deals magic damage to enemies along the way, then returns after reaching maximum distance, dealing magic damage in an area and rooting enemies. Recast pulls rooted champions to Swain and collects 1 Soul Fragment from targets.`,
    descriptionVi: `Swain phóng ra một làn sóng quỷ gây sát thương phép lên kẻ địch trên đường bay, sau đó quay lại khi đạt tầm tối đa, gây sát thương phép trong vùng và trói chân kẻ địch. Tái kích hoạt kéo các tướng bị trói về phía Swain và thu thập 1 Mảnh Hồn từ mục tiêu.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: {
      values: [10, 10, 10, 10],
    ...
    scaling: {
      ...
      rootDurationSeconds: 1.5,
      soulFragmentsFromPulledTargets: 1,
      recast: {
        pullsRootedChampions: true,
      },
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.ROOT, SkillEffect.BUFF],
    tags: [
  ...
  // SWAIN - R
  {
    ...
    nameVi: `Hóa Quỷ`,
    description: `Swain frees the demon, dealing magic damage per second to nearby enemies and restoring Health to himself. Recast can be used after 2 seconds to deal damage and slow enemies. Demon Energy depletes over time, can be recharged indefinitely by draining enemy champions, and is fully restored on champion takedowns.`,
    descriptionVi: `Swain giải phóng con quỷ, gây sát thương phép mỗi giây lên kẻ địch xung quanh và hồi Máu cho bản thân. Có thể tái kích hoạt sau 2 giây để gây sát thương và làm chậm kẻ địch. Năng Lượng Quỷ giảm dần theo thời gian, có thể được hồi vô hạn bằng cách hút máu tướng địch, và được hồi đầy khi tham gia hạ gục tướng.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: {
      values: [75, 65, 55],
    ...
    scaling: {
      ...
      nonChampionUnitHealPercent: 10,
      recastAvailableAfterSeconds: 2,
      demonflareCooldownSeconds: 6,
      demonEnergy: {
        depletesOverTime: true,
        rechargesFromDrainingEnemyChampions: true,
        fullyRestoredOnChampionTakedown: true,
      },
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.HEAL, SkillEffect.SLOW],
    tags: [
  ...
  // SYNDRA - PASSIVE
  {
    ...
    name: `Transcendent`,
    nameVi: `Siêu Việt`,
    description: `Every instance of ability damage dealt to an enemy champion grants 1 Splinter of Wrath and restores mana. Syndra gains 4 Splinters of Wrath every time she levels up an ability, up to 120 Splinters. At 40, 60, and 80 Splinters, her basic abilities are empowered. At 100 Splinters, Unleashed Power is empowered. At 120 Splinters, Syndra gains bonus Ability Power.`,
    descriptionVi: `Mỗi lần kỹ năng gây sát thương lên tướng địch cho Syndra 1 Mảnh Thịnh Nộ và hồi năng lượng. Syndra nhận 4 Mảnh Thịnh Nộ mỗi khi nâng cấp kỹ năng, tối đa 120 Mảnh. Ở 40, 60 và 80 Mảnh, các kỹ năng cơ bản của cô được cường hóa. Ở 100 Mảnh, Bùng Nổ Sức Mạnh được cường hóa. Ở 120 Mảnh, Syndra nhận thêm Sức Mạnh Phép Thuật.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      splintersPerAbilityDamageInstanceToChampion: 1,
      manaRestorePerAbilityDamageInstance: 13,
      splintersPerAbilityLevelUp: 4,
      maxSplinters: 120,
      basicAbilityUpgradeThresholds: [40, 60, 80],
      ultimateUpgradeThreshold: 100,
      bonusAbilityPowerThreshold: 120,
      bonusAbilityPowerPercent: 12,
    },
    effects: [SkillEffect.BUFF],
    tags: [
      `STACKING_PASSIVE`,
  ...
  // SYNDRA - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Dark Sphere`,
    nameVi: `Quả Cầu Bóng Tối`,
    description: `Conjures a Dark Sphere, dealing magic damage. The Sphere remains for 6 seconds and can be manipulated by Syndra's other abilities. Transcendent: stores a charge of Dark Sphere every 7 seconds, up to 2 charges, and can be cast while moving.`,
    descriptionVi: `Tạo ra một Quả Cầu Bóng Tối, gây sát thương phép. Quả Cầu tồn tại trong 6 giây và có thể được Syndra điều khiển bằng các kỹ năng khác. Siêu Việt: tích trữ một điểm dùng Quả Cầu Bóng Tối mỗi 7 giây, tối đa 2 điểm, và có thể dùng khi đang di chuyển.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: {
      values: [7, 7, 6, 5],
    ...
    scaling: {
      ...
      sphereDurationSeconds: 6,
      transcendent: {
        chargeCooldownSeconds: 7,
        maxCharges: 2,
  ...
  // SYNDRA - W
  {
    ...
    name: `Force of Will`,
    nameVi: `Ý Lực`,
    description: `Grabs the nearest Dark Sphere and hurls it at a target location, dealing magic damage to enemies in the area and slowing them. If there is no nearby Dark Sphere, Syndra generates one and hurls it, but the Sphere damage is reduced. Transcendent: deals additional true damage.`,
    descriptionVi: `Nắm lấy Quả Cầu Bóng Tối gần nhất và ném tới vị trí chỉ định, gây sát thương phép lên kẻ địch trong vùng và làm chậm chúng. Nếu không có Quả Cầu gần đó, Syndra tạo một Quả Cầu rồi ném đi, nhưng sát thương từ Quả Cầu bị giảm. Siêu Việt: gây thêm sát thương chuẩn.`,
    damageType: DamageType.MIXED,
    targetType: TargetType.AREA,
    cooldown: {
      values: [12, 11, 10, 9],
    ...
    scaling: {
      ...
      generatedSphereDamagePercent: 80,
      slowPercent: [20, 25, 30, 35],
      slowDurationSeconds: 1.5,
      transcendent: {
        bonusTrueDamagePercent: 12,
        bonusTrueDamageAbilityPowerRatioPercent: 2,
      },
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW],
    tags: [
  ...
  // SYNDRA - E
  {
    ...
    nameVi: `Quét Tan Kẻ Yếu`,
    description: `Projects a wave of force in a cone, knocking back enemies and Dark Spheres and dealing magic damage. Dark Spheres knocked back by the wave stun and knock back enemies hit along the way. Transcendent: increases the cone angle and radius.`,
    descriptionVi: `Phóng ra một làn sóng lực theo hình nón, đẩy lùi kẻ địch và Quả Cầu Bóng Tối, đồng thời gây sát thương phép. Quả Cầu bị đẩy bởi làn sóng sẽ làm choáng và đẩy lùi kẻ địch trúng phải trên đường bay. Siêu Việt: tăng góc hình nón và bán kính của làn sóng.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: {
      values: [17, 17, 17, 17],
    ...
    scaling: {
      waveDamage: {
        values: [70, 110, 150, 190],
        abilityPowerRatio: 0.35,
        damageType: `MAGIC`,
      },
      sphereCollisionDamage: {
        values: [70, 110, 150, 190],
        abilityPowerRatio: 0.35,
        damageType: `MAGIC`,
      },
      sphereStunDurationSeconds: 1.25,
      transcendent: {
        coneAngleIncreasePercent: 50,
        radius: 720,
      },
      damageAndKnockbackLimitPerEnemyPerCast: 1,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.KNOCK_BACK, SkillEffect.STUN],
    tags: [
      `MAGIC_DAMAGE`,
      `CONE_DAMAGE`,
      `KNOCK_BACK`,
  ...
  // SYNDRA - R
  {
    ...
    nameVi: `Bùng Nổ Sức Mạnh`,
    description: `Manipulates the 3 Dark Spheres orbiting Syndra plus up to 4 nearby Dark Spheres, launching them at an enemy champion. Each Sphere deals magic damage. Transcendent: increases cast range, executes enemies below 10% Health, and if this ability kills an enemy champion, the Dark Spheres detonate at the death location and damage nearby enemy champions.`,
    descriptionVi: `Điều khiển 3 Quả Cầu Bóng Tối bay quanh Syndra cùng tối đa 4 Quả Cầu gần đó, phóng chúng vào một tướng địch. Mỗi Quả Cầu gây sát thương phép. Siêu Việt: tăng tầm dùng chiêu, kết liễu kẻ địch dưới 10% Máu, và nếu kỹ năng này hạ gục tướng địch, các Quả Cầu phát nổ tại vị trí mục tiêu bị hạ và gây sát thương lên tướng địch xung quanh.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.CHAMPION,
    cooldown: {
      values: [80, 70, 60],
    ...
    range: null,
    scaling: {
      baseOrbitingSpheres: 3,
      maxAdditionalNearbySpheres: 4,
      maxTotalSpheres: 7,
      damagePerSphere: {
        values: [60, 110, 165],
        abilityPowerRatio: 0.15,
      ...
      transcendent: {
        castRangeIncrease: 100,
        executeHealthThresholdPercent: 10,
        championKillDetonation: {
          damage: {
            values: [60, 110, 160],
            abilityPowerRatio: 0.15,
            damageType: `MAGIC`,
          },
          targetType: `nearby_enemy_champions`,
        },
      },
    },
    effects: [SkillEffect.DAMAGE],
  ...
  // TALIYAH - PASSIVE
  {
    ...
    name: `Rock Surfing`,
    nameVi: `Lướt Đá`,
    description: `Taliyah gains Movement Speed while out of combat and near a wall.`,
    descriptionVi: `Taliyah nhận Tốc Độ Di Chuyển khi ngoài giao tranh và ở gần tường.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
  ...
  // TALIYAH - Q
  {
    ...
    nameVi: `Phi Thạch`,
    description: `Taliyah hurls 5 rocks in a target direction, each dealing magic damage in an area around the first enemy hit and creating Worked Ground below herself. Subsequent hits against the same target deal reduced damage. Casting on Worked Ground costs less Mana, consumes the Worked Ground, has reduced cooldown, and hurls a boulder that deals magic damage to the primary target and slows enemies hit. Monsters hit by the boulder are stunned.`,
    descriptionVi: `Taliyah ném 5 viên đá theo hướng chỉ định, mỗi viên gây sát thương phép trong vùng quanh kẻ địch đầu tiên trúng phải và tạo Đất Biến Đổi bên dưới cô. Các lần trúng tiếp theo lên cùng mục tiêu gây giảm sát thương. Dùng trên Đất Biến Đổi tiêu hao ít Năng Lượng hơn, tiêu thụ Đất Biến Đổi, giảm hồi chiêu, và ném một tảng đá gây sát thương phép lên mục tiêu chính đồng thời làm chậm kẻ địch trúng phải. Quái trúng tảng đá bị làm choáng.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: {
      values: [6, 5, 4, 3],
    ...
    scaling: {
      ...
      repeatedHitDamageReductionPercent: 60,
      createsWorkedGround: true,
      workedGroundCast: {
        manaCost: 10,
        consumesWorkedGround: true,
        cooldownReductionPercent: 50,
        boulderDamage: {
          values: [100, 140, 180, 220],
          abilityPowerRatio: 0.8,
        ...
        slowPercent: [25, 30, 35, 40],
        slowDurationSeconds: 1.5,
        monsterStunDurationSeconds: 3,
      },
      monsterBonusDamagePerRock: 20,
      monsterBonusDamagePerBoulder: 36,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW, SkillEffect.STUN],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // TALIYAH - W
  {
    ...
    slot: SkillSlot.W,
    name: `Seismic Shove`,
    nameVi: `Quăng Địa Chấn`,
    description: `Taliyah causes an area of ground to erupt after a brief delay, knocking enemies in the area in the chosen direction.`,
    descriptionVi: `Taliyah khiến một vùng đất phun trào sau một khoảng trễ ngắn, hất kẻ địch trong vùng theo hướng đã chọn.`,
    damageType: DamageType.NONE,
    targetType: TargetType.AREA,
    cooldown: {
      values: [13, 11, 9, 7],
    ...
    range: null,
    scaling: {
      delayedEruption: true,
      chosenDirectionKnockback: true,
    },
    effects: [SkillEffect.KNOCK_BACK],
    tags: [
      `DELAYED_AREA`,
      `KNOCK_BACK`,
      `DISPLACEMENT`,
  ...
  // TALIYAH - E
  {
    ...
    nameVi: `Tấm Thảm Bất Ổn`,
    description: `Taliyah scatters loose stones, dealing magic damage and slowing enemies hit. The stones detonate when enemies dash or are knocked through them, dealing magic damage and stunning for the remaining movement duration plus a bonus duration. Monsters are always stunned for the maximum duration and take increased damage.`,
    descriptionVi: `Taliyah rải đá vụn, gây sát thương phép và làm chậm kẻ địch trúng phải. Những viên đá phát nổ khi kẻ địch lướt qua hoặc bị hất qua chúng, gây sát thương phép và làm choáng trong thời gian di chuyển còn lại cộng thêm một khoảng thời gian. Quái luôn bị choáng tối đa và nhận thêm sát thương.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: {
      values: [12, 12, 12, 12],
    ...
    scaling: {
      ...
      stunDuration: {
        remainingMovementDurationPlusSeconds: 0.75,
        monstersAlwaysMaximumDuration: true,
      },
      monsterDamagePercent: 190,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW, SkillEffect.STUN],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // TALIYAH - R
  {
    ...
    slot: SkillSlot.R,
    name: `Weaver's Wall`,
    nameVi: `Mặt Đất Dậy Sóng`,
    description: `Taliyah creates a massive earthen wall for 4 seconds, knocking back nearby enemies when it forms. Once fully formed, Taliyah can recast to destroy it early. If recast immediately, Taliyah rides along the wall as it unravels. Moving or being immobilized ends the ride. This ability cannot be cast if Taliyah has taken damage from champions or structures within the last 3 seconds.`,
    descriptionVi: `Taliyah tạo một bức tường đất khổng lồ trong 4 giây, đẩy lùi kẻ địch gần đó khi hình thành. Sau khi bức tường hoàn tất, Taliyah có thể tái kích hoạt để phá hủy sớm. Nếu tái kích hoạt ngay lập tức, Taliyah sẽ cưỡi theo bức tường khi nó mở ra. Di chuyển hoặc bị bất động sẽ kết thúc trạng thái cưỡi. Kỹ năng này không thể dùng nếu Taliyah đã nhận sát thương từ tướng hoặc công trình trong 3 giây gần nhất.`,
    damageType: DamageType.NONE,
    targetType: TargetType.LINE,
    cooldown: {
      values: [94, 85, 75],
    ...
    range: null,
    scaling: {
      wallDurationSeconds: 4,
      knocksBackNearbyEnemiesOnFormation: true,
      recastCanDestroyWallEarly: true,
      immediateRecastRide: true,
      rideEndsOnMovementOrImmobilize: true,
      cannotCastAfterChampionOrStructureDamageSeconds: 3,
    },
    effects: [SkillEffect.KNOCK_BACK, SkillEffect.DASH],
    tags: [
      `TERRAIN_CONTROL`,
      `PATH_MAKER`,
      `TERRAIN_TRAVEL`,
  ...
  // TALON - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Blade's End`,
    nameVi: `Lưỡi Dao Kết Liễu`,
    description: `Talon's abilities apply Wound stacks to enemy champions and large monsters for 6 seconds, stacking up to 3 times. Attacking a target with 3 Wound stacks consumes them and causes the target to bleed, dealing physical damage over 2 seconds. Monsters take reduced bleed damage. If an enemy champion dies while bleeding, Talon gains decaying Movement Speed.`,
    descriptionVi: `Kỹ năng của Talon đặt cộng dồn Vết Thương lên tướng địch và quái lớn trong 6 giây, tối đa 3 cộng dồn. Đánh thường mục tiêu có 3 cộng dồn Vết Thương sẽ tiêu thụ chúng và khiến mục tiêu chảy máu, gây sát thương vật lý trong 2 giây. Quái chịu giảm sát thương chảy máu. Nếu tướng địch bị hạ khi đang chảy máu, Talon nhận Tốc Độ Di Chuyển giảm dần.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.ENEMY,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      woundDurationSeconds: 6,
      maxWoundStacks: 3,
      damagingSameTargetRefreshesWoundDuration: true,
      bleedDamage: {
        minValue: 100,
        maxValue: 300,
        bonusAttackDamageRatio: 2.1,
        durationSeconds: 2,
        damageType: `PHYSICAL`,
      },
      monsterDamagePercent: 90,
      targetCannotGainWoundStacksWhileBleeding: true,
      championBleedKillMovementSpeed: {
  ...
  // TALON - Q
  {
    ...
    nameVi: `Ngoại Giao Noxus`,
    description: `Long-range cast: Talon dashes toward an enemy champion and deals physical damage. Close-range cast: Talon stabs the target, dealing higher physical damage. If this ability kills the target, Talon restores Health and the ability's cooldown is reduced. Higher Armor Penetration increases the dash and cast speed. Close-range damage scales with Critical Strike Damage.`,
    descriptionVi: `Dùng từ xa: Talon lướt tới tướng địch và gây sát thương vật lý. Dùng cận chiến: Talon đâm mục tiêu, gây sát thương vật lý cao hơn. Nếu kỹ năng này hạ gục mục tiêu, Talon hồi Máu và được giảm hồi chiêu. Xuyên Giáp càng cao thì tốc độ lướt và thi triển càng nhanh. Sát thương cận chiến tăng theo Sát Thương Chí Mạng.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.ENEMY,
    cooldown: {
      values: [7, 6, 6, 5],
    ...
    scaling: {
      ...
      closeRangeDamage: {
        values: [98, 135, 173, 210],
        bonusAttackDamageRatio: 1.5,
        damageType: `PHYSICAL`,
        scalesWithCriticalStrikeDamage: true,
      },
      onKillHeal: {
        minValue: 35,
        maxValue: 70,
      },
      onKillCooldownReductionPercent: 65,
      armorPenetrationIncreasesDashAndCastSpeed: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.DASH, SkillEffect.HEAL],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // TALON - W
  {
    ...
    name: `Rake`,
    nameVi: `Ám Khí`,
    description: `Talon tosses daggers in a cone at the target area, dealing physical damage to enemies hit. Upon reaching maximum range, the daggers linger briefly before returning, dealing physical damage to enemies hit along the way and slowing them. Deals reduced damage to monsters.`,
    descriptionVi: `Talon ném dao theo hình nón tới vùng chỉ định, gây sát thương vật lý lên kẻ địch trúng phải. Khi đạt tầm tối đa, các lưỡi dao tồn tại ngắn rồi quay lại, gây sát thương vật lý lên kẻ địch trên đường về và làm chậm chúng. Gây giảm sát thương lên quái.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: {
      values: [8, 7, 7, 6],
  ...
  // TALON - E
  {
    ...
    nameVi: `Con Đường Thích Khách`,
    description: `Talon vaults over the terrain or structure closest to him. Talon cannot vault over the same terrain again for a long per-terrain cooldown that decreases with Ability Haste. Talon's speed after vaulting over terrain and turrets is increased.`,
    descriptionVi: `Talon phóng qua địa hình hoặc công trình gần nhất. Talon không thể phóng qua cùng một địa hình lần nữa trong một hồi chiêu riêng theo địa hình, giảm theo Điểm Hồi Kỹ Năng. Tốc độ của Talon sau khi phóng qua địa hình và trụ được tăng.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: {
      values: [1, 1, 1, 1],
    ...
    range: null,
    scaling: {
      perTerrainCooldownSeconds: [135, 110, 85, 60],
      perTerrainCooldownDecreasesWithAbilityHaste: true,
      postVaultSpeedIncreasePercent: 10,
      canVaultOverTerrain: true,
      canVaultOverStructures: true,
    },
    effects: [SkillEffect.DASH, SkillEffect.SPEED_UP],
    tags: [
      `TERRAIN_INTERACTION`,
      `TERRAIN_TRAVEL`,
      `LEAP`,
  ...
  // TALON - R
  {
    ...
    slot: SkillSlot.R,
    name: `Shadow Assault`,
    nameVi: `Sát Thủ Vô Hình`,
    description: `First cast: Talon flings out a ring of blades around himself, dealing physical damage to nearby enemies and gaining invisibility and bonus Movement Speed. Recast: Talon exits invisibility and recalls the blades, dealing physical damage again to enemies hit along the way. If Talon exits invisibility with an attack or Noxian Diplomacy, the blades converge toward the target enemy.`,
    descriptionVi: `Lần dùng đầu: Talon tung ra một vòng lưỡi dao quanh bản thân, gây sát thương vật lý lên kẻ địch gần đó và nhận tàng hình cùng Tốc Độ Di Chuyển cộng thêm. Tái kích hoạt: Talon rời tàng hình và thu hồi lưỡi dao, gây sát thương vật lý lần nữa lên kẻ địch trên đường bay. Nếu Talon thoát tàng hình bằng đòn đánh hoặc Ngoại Giao Noxus, các lưỡi dao sẽ hội tụ về mục tiêu địch.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: {
      values: [65, 55, 45],
    ...
    scaling: {
      ...
      invisibilityDurationSeconds: 2.5,
      movementSpeedPercent: [40, 55, 70],
      recastAvailableAfterSeconds: 1,
      automaticRecastWhenInvisibilityEndsOrIsDisabled: true,
      recastDamage: {
        values: [90, 130, 170],
        bonusAttackDamageRatio: 1,
        damageType: `PHYSICAL`,
      },
      bladesConvergeToTargetWhenExitingWithAttackOrNoxianDiplomacy: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SPEED_UP, SkillEffect.BUFF],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // TEEMO - PASSIVE
  {
    ...
    name: `Toxic Shot`,
    nameVi: `Bắn Độc`,
    description: `Teemo's attacks deal bonus magic damage on impact and additional magic damage each second over 4 seconds.`,
    descriptionVi: `Đòn đánh của Teemo gây thêm sát thương phép khi trúng đích và gây thêm sát thương phép mỗi giây trong 4 giây.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.ENEMY,
    cooldown: null,
    cost: null,
  ...
  // TEEMO - Q
  {
    ...
    name: `Blinding Dart`,
    nameVi: `Phi Tiêu Mù`,
    description: `Teemo deals magic damage and blinds the target. Attacks from blinded enemies miss, dealing no damage and failing to apply on-hit effects.`,
    descriptionVi: `Teemo gây sát thương phép và làm mù mục tiêu. Đòn đánh từ kẻ địch bị mù sẽ trượt, không gây sát thương và không kích hoạt hiệu ứng đòn đánh.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.ENEMY,
    cooldown: {
      values: [8, 8, 8, 8],
    ...
    scaling: {
      ...
      blindDurationSeconds: [1.25, 1.5, 1.75, 2],
      blindedAttacksMiss: true,
      blindedAttacksDoNotApplyOnHitEffects: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.BUFF],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // TEEMO - W
  {
    ...
    name: `Move Quick`,
    nameVi: `Chạy Lẹ`,
    description: `Passive: Teemo gains Movement Speed if he has not taken damage from an enemy champion or structure recently. Active: Teemo rolls a short distance forward and sprints for 3 seconds, doubling Move Quick's bonus and making it unable to be removed by damage during the sprint.`,
    descriptionVi: `Nội tại: Teemo nhận Tốc Độ Di Chuyển nếu gần đây không nhận sát thương từ tướng địch hoặc công trình. Kích hoạt: Teemo lộn một đoạn ngắn về phía trước và chạy nước rút trong 3 giây, nhân đôi hiệu ứng Chạy Lẹ và khiến nó không thể bị loại bỏ bởi sát thương trong thời gian chạy nước rút.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: {
      values: [17, 16, 15, 14],
    ...
    range: null,
    scaling: {
      passiveMovementSpeedPercent: [15, 20, 25, 30],
      passiveDisabledAfterChampionOrStructureDamageSeconds: 5,
      activeDurationSeconds: 3,
      activeDoublesMoveQuickBonus: true,
      activeBonusCannotBeRemovedByDamage: true,
      shortForwardRoll: true,
    },
    effects: [SkillEffect.SPEED_UP, SkillEffect.DASH],
    tags: [
      `SPEED_UP`,
      `REPOSITION`,
      `DASH`,
  ...
  // TEEMO - E
  {
    ...
    nameVi: `Chiến Tranh Du Kích`,
    description: `After a delay, Teemo becomes Camouflaged. Moving outside brush for too long ends this effect. After exiting Camouflage, Teemo gains Attack Speed for a duration. Enemy turrets reveal camouflaged units near them, and attacks or offensive abilities end Camouflage early.`,
    descriptionVi: `Sau một khoảng trễ, Teemo trở nên Ngụy Trang. Di chuyển ngoài bụi cỏ quá lâu sẽ kết thúc hiệu ứng này. Sau khi rời Ngụy Trang, Teemo nhận Tốc Độ Đánh trong một thời gian. Trụ địch làm lộ diện đơn vị Ngụy Trang ở gần, và đòn đánh hoặc kỹ năng tấn công sẽ kết thúc Ngụy Trang sớm.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: {
      values: [25, 23, 21, 19],
    ...
    range: null,
    scaling: {
      camouflageAfterDelay: true,
      outsideBrushDurationBeforeCamouflageEndsSeconds: [3, 3.5, 4, 4.5],
      attackSpeedAfterExitingCamouflagePercent: [30, 40, 50, 60],
      attackSpeedDurationSeconds: [3, 4, 5, 6],
      enemyTurretsRevealNearbyCamouflagedUnits: true,
      attacksAndOffensiveAbilitiesEndCamouflageEarly: true,
    },
    effects: [SkillEffect.BUFF],
    tags: [
      `CAMOUFLAGE`,
  ...
  // TEEMO - R
  {
    ...
    slot: SkillSlot.R,
    name: `Noxious Trap`,
    nameVi: `Bẫy Độc Noxus`,
    description: `Teemo places a mushroom trap that detonates when an enemy steps on it, dealing magic damage over 3 seconds and slowing enemies. Traps last for 2 minutes.`,
    descriptionVi: `Teemo đặt một bẫy nấm phát nổ khi kẻ địch giẫm lên, gây sát thương phép trong 3 giây và làm chậm kẻ địch. Bẫy tồn tại trong 2 phút.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: {
      values: [1, 1, 1],
    ...
    scaling: {
      ...
      slowPercent: [30, 40, 50],
      slowDurationSeconds: 3,
      trapDurationSeconds: 120,
      detonatesWhenEnemyStepsOnTrap: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // THRESH - PASSIVE
  {
    ...
    name: `Damnation`,
    nameVi: `Đọa Đày`,
    description: `Thresh can harvest the Souls of enemies that die near him, each Soul permanently granting Armor and Ability Power. Thresh does not gain Armor on level up.`,
    descriptionVi: `Thresh có thể thu thập Linh Hồn từ kẻ địch chết gần hắn, mỗi Linh Hồn vĩnh viễn cho Giáp và Sức Mạnh Phép Thuật. Thresh không tăng Giáp khi lên cấp.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    ...
    scaling: {
      armorPerSoul: 2,
      abilityPowerPerSoul: 2,
      gainsArmorOnLevelUp: false,
    },
    effects: [SkillEffect.BUFF],
    tags: [
      `STACKING_PASSIVE`,
  ...
  // THRESH - Q
  {
    ...
    name: `Death Sentence`,
    nameVi: `Án Tử`,
    description: `Thresh throws out a scythe, stunning the first unit hit, pulling them in, dealing magic damage, and granting True Sight for the duration. Recast: Thresh dashes to the bound enemy. Cooldown is reduced if it hits an enemy.`,
    descriptionVi: `Thresh ném lưỡi hái ra, làm choáng đơn vị đầu tiên trúng phải, kéo chúng lại, gây sát thương phép và cho Tầm Nhìn Chuẩn trong thời gian hiệu lực. Tái kích hoạt: Thresh lướt tới kẻ địch bị trói. Hồi chiêu được giảm nếu trúng kẻ địch.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: {
      values: [17, 15, 13, 11],
    ...
    scaling: {
      ...
      bindDurationSeconds: 1.5,
      cooldownReductionOnHitSeconds: 3,
      grantsTrueSightForDuration: true,
      recast: {
        dashesToBoundEnemy: true,
      },
    },
    effects: [
      SkillEffect.DAMAGE,
  ...
  // THRESH - W
  {
    ...
    slot: SkillSlot.W,
    name: `Dark Passage`,
    nameVi: `Con Đường Tăm Tối`,
    description: `Thresh throws a Lantern to a target location, allowing an ally to dash to him. The Lantern also grants a shield to Thresh and the first ally that comes near it, scaling with Souls.`,
    descriptionVi: `Thresh ném Lồng Đèn tới vị trí chỉ định, cho phép đồng minh lướt về phía hắn. Lồng Đèn cũng tạo lá chắn cho Thresh và đồng minh đầu tiên đến gần, tăng theo số Linh Hồn.`,
    damageType: DamageType.NONE,
    targetType: TargetType.LOCATION,
    cooldown: {
      values: [22, 20, 18, 16],
    ...
    scaling: {
      shield: {
        values: [65, 115, 165, 215],
        soulRatio: 2,
        durationSeconds: 4,
      },
      allowsAllyDashToThresh: true,
      shieldTargets: [`thresh`, `first_ally_near_lantern`],
    },
    effects: [SkillEffect.SHIELD, SkillEffect.DASH],
    tags: [
      `ALLY_SHIELD`,
      `SELF_SHIELD`,
      `ALLY_DASH`,
  ...
  // THRESH - E
  {
    ...
    slot: SkillSlot.E,
    name: `Flay`,
    nameVi: `Lưỡi Hái Xoáy`,
    description: `Passive: Thresh's basic attacks deal bonus magic damage based on Souls and how long since he last attacked. Active: Thresh whips his chains, pulling or pushing enemies in the direction of the swing. Enemies hit are slowed and take magic damage.`,
    descriptionVi: `Nội tại: Đòn đánh của Thresh gây thêm sát thương phép dựa trên số Linh Hồn và thời gian kể từ lần đánh trước. Kích hoạt: Thresh quất xích, kéo hoặc đẩy kẻ địch theo hướng vung. Kẻ địch trúng chiêu bị làm chậm và nhận sát thương phép.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: {
      values: [12, 11, 10, 9],
    ...
    range: null,
    scaling: {
      passiveBonusMagicDamage: {
        minValue: 0,
        maxBaseValue: 58,
        soulRatioMin: 2,
        soulRatioMax: 2,
        attackDamageRatioByRank: [0.8, 1, 1.2, 1.4],
        scalesWithTimeSinceLastAttack: true,
        damageType: `MAGIC`,
      },
      activeDamage: {
        values: [65, 105, 145, 185],
      ...
      slowPercent: [20, 25, 30, 35],
      slowDurationSeconds: 1,
      canPullOrPushBasedOnSwingDirection: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.KNOCK_BACK, SkillEffect.SLOW],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // THRESH - R
  {
    ...
    name: `The Box`,
    nameVi: `Đóng Hộp`,
    description: `Thresh creates a prison of spectral walls, slowing champions heavily and dealing magic damage. Walls break after one collision, and after one wall is broken, the rest deal no damage and slow for half duration. An enemy cannot be affected by multiple walls simultaneously.`,
    descriptionVi: `Thresh tạo một nhà tù bằng những bức tường ma quái, làm chậm cực mạnh tướng địch và gây sát thương phép. Tường vỡ sau một lần va chạm, và sau khi một bức tường bị phá, các tường còn lại không gây sát thương và làm chậm trong nửa thời gian. Một kẻ địch không thể bị ảnh hưởng bởi nhiều tường cùng lúc.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.AREA,
    cooldown: {
      values: [85, 80, 75],
    ...
    scaling: {
      ...
      slowPercent: 99,
      slowDurationSeconds: 2,
      wallsBreakAfterOneCollision: true,
      afterFirstWallBreakRemainingWalls: {
        dealDamage: false,
        slowDurationMultiplier: 0.5,
      },
      cannotBeAffectedByMultipleWallsSimultaneously: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // TRISTANA - PASSIVE
  {
    ...
    name: `Draw a Bead`,
    nameVi: `Ngắm Bắn`,
    description: `Tristana increases the range of her attacks, Explosive Charge, and Buster Shot with each level.`,
    descriptionVi: `Tristana tăng tầm đánh, Bọc Thuốc Súng và Đại Bác Đẩy Lùi theo mỗi cấp.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    ...
    scaling: {
      ...
      affectedActions: [`attacks`, `explosive_charge`, `buster_shot`],
    },
    effects: [SkillEffect.BUFF],
    tags: [`RANGE_SCALING`, `ATTACK_RANGE_BUFF`, `SCALING`, `SAFE_POSITIONING`],
  },
  ...
  // TRISTANA - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Rapid Fire`,
    nameVi: `Súng Liên Thanh`,
    description: `Tristana gains bonus Attack Speed for 7 seconds.`,
    descriptionVi: `Tristana nhận thêm Tốc Độ Đánh trong 7 giây.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: {
      values: [17, 16, 15, 14],
    ...
    range: null,
    scaling: {
      attackSpeedPercent: [50, 75, 100, 125],
      durationSeconds: 7,
    },
    effects: [SkillEffect.BUFF],
    tags: [
  ...
  // TRISTANA - W
  {
    ...
    slot: SkillSlot.W,
    name: `Rocket Jump`,
    nameVi: `Phóng Nhảy Tên Lửa`,
    description: `Tristana leaps to a target location, dealing magic damage and slowing nearby enemies. Takedowns and fully stacked Explosive Charge detonations on champions reset Rocket Jump's cooldown.`,
    descriptionVi: `Tristana nhảy tới vị trí chỉ định, gây sát thương phép và làm chậm kẻ địch gần đó. Tham gia hạ gục và vụ nổ Bọc Thuốc Súng đủ cộng dồn trên tướng sẽ hồi lại hồi chiêu của Phóng Nhảy Tên Lửa.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LOCATION,
    cooldown: {
      values: [22, 19, 16, 13],
    ...
    scaling: {
      damage: {
        values: [85, 155, 225, 295],
        abilityPowerRatio: 0.5,
        damageType: `MAGIC`,
      },
      slowPercent: 60,
      slowDurationSeconds: [1.5, 2, 2.5, 3],
      cooldownResetConditions: [
        `champion_takedown`,
        `fully_stacked_explosive_charge_detonation_on_champion`,
      ],
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW, SkillEffect.DASH],
    tags: [
  ...
  // TRISTANA - E
  {
    ...
    nameVi: `Bọc Thuốc Súng`,
    description: `Passive: enemies explode when killed by Tristana's attacks, dealing magic damage to nearby enemies. Active: Tristana places a bomb on an enemy or turret, dealing physical damage to nearby enemies. Tristana's attacks and abilities charge the bomb's damage, stacking up to 4 times. Bombs explode immediately at full stacks, and explosion radius is doubled for bombs placed on turrets.`,
    descriptionVi: `Nội tại: kẻ địch phát nổ khi bị đòn đánh của Tristana hạ gục, gây sát thương phép lên kẻ địch gần đó. Kích hoạt: Tristana đặt bom lên kẻ địch hoặc trụ, gây sát thương vật lý lên kẻ địch gần đó. Đòn đánh và kỹ năng của Tristana tích thêm sát thương cho bom, tối đa 4 cộng dồn. Bom phát nổ ngay khi đủ cộng dồn, và bán kính nổ được nhân đôi nếu đặt lên trụ.`,
    damageType: DamageType.MIXED,
    targetType: TargetType.ENEMY,
    cooldown: {
      values: [15, 14, 13, 12],
    ...
    scaling: {
      passiveExplosionDamage: {
        values: [65, 100, 135, 170],
        abilityPowerRatio: 0.25,
        damageType: `MAGIC`,
      },
      activeBombDamage: {
        values: [50, 75, 100, 125],
        bonusAttackDamageRatioByRank: [0.75, 1.1, 1.45, 1.8],
        abilityPowerRatio: 0.5,
        damageType: `PHYSICAL`,
      },
      bombDamageIncreasePerStackPercent: 30,
      maxStacks: 4,
      explodesImmediatelyAtFullStacks: true,
      turretBombExplosionRadiusMultiplier: 2,
  ...
  // TRISTANA - R
  {
    ...
    slot: SkillSlot.R,
    name: `Buster Shot`,
    nameVi: `Đại Bác Đẩy Lùi`,
    description: `Tristana fires a massive cannonball at an enemy, dealing magic damage and knocking them back.`,
    descriptionVi: `Tristana bắn một viên đại bác khổng lồ vào kẻ địch, gây sát thương phép và đẩy lùi chúng.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.ENEMY,
    cooldown: {
      values: [70, 65, 60],
  ...
  // TRYNDAMERE - PASSIVE
  {
    ...
    description: `Tryndamere gains Critical Rate for each point of Fury. Attacking a champion grants Attack Speed for 5 seconds. He gains Fury from attacks, critical strikes, and kills, then loses Fury after being out of combat. Battle Fury's Attack Speed bonus increases with Undying Rage's rank. Critical Rate above 100% is converted into Attack Damage.`,
    descriptionVi: `Tryndamere nhận Tỉ Lệ Chí Mạng với mỗi điểm Nộ. Tấn công tướng cho Tốc Độ Đánh trong 5 giây. Hắn nhận Nộ từ đòn đánh, chí mạng và hạ gục, rồi mất Nộ sau khi rời giao tranh. Tốc Độ Đánh cộng thêm của Cuồng Nộ Chiến Trường tăng theo cấp Chiến Binh Bất Tử. Tỉ Lệ Chí Mạng vượt quá 100% được chuyển thành Sức Mạnh Công Kích.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    range: null,
    scaling: {
      criticalRatePerFuryPercent: 0.32,
      championAttackSpeedBuff: {
      ...
      furyGain: {
        perAttack: 5,
        perCriticalStrike: 10,
        perKill: 15,
      },
      furyDecay: {
        furyLostPerSecond: 5,
        startsAfterOutOfCombatSeconds: 8,
      },
      attackSpeedBonusScalesWithUndyingRageRank: true,
      overcapCriticalRateConversion: {
        attackDamagePerCriticalRatePercentAboveCap: 1,
        criticalRateCapPercent: 100,
      },
    },
    effects: [SkillEffect.BUFF],
    tags: [
  ...
  // TRYNDAMERE - Q
  {
    ...
    name: `Bloodlust`,
    nameVi: `Say Máu`,
    description: `Passive: Tryndamere gains Attack Damage and additional Attack Damage based on missing Health. Active: consumes all Fury to heal, with healing increased per point of Fury consumed.`,
    descriptionVi: `Nội tại: Tryndamere nhận Sức Mạnh Công Kích và thêm Sức Mạnh Công Kích dựa trên Máu đã mất. Kích hoạt: tiêu thụ toàn bộ Nộ để hồi máu, lượng hồi máu tăng theo mỗi điểm Nộ đã tiêu thụ.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: {
      values: [12, 12, 12, 12],
    ...
    scaling: {
      ...
      passiveAttackDamagePerMissingHealthPercent: [0.35, 0.4, 0.45, 0.5],
      activeHeal: {
        values: [55, 65, 75, 85],
        abilityPowerRatio: 0.3,
      },
      healPerFuryConsumed: {
        values: [1.5, 2.1, 2.7, 3.3],
        abilityPowerRatio: 0.012,
      },
      consumesAllFury: true,
    },
    effects: [SkillEffect.HEAL, SkillEffect.BUFF],
    tags: [
      `SELF_HEAL`,
  ...
  // TRYNDAMERE - W
  {
    ...
    slot: SkillSlot.W,
    name: `Mocking Shout`,
    nameVi: `Tiếng Thét Uy Hiếp`,
    description: `Tryndamere reduces nearby enemy champions' Attack Damage. If a target is moving away from Tryndamere, they are slowed.`,
    descriptionVi: `Tryndamere giảm Sức Mạnh Công Kích của tướng địch gần đó. Nếu mục tiêu đang di chuyển ra xa Tryndamere, chúng bị làm chậm.`,
    damageType: DamageType.NONE,
    targetType: TargetType.ENEMIES,
    cooldown: {
      values: [12, 12, 12, 12],
    ...
    range: null,
    scaling: {
      attackDamageReductionPercent: 40,
      attackDamageReductionDurationSeconds: 3,
      slowPercent: [25, 30, 35, 40],
      slowCondition: `target_moving_away_from_tryndamere`,
    },
    effects: [SkillEffect.SLOW, SkillEffect.BUFF],
    tags: [
      `AREA_SLOW`,
      `ATTACK_DAMAGE_BUFF`,
      `DAMAGE_REDUCTION`,
  ...
  // TRYNDAMERE - E
  {
    ...
    name: `Spinning Slash`,
    nameVi: `Chém Xoáy`,
    description: `Tryndamere dashes, dealing physical damage. Critical strikes against minions reduce Spinning Slash's cooldown, doubled against champions. Tryndamere gains Fury for each enemy hit.`,
    descriptionVi: `Tryndamere lướt đi, gây sát thương vật lý. Chí mạng lên lính giảm hồi chiêu Chém Xoáy, hiệu quả gấp đôi khi chí mạng lên tướng. Tryndamere nhận Nộ với mỗi kẻ địch trúng chiêu.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: {
      values: [11, 10, 9, 8],
    ...
    scaling: {
      ...
      criticalStrikeCooldownReduction: {
        minionSeconds: 1,
        championSeconds: 2,
      },
      furyGainPerEnemyHit: 2,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.DASH],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // TRYNDAMERE - R
  {
    ...
    slot: SkillSlot.R,
    name: `Undying Rage`,
    nameVi: `Chiến Binh Bất Tử`,
    description: `Passive: increases Battle Fury's bonus Attack Speed. Active: Tryndamere becomes unkillable for 5 seconds and gains Fury. Can be cast while crowd controlled.`,
    descriptionVi: `Nội tại: tăng Tốc Độ Đánh cộng thêm của Cuồng Nộ Chiến Trường. Kích hoạt: Tryndamere trở nên không thể bị hạ gục trong 5 giây và nhận Nộ. Có thể dùng khi đang bị khống chế.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: {
      values: [90, 80, 70],
    ...
    range: null,
    scaling: {
      passiveBattleFuryAttackSpeedPercent: [45, 60, 75],
      unkillableDurationSeconds: 5,
      furyGain: [50, 75, 100],
      canCastWhileCrowdControlled: true,
    },
    effects: [SkillEffect.BUFF],
  ...
  // TWISTED FATE - PASSIVE
  {
    ...
    name: `Loaded Dice`,
    nameVi: `Gian Lận`,
    description: `Twisted Fate gains bonus gold when killing a unit.`,
    descriptionVi: `Twisted Fate nhận thêm vàng khi hạ gục một đơn vị.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    ...
    effects: [SkillEffect.BUFF],
    tags: [`BONUS_GOLD`, `SNOWBALL`, `SCALING_GAME`],
  },
  ...
  // TWISTED FATE - Q
  {
    ...
    name: `Wild Cards`,
    nameVi: `Phi Bài`,
    description: `Twisted Fate throws three cards, dealing magic damage to enemies hit.`,
    descriptionVi: `Twisted Fate phóng ba lá bài, gây sát thương phép lên kẻ địch trúng phải.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: {
      values: [6, 6, 6, 6],
  ...
  // TWISTED FATE - W
  {
    ...
    name: `Pick A Card`,
    nameVi: `Chọn Bài`,
    description: `First cast starts shuffling Twisted Fate's deck. Second cast picks a card to empower his next attack. Red Card deals area magic damage and slows. Blue Card deals magic damage and restores Mana. Gold Card deals magic damage and stuns.`,
    descriptionVi: `Lần dùng đầu bắt đầu xáo bộ bài của Twisted Fate. Lần dùng thứ hai chọn một lá bài để cường hóa đòn đánh kế tiếp. Bài Đỏ gây sát thương phép diện rộng và làm chậm. Bài Xanh gây sát thương phép và hồi Năng Lượng. Bài Vàng gây sát thương phép và làm choáng.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: {
      values: [7, 7, 6, 5],
    ...
    range: null,
    scaling: {
      firstCastStartsShuffling: true,
      secondCastSelectsCard: true,
      empowersNextAttack: true,
      redCard: {
        damage: {
          values: [30, 50, 70, 90],
      ...
      goldCard: {
        ...
        stunDurationSeconds: [1.25, 1.5, 1.75, 2],
      },
    },
    effects: [
      SkillEffect.DAMAGE,
  ...
  // TWISTED FATE - E
  {
    ...
    name: `Stacked Deck`,
    nameVi: `Tráo Bài`,
    description: `Passive: Twisted Fate gains Attack Speed and every 4th attack deals bonus magic damage. Active: Twisted Fate gains additional Attack Speed for 3 seconds, and during this time attacking enemy champions rolls Loaded Dice.`,
    descriptionVi: `Nội tại: Twisted Fate nhận Tốc Độ Đánh và mỗi đòn đánh thứ 4 gây thêm sát thương phép. Kích hoạt: Twisted Fate nhận thêm Tốc Độ Đánh trong 3 giây, và trong thời gian này đánh tướng địch sẽ kích hoạt Gian Lận.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: {
      values: [17, 16, 15, 14],
    ...
    range: null,
    scaling: {
      passiveAttackSpeedPercent: [15, 20, 25, 30],
      fourthAttackDamage: {
        values: [50, 80, 110, 140],
        abilityPowerRatio: 0.45,
        damageType: `MAGIC`,
      },
      activeAttackSpeedPercent: [20, 25, 30, 35],
      activeDurationSeconds: 3,
      attackingEnemyChampionsDuringActiveRollsLoadedDice: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.BUFF],
    tags: [
      `MAGIC_DAMAGE`,
  ...
  // TWISTED FATE - R
  {
    ...
    name: `Destiny`,
    nameVi: `Định Mệnh`,
    description: `First cast reveals all enemy champions for a duration. Second cast channels briefly to teleport to a target location.`,
    descriptionVi: `Lần dùng đầu làm lộ diện tất cả tướng địch trong một thời gian. Lần dùng thứ hai vận sức ngắn để dịch chuyển tới vị trí chỉ định.`,
    damageType: DamageType.NONE,
    targetType: TargetType.LOCATION,
    cooldown: {
      values: [100, 90, 80],
    ...
    scaling: {
      revealDurationSeconds: [6, 7, 8],
      secondCastChannelSeconds: 1.5,
      secondCastTeleportsToTargetLocation: true,
    },
    effects: [SkillEffect.REVEAL, SkillEffect.DASH],
    tags: [
      `GLOBAL_RANGE`,
      `REVEAL`,
      `TRUE_SIGHT`,
  ...
  // TWITCH - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Deadly Venom`,
    nameVi: `Độc Chết Người`,
    description: `Twitch's attacks infect enemies with venom, dealing true damage over 5 seconds and stacking up to 5 times. When an enemy champion has full Deadly Venom stacks, Twitch gains Attack Speed for 5 seconds. Monsters take increased damage from Deadly Venom.`,
    descriptionVi: `Đòn đánh của Twitch nhiễm độc kẻ địch, gây sát thương chuẩn trong 5 giây và cộng dồn tối đa 5 lần. Khi một tướng địch có đủ cộng dồn Độc Chết Người, Twitch nhận Tốc Độ Đánh trong 5 giây. Quái chịu thêm sát thương từ Độc Chết Người.`,
    damageType: DamageType.TRUE_DAMAGE,
    targetType: TargetType.ENEMY,
    cooldown: null,
    cost: null,
    ...
    scaling: {
      damageOverTime: {
        baseValue: 1,
        abilityPowerRatio: 0.025,
        durationSeconds: 5,
        damageType: `TRUE`,
      },
      maxStacks: 5,
      fullStackChampionAttackSpeed: {
        values: [30, 35, 40, 45, 50],
        durationSeconds: 5,
      },
      monsterDamageIncreasePercent: 130,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.BUFF],
    tags: [
      `TRUE_DAMAGE`,
  ...
  // TWITCH - Q
  {
    ...
    name: `Ambush`,
    nameVi: `Đột Kích`,
    description: `Twitch becomes Camouflaged and gains Movement Speed. The Movement Speed increases when nearby enemy champions cannot see Twitch. After exiting Camouflage, Twitch's attacks apply an additional Deadly Venom stack for 3 seconds. Ambush resets when a champion dies while infected by Deadly Venom.`,
    descriptionVi: `Twitch trở nên Ngụy Trang và nhận Tốc Độ Di Chuyển. Tốc Độ Di Chuyển tăng khi tướng địch gần đó không thể nhìn thấy Twitch. Sau khi rời Ngụy Trang, đòn đánh của Twitch đặt thêm một cộng dồn Độc Chết Người trong 3 giây. Đột Kích được hồi lại khi một tướng chết trong khi đang nhiễm Độc Chết Người.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: {
      values: [15, 15, 15, 15],
    ...
    range: null,
    scaling: {
      camouflageDurationSeconds: [8, 9, 10, 11],
      movementSpeedPercent: 10,
      unseenByNearbyEnemyChampionMovementSpeedPercent: 20,
      postCamouflageAdditionalDeadlyVenomStackDurationSeconds: 3,
      resetsWhenChampionDiesWhileInfectedByDeadlyVenom: true,
      attacksAndOffensiveAbilitiesEndCamouflageEarly: true,
    },
    effects: [SkillEffect.BUFF, SkillEffect.SPEED_UP],
    tags: [
  ...
  // TWITCH - W
  {
    ...
    slot: SkillSlot.W,
    name: `Venom Cask`,
    nameVi: `Độc Suy Nhược`,
    description: `Twitch hurls a cask that applies Deadly Venom stacks to enemies and slows them. Cast time decreases with Twitch's Attack Speed.`,
    descriptionVi: `Twitch ném một bình độc đặt cộng dồn Độc Chết Người lên kẻ địch và làm chậm chúng. Thời gian thi triển giảm theo Tốc Độ Đánh của Twitch.`,
    damageType: DamageType.NONE,
    targetType: TargetType.AREA,
    cooldown: {
      values: [12, 11, 10, 9],
    ...
    range: null,
    scaling: {
      appliesDeadlyVenomStacks: true,
      slowPercent: [30, 35, 40, 45],
      slowBonusPercent: 6,
      slowDurationSeconds: 3,
      castTimeDecreasesWithAttackSpeed: true,
    },
    effects: [SkillEffect.SLOW],
    tags: [
      `AREA_SLOW`,
  ...
  // TWITCH - E
  {
    ...
    name: `Contaminate`,
    nameVi: `Nhiễm Khuẩn`,
    description: `Twitch deals physical damage to all enemies affected by Deadly Venom, with each Deadly Venom stack adding extra damage. Enemies with maximum stacks spread the damage to nearby targets and apply maximum Deadly Venom stacks to them. Deals increased damage to monsters.`,
    descriptionVi: `Twitch gây sát thương vật lý lên tất cả kẻ địch đang nhiễm Độc Chết Người, mỗi cộng dồn Độc Chết Người gây thêm sát thương. Kẻ địch có đủ cộng dồn sẽ lan sát thương sang mục tiêu gần đó và đặt tối đa cộng dồn Độc Chết Người lên chúng. Gây thêm sát thương lên quái.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.ENEMIES,
    cooldown: {
      values: [16, 15, 14, 13],
    ...
    scaling: {
      ...
      damagePerStack: {
        values: [20, 25, 30, 35],
        bonusAttackDamageRatio: 0.42,
        abilityPowerRatio: 0.18,
        damageType: `PHYSICAL`,
      },
      maxStackPhysicalDamage: 130,
      maxStackSpread: {
        spreadsDamageToNearbyTargets: true,
        appliesMaximumDeadlyVenomStacks: true,
      },
      monsterDamageIncreasePercent: 80,
    },
    effects: [SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // TWITCH - R
  {
    ...
    slot: SkillSlot.R,
    name: `Spray and Pray`,
    nameVi: `Nhắm Mắt Bắn Bừa`,
    description: `Twitch gains Attack Range and bonus Attack Damage for 6 seconds, transforming his attacks into piercing bolts that hit every enemy in a line. Subsequent targets take reduced damage down to a minimum value.`,
    descriptionVi: `Twitch nhận thêm Tầm Đánh và Sức Mạnh Công Kích trong 6 giây, biến đòn đánh thành các tia xuyên thấu trúng mọi kẻ địch theo đường thẳng. Các mục tiêu sau chịu giảm sát thương tới một mức tối thiểu.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: {
      values: [70, 65, 60],
    ...
    range: {
      bonusAttackRange: 225,
    },
    scaling: {
      durationSeconds: 6,
      bonusAttackDamage: [30, 45, 60],
      attacksBecomePiercingBolts: true,
      subsequentTargetDamageReductionPercent: 15,
  ...
  // URGOT - PASSIVE
  {
    ...
    slot: SkillSlot.PASSIVE,
    name: `Echoing Flames`,
    nameVi: `Đại Bác Cộng Hưởng`,
    description: `Urgot's attacks and Purge periodically trigger blasts from his leg cannons, dealing physical damage plus a percentage of the target's maximum Health. Each leg has its own cooldown. Damage is capped against monsters.`,
    descriptionVi: `Đòn đánh và Càn Quét của Urgot định kỳ kích hoạt phát bắn từ các khẩu đại bác ở chân, gây sát thương vật lý kèm một phần trăm Máu tối đa của mục tiêu. Mỗi chân có hồi chiêu riêng. Sát thương bị giới hạn lên quái.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.ENEMY,
    cooldown: null,
    cost: null,
    ...
    scaling: {
      baseDamage: 31,
      attackDamageRatio: [0.6, 0.75, 0.9, 1.05],
      maxHealthDamagePercent: [3, 4, 5, 6],
      perLegCooldownSeconds: [15, 8, 4, 2],
      monsterMaxDamage: 120,
      triggeredByAttacksAndPurge: true,
    },
    effects: [SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // URGOT - Q
  {
    ...
    nameVi: `Lựu Đạn Ăn Mòn`,
    description: `Urgot fires an explosive charge that deals physical damage and slows enemies hit.`,
    descriptionVi: `Urgot bắn ra một quả đạn nổ, gây sát thương vật lý và làm chậm kẻ địch trúng phải.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: {
      values: [10, 9, 9, 8],
  ...
  // URGOT - W
  {
    ...
    name: `Purge`,
    nameVi: `Càn Quét`,
    description: `Urgot rapidly shoots the nearest enemy for a duration, dealing physical damage and applying on-hit effects at reduced effectiveness. During Purge, Urgot's Movement Speed is reduced and he gains Slow Resist. Recast ends Purge. Purge prioritizes the champion most recently hit by Urgot's abilities, deals minimum damage to minions and monsters, and gains infinite duration at max rank.`,
    descriptionVi: `Urgot bắn nhanh vào kẻ địch gần nhất trong một thời gian, gây sát thương vật lý và áp dụng hiệu ứng đòn đánh với hiệu quả giảm. Trong lúc Càn Quét, Tốc Độ Di Chuyển của Urgot bị giảm và hắn nhận Kháng Làm Chậm. Tái kích hoạt để kết thúc Càn Quét. Càn Quét ưu tiên tướng vừa bị kỹ năng của Urgot đánh trúng gần nhất, gây sát thương tối thiểu lên lính và quái, và có thời lượng vô hạn ở cấp tối đa.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.ENEMY,
    cooldown: {
      values: [12, 8, 4, 1],
    ...
    scaling: {
      ...
      damagePerShot: {
        baseValue: 10,
        attackDamageRatio: [0.2, 0.275, 0.35, 0.425],
        damageType: `PHYSICAL`,
      },
      onHitEffectivenessPercent: 70,
      movementSpeedReduction: [125, 110, 95, 80],
      slowResistPercent: 40,
      recastEndsPurge: true,
      minimumDamageToMinionsAndMonsters: 50,
      prioritizesChampionMostRecentlyHitByUrgotAbilities: true,
      maxRankInfiniteDuration: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.BUFF],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // URGOT - E
  {
    ...
    name: `Disdain`,
    nameVi: `Khinh Thị`,
    description: `Urgot gains a shield and charges forward, dealing physical damage and stunning enemies hit. He flings the first enemy champion over himself and knocks non-champions aside.`,
    descriptionVi: `Urgot nhận lá chắn và lao tới phía trước, gây sát thương vật lý và làm choáng kẻ địch trúng phải. Hắn hất tướng địch đầu tiên qua người mình và hất văng các mục tiêu không phải tướng sang bên.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: {
      values: [15, 14, 13, 12],
    ...
    scaling: {
      ...
      stunDurationSeconds: 1.5,
      flingsFirstEnemyChampionOverUrgot: true,
      knocksNonChampionsAside: true,
    },
    effects: [
      SkillEffect.SHIELD,
      SkillEffect.DASH,
  ...
  // URGOT - R
  {
    ...
    nameVi: `Mũi Khoan Tử Thần`,
    description: `Urgot fires a chem-drill that deals physical damage to the first champion hit and impales them, slowing them based on missing Health. Recast: if the impaled target falls below the Health threshold, Urgot channels while reeling them in and executing them. Upon execution, nearby enemies are feared. Fear Beyond Death automatically recasts if the enemy is below the threshold at the end of the duration.`,
    descriptionVi: `Urgot bắn ra một mũi khoan hóa chất, gây sát thương vật lý lên tướng đầu tiên trúng phải và xiên họ, làm chậm dựa trên Máu đã mất. Tái kích hoạt: nếu mục tiêu bị xiên xuống dưới ngưỡng Máu, Urgot vận sức kéo họ lại và kết liễu. Khi kết liễu thành công, kẻ địch xung quanh bị hoảng sợ. Mũi Khoan Tử Thần tự động tái kích hoạt nếu kẻ địch dưới ngưỡng khi hết thời gian hiệu lực.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: {
      values: [60, 55, 50],
    ...
    scaling: {
      ...
      impaleDurationSeconds: 4,
      slowPercentByMissingHealth: {
        maxValue: 75,
      },
      executeHealthThresholdPercent: 25,
      recastChannelSeconds: 1.5,
      fearDurationSeconds: 1.5,
      autoRecastIfBelowThresholdAtEndOfDuration: true,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW, SkillEffect.BUFF],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // VARUS - PASSIVE
  {
    ...
    nameVi: `Sức Mạnh Báo Thù`,
    description: `On champion takedowns, Varus gains Attack Speed that can exceed the Attack Speed cap, then gains Attack Damage and Ability Power based on the bonus Attack Speed. On non-champion takedowns, he gains a smaller Attack Speed bonus and smaller stat conversion. These bonuses last 5 seconds.`,
    descriptionVi: `Khi tham gia hạ gục tướng, Varus nhận Tốc Độ Đánh có thể vượt giới hạn, sau đó nhận Sức Mạnh Công Kích và Sức Mạnh Phép Thuật dựa trên Tốc Độ Đánh cộng thêm. Khi hạ gục mục tiêu không phải tướng, hắn nhận ít Tốc Độ Đánh hơn và chuyển hóa chỉ số thấp hơn. Các hiệu ứng này kéo dài 5 giây.`,
    damageType: DamageType.NONE,
    targetType: TargetType.SELF,
    cooldown: null,
    cost: null,
    ...
    scaling: {
      championTakedown: {
        attackSpeedPercent: 55,
        canExceedAttackSpeedCap: true,
        attackDamagePerBonusAttackSpeed: 20,
        abilityPowerPerBonusAttackSpeed: 20,
        durationSeconds: 5,
      },
      nonChampionTakedown: {
        attackSpeedPercent: [20, 25, 30],
        attackDamagePerBonusAttackSpeed: 10,
        abilityPowerPerBonusAttackSpeed: 10,
        durationSeconds: 5,
      },
    },
    effects: [SkillEffect.BUFF],
  ...
  // VARUS - Q
  {
    ...
    slot: SkillSlot.Q,
    name: `Piercing Arrow`,
    nameVi: `Mũi Tên Xuyên Phá`,
    description: `Hold: Varus draws his bow, gradually increasing the range and damage of the next shot while slowing himself. Release: Varus fires an arrow that deals physical damage, reduced per enemy hit down to a minimum value.`,
    descriptionVi: `Giữ: Varus kéo cung, tăng dần tầm và sát thương của phát bắn kế tiếp đồng thời tự làm chậm bản thân. Thả: Varus bắn ra một mũi tên gây sát thương vật lý, giảm sát thương theo mỗi kẻ địch trúng phải tới một mức tối thiểu.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.LINE,
    cooldown: {
      values: [15, 14, 13, 12],
    ...
    scaling: {
      hold: {
        graduallyIncreasesRangeAndDamage: true,
        selfSlowPercent: 20,
      },
      minimumDamage: {
        values: [80, 140, 200, 260],
        attackDamageRatioByRank: [1.1, 1.2, 1.3, 1.4],
        damageType: `PHYSICAL`,
      },
      maximumDamage: {
        values: [105, 195, 285, 375],
        attackDamageRatio: 1.5,
        damageType: `PHYSICAL`,
      },
      damageReductionPerEnemyHitPercent: 15,
      minimumDamagePercent: 33,
    },
    effects: [SkillEffect.DAMAGE],
    tags: [
      `PHYSICAL_DAMAGE`,
  ...
  // VARUS - W
  {
    ...
    nameVi: `Tên Độc`,
    description: `Passive: Varus's attacks deal bonus magic damage and apply Blight stacks. Varus's other abilities detonate Blight, dealing magic damage based on the target's maximum Health per stack. Detonating Blight on enemy champions or epic monsters reduces his basic ability cooldowns per stack. Active: Varus's next Piercing Arrow deals bonus magic damage based on the target's missing Health, increased by charge time. Detonating Blight on monsters has a damage cap per stack.`,
    descriptionVi: `Nội tại: Đòn đánh của Varus gây thêm sát thương phép và đặt cộng dồn Tên Độc. Các kỹ năng khác của Varus kích nổ Tên Độc, gây sát thương phép theo Máu tối đa của mục tiêu trên mỗi cộng dồn. Kích nổ Tên Độc trên tướng địch hoặc quái khủng giảm hồi chiêu kỹ năng cơ bản theo mỗi cộng dồn. Kích hoạt: Mũi Tên Xuyên Phá kế tiếp gây thêm sát thương phép theo Máu đã mất của mục tiêu, tăng theo thời gian vận sức. Kích nổ Tên Độc trên quái có giới hạn sát thương mỗi cộng dồn.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.SELF,
    cooldown: {
      values: [25, 25, 25, 25],
    ...
    scaling: {
      ...
      blight: {
        durationSeconds: 6,
        maxStacks: 3,
        maxHealthDamagePercentPerStack: [3, 3.5, 4, 4.5],
        maxHealthDamageAbilityPowerRatioPercentPerStack: 0.012,
        damageType: `MAGIC`,
        basicAbilityCooldownReductionPerStackPercent: 13,
        cooldownReductionTargets: [`enemy_champions`, `epic_monsters`],
        monsterDamageCapPerStack: 120,
      },
      activeNextPiercingArrow: {
        missingHealthBonusMagicDamagePercent: {
          minValue: 6,
          maxValue: 9,
        },
        chargeTimeIncreasePercent: {
          minValue: 0,
          maxValue: 50,
        },
      },
  ...
  // VARUS - E
  {
    ...
    name: `Hail of Arrows`,
    nameVi: `Mưa Tên`,
    description: `Varus fires a hail of arrows that deals physical damage and desecrates the ground for 4 seconds. Desecrated ground slows enemies and applies Grievous Wounds, reducing healing and regeneration effects.`,
    descriptionVi: `Varus bắn một trận mưa tên gây sát thương vật lý và làm ô uế mặt đất trong 4 giây. Vùng đất ô uế làm chậm kẻ địch và gây Vết Thương Sâu, giảm hiệu quả hồi máu và hồi phục.`,
    damageType: DamageType.PHYSICAL,
    targetType: TargetType.AREA,
    cooldown: {
      values: [13, 12, 11, 10],
    ...
    scaling: {
      ...
      desecratedGroundDurationSeconds: 4,
      slowPercent: 25,
      grievousWoundsPercent: 40,
    },
    effects: [SkillEffect.DAMAGE, SkillEffect.SLOW],
  ...
  // VARUS - R
  {
    ...
    nameVi: `Sợi Xích Tội Lỗi`,
    description: `Varus flings out a tendril of corruption that deals magic damage and roots the first enemy champion hit. The corruption then spreads toward nearby enemy champions, also immobilizing them on contact. Immobilized units gain Blight stacks over the next 3 seconds.`,
    descriptionVi: `Varus phóng ra một xúc tu tha hóa, gây sát thương phép và trói chân tướng địch đầu tiên trúng phải. Sự tha hóa sau đó lan sang các tướng địch gần đó, cũng khiến chúng bị bất động khi chạm phải. Các đơn vị bị bất động nhận cộng dồn Tên Độc trong 3 giây tiếp theo.`,
    damageType: DamageType.MAGIC,
    targetType: TargetType.LINE,
    cooldown: {
      values: [75, 65, 55],
    ...
    scaling: {
      ...
      rootDurationSeconds: 2,
      spreadsTowardNearbyEnemyChampions: true,
      immobilizedUnitsGainBlightStacks: {
        stacks: 3,
        durationSeconds: 3,
      },
    },
